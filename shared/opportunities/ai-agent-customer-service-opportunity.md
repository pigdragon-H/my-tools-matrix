---
id: ai-agent-customer-service-opportunity
...
這個機會的收入模式可以三層疊加。第一層是一次性的**建置費**，涵蓋需求訪談與知識庫導入，這是你交付複雜度的對價。第二層是**月維運訂閱**，持續維護知識庫、優化回應品質、處理例外狀況，這是穩定的可重複收入。第三層是**對話量計費**，當客戶的使用量成長，你的收入也跟著成長。三層疊加，讓你同時擁有現金、穩定性與成長性。
