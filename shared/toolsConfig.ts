...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    icon: "Scale",
    description: "違約金計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Percent",
    description: "法定利息計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Clock",
    description: "加班費計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Briefcase",
    description: "資遣費計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "CalendarDays",
    description: "特休假計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Coins",
    description: "最低工資計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Clock",
    description: "工時計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Stamp",
    description: "印花稅計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Ship",
    description: "進口關稅計算機 — Profile B 計算器型 YMYL 工具，待補完 17 層內容。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
