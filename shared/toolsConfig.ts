...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "CSS 單位轉換器",
    category: "developer",
    path: "/tools/developer/css-unit-converter",
    icon: "Ruler",
  ...
  // ── Sninja 修正：已存在 TSX 元件之工具登記（Developer / Health）──
  {
    ...
    category: "developer",
    path: "/tools/developer/base64-json-formatter",
    icon: "FileCode",
  ...
  },
  {
    ...
    category: "developer",
    path: "/tools/developer/css-grid-flexbox-generator",
    icon: "Layout",
  ...
  },
  {
    ...
    name: "圖片格式轉換器",
    category: "developer",
    path: "/tools/developer/image-converter",
    icon: "Image",
  ...
  },
  {
    ...
    name: "響應式斷點測試器",
    category: "developer",
    path: "/tools/developer/responsive-breakpoint-tester",
    icon: "Monitor",
  ...
  },
  {
    ...
    name: "時區轉換器",
    category: "developer",
    path: "/tools/developer/timezone-converter",
    icon: "Globe",
  ...
  },
  {
    ...
    name: "UUID/密碼產生器",
    category: "developer",
    path: "/tools/developer/uuid-password-generator",
    icon: "Shield",
