...
export const tools: Tool[] = [
  ...
  // ── Phase 1 Finance 工具（ROI、CompoundInterest、Loan）────────────────────────────────────
  {
    id: "roi-calculator",
    name: "ROI Calculator",
    nameZh: "投資回報率計算機",
    ...
    icon: "TrendingUp",
    description: "Calculate your return on investment (ROI) to evaluate investment performance.",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "BarChart3",
    description: "Calculate compound interest and project your investment growth over time.",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "DollarSign",
    description: "Calculate monthly loan payments and total interest cost.",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  // ── Phase 1 Developer 工具（API、JSON、Regex、Cron）────────────────────────────────────
  {
    id: "api-response-formatter",
    name: "API Response Formatter",
    nameZh: "API 響應格式化工具",
    category: "developer",
    path: "/tools/developer/api-response-formatter",
    icon: "Code",
    description: "Format and beautify API responses in JSON, XML, or YAML format.",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "CheckCircle",
    description: "Validate JSON syntax and identify errors in your JSON data.",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    nameZh: "Cron 表達式生成器",
    category: "developer",
    path: "/tools/developer/cron-expression-builder",
    icon: "Clock",
    description: "Build and test cron expressions for scheduled tasks.",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
