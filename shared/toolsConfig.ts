...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    icon: "PieChart",
    description: "用 50/30/20 或自訂比例分配月收入。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    path: "/tools/productivity/hourly-rate-calculator",
    icon: "Clock",
    description: "把月薪、工時與休假換算為實際時薪。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    nameZh: "會議成本計算機",
    category: "productivity",
    path: "/tools/productivity/meeting-cost-calculator",
    icon: "Users",
    description: "依人數、時薪與時間估算會議成本。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    nameZh: "毛利率計算機",
    category: "ecommerce",
    path: "/tools/ecommerce/profit-margin-calculator",
    icon: "ShoppingCart",
    description: "用售價與成本估算毛利、毛利率與加價率。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    nameZh: "廣告 ROAS 計算機",
    category: "ecommerce",
    path: "/tools/ecommerce/roas-calculator",
    icon: "Megaphone",
    description: "用廣告花費與營收估算 ROAS 與獲利空間。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    nameZh: "小費計算機",
    category: "travel",
    path: "/tools/travel/tip-calculator",
    icon: "ReceiptText",
    description: "依帳單、人數與小費率拆分每人應付金額。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Code2",
    description: "格式化 JSON 並檢查基本語法有效性。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
  ...
  },
  {
    ...
    icon: "Binary",
    description: "在瀏覽器內進行 Base64 編碼與解碼。",
    isPremium: false,
    showAds: true,
    rateLimit: 30,
    isNew: true,
...
export const hourlyRateCalculator = { id: "hourly-rate-calculator", category: "productivity", name: "Hourly Rate Calculator", path: "/tools/productivity/hourly-rate-calculator" };
export const meetingCostCalculator = { id: "meeting-cost-calculator", category: "productivity", name: "Meeting Cost Calculator", path: "/tools/productivity/meeting-cost-calculator" };
...
export const profitMarginCalculator = { id: "profit-margin-calculator", category: "ecommerce", name: "Profit Margin Calculator", path: "/tools/ecommerce/profit-margin-calculator" };
export const roasCalculator = { id: "roas-calculator", category: "ecommerce", name: "ROAS Calculator", path: "/tools/ecommerce/roas-calculator" };
export const tipCalculator = { id: "tip-calculator", category: "travel", name: "Tip Calculator", path: "/tools/travel/tip-calculator" };
