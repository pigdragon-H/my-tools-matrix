...
const ui = {
  zh: {
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把假文產生整合進設計流程", conversionNote: "L9 會連動目前產生結果，顯示模式、字數與格式，協助你判斷該用哪種長度與標記接進設計稿或網頁模板。",
    progressInsight: "進度洞察卡", possibleTarget: "目前假文產生計畫", dailyGap: "字元數", weeklyTrend: "總字數", motivation: "動力卡", keepMomentum: "從單次佔位走向批次套版",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這段假文帶進你的稿件", journeyHint: "每次調整模式、數量或格式時重新產生，並把結果複製到設計稿、HTML 模板或文件。",
