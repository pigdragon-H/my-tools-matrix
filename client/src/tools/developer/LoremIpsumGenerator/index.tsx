...
const SENTENCES = [
  " Design sample dolor sit amet, consectetur adipiscing elit.",
...
const ui = {
  ...
  en: {
    ...
    title: "Lorem Ipsum Generator", subtitle: "Generate Lorem Ipsum sample text with paragraph / sentence / word modes and multiple formats",
    intro: "This tool generates sample text from the classic Lorem Ipsum corpus in paragraph, sentence, or word mode, exporting as plain text, HTML, or Markdown — ideal for layout previews, design mockups, and front-end sample content.",
    trustNoteLabel: "Note:", trustNote: "Lorem Ipsum is meaningless sample text for layout and design preview only. Always replace it with real content before going live to avoid publishing dummy text.",
    quickActionCard: "Quick example", tryExample: "Try a sample example", examplePreview: "Current word count", examplePerson: "Mode", flowDemo: "Count", fillExample: "Generate 3 plain paragraphs", previewActivePath: "Generate 5 HTML sentences",
    ...
    resultIntelligence: "Result intelligence", tdeeMatrix: "Six-band sample mode matrix", tdeeMatrixNote: "L7 fixed six-band matrix — lists common modes and formats and their uses. This is a layout reference, not content or copywriting advice.",
    emotionConversionLayer: "Emotion & conversion layer", turnIntoPlan: "Fit sample generation into your design workflow", conversionNote: "L9 reflects your current output — mode, word count, and format — to help you decide which length and markup to feed into a mockup or web template.",
    progressInsight: "Progress insight", possibleTarget: "Your current sample plan", dailyGap: "Char count", weeklyTrend: "Word count", motivation: "Motivation", keepMomentum: "Move from single samples to batch templating",
    saveShareJourney: "Save / share", journeyTitle: "Take this sample text into your draft", journeyHint: "Regenerate whenever you change the mode, count, or format, and copy the result into a mockup, HTML template, or document.",
    nextActionLabel: "Next action", nextActionTitle: "Carry the result to the next tool", nextActionItem1: "Use the Word Counter to check the sample length fits the slot", nextActionItem2: "Use Markdown to HTML to turn sample paragraphs into web markup", nextActionItem3: "Use the HTML Encoder to safely embed tag-containing content",
    ...
    knowledge: "Knowledge", knowledgeTitle: "What Lorem Ipsum means in design and layout", definition: "Definition", definitionText: "Lorem Ipsum is meaningless sample text derived from classical Latin, used to show layout and typography without readable content distracting the designer's judgment of the visuals.",
    ...
    interpretation: "Interpretation", interpretationText: "Mode affects structure, format affects markup, and count affects length. Their combination decides how closely the sample matches the rhythm of the final content's layout.",
    context: "Context", contextText: "Use sample text during design and development, then replace it with real content before delivery; pairing with a word counter keeps slot length close to real copy.",
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended tools", affiliateTitle: "Next-step tools for a sample workflow", premiumTitle: "Pro Placeholder Toolkit", premiumText: "Unlock Chinese sample text, custom corpora, image sample generation, and batch export of multi-file templates.",
    trustReferences: "Trust · Related tools · References", trust: "Trust", trustText: "This tool is for design and development sample use only; sample text has no meaning and must not be used in published content.", relatedTools: "Related tools", relatedToolsText: "Word Counter · Markdown to HTML · Base64 Encoder · HTML Encoder", references: "References", referencesText: "Origin and history of Lorem Ipsum; web layout sample conventions; front-end mockup content-fill guides; pre-delivery content-replacement checklists.",
    q1: "What is Lorem Ipsum?", a1: "It is meaningless sample text derived from Latin, used since the printing era to show layout and typography when no real content exists yet.",
    q2: "Why use sample text instead of random typing?", a2: "Lorem Ipsum's letter distribution resembles natural language and shows a realistic layout rhythm; random typing often repeats letters and distorts the look.",
    ...
    q5: "Does sample text affect SEO?", a5: "If dummy text remains on a live page, search engines may judge it low quality; always replace it with real copy before launch.",
