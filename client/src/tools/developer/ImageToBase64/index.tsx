...
const ui = {
  zh: {
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把圖片編碼整合進開發流程", conversionNote: "L9 會連動目前編碼結果,顯示格式、原始與編碼後體積,協助你判斷該圖片適合內嵌還是仍走檔案連結。",
    progressInsight: "進度洞察卡", possibleTarget: "目前編碼計畫", dailyGap: "原始位元組", weeklyTrend: "編碼後位元組", motivation: "動力卡", keepMomentum: "從單張內嵌走向資源打包流程",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把編碼結果帶進你的程式碼", journeyHint: "每次更換圖片或輸出格式時重新編碼,並把結果複製到 HTML、CSS 樣式表或 JSON 設定。",
    ...
    trustReferences: "信任聲明 · 相關工具 · 參考資料", trust: "信任聲明", trustText: "本工具僅在瀏覽器端編碼,圖片不會離開你的裝置;適合處理私有或內部圖片資源。", relatedTools: "相關工具", relatedToolsText: "Base64 編碼器 · 程式碼壓縮器 · 顏色轉換器 · QR Code 產生器", references: "參考資料", referencesText: "RFC 2397 Data URI Scheme;Base64 編碼規範;前端資源內嵌最佳實務;圖片最佳化與快取策略指南。",
    ...
    q3: "這個工具會上傳我的圖片嗎？", a3: "不會。所有編碼都在你的瀏覽器本機執行,圖片不會上傳到任何伺服器,適合處理機密或內部圖片。",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題後廣告位：廣告位" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="image-to-base64-faq" position="inline" /></section>
