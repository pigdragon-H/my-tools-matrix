...
const ui = {
  zh: {
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把權限設定整合進部署流程", conversionNote: "L9 會連動目前勾選結果,顯示八進位與符號表示,協助您判斷該檔案是否設得太寬或太緊。",
    progressInsight: "進度洞察卡", possibleTarget: "目前權限計畫", dailyGap: "符號表示", weeklyTrend: "八進位", motivation: "動力卡", keepMomentum: "從單檔權限走向部署腳本自動化",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這組權限帶進您的部署腳本", journeyHint: "每次調整權限勾選或特殊位元時重新計算,並把 chmod 指令複製到佈署腳本或文件。",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題補充區" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="chmod-calculator-faq" position="inline" /></section>
