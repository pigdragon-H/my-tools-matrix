...
const ui = {
  zh: {
    ...
    q6: "可以用本工具做正式的無障礙稽核嗎?", a6: "不建議。本工具只做數學公式推導,不檢查實際 DOM 互動狀態(focus ring、disabled、sample、error)、字級權重、跨瀏覽器渲染差異、或色盲模擬。正式稽核請使用 axe DevTools、WAVE、Pa11y,或委由 a11y 專業團隊。",
  },
  en: {
    ...
    q6: "Can I use this for formal a11y audit?", a6: "Not recommended. This tool only does math derivation — it does not check actual DOM interaction states (focus ring, disabled, sample, error), font weight, cross-browser rendering, or color-blind simulation. For audits use axe DevTools, WAVE, Pa11y, or an a11y team.",
  },
} as const;
