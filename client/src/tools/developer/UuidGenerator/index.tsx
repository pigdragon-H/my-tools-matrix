...
const ui = {
  zh: {
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把 UUID 產生整合進開發流程", conversionNote: "L9 會連動目前產生結果，顯示數量、格式與字元長度，協助你判斷該用哪種格式接進資料庫、URL 或設定檔。",
    ...
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這批 UUID 帶進你的專案", journeyHint: "每次調整數量或格式時重新產生，並把結果複製到程式碼、種子檔或 API 測試集。",
