...
const SAMPLE_HS256 = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTc1Mzk2MDAwMCwiZXhwIjoxOTAwMDAwMDAwfQ.signature_placeholder_for_demo_only_not_a_real_signature`;
...
const ui = {
  zh: {
    ...
    example: "範例", exampleText: "header = {alg:\"HS256\",typ:\"JWT\"}、payload = {sub:\"1234567890\",name:\"John Doe\",admin:true,iat:1753960000,exp:1900000000};經 base64url 編碼 + secret 簽章後變成三段 token。本工具的範例使用 placeholder 簽名,不會通過任何 verify 流程。",
  ...
  en: {
    ...
    example: "Example", exampleText: "header = {alg:\"HS256\",typ:\"JWT\"}; payload = {sub:\"1234567890\",name:\"John Doe\",admin:true,iat:1753960000,exp:1900000000}. After base64url-encoding and signing, it becomes the three-part token. The samples in this tool use placeholder signatures and will not pass any verify flow.",
