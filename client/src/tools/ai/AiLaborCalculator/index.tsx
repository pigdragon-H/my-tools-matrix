...
const ui = {
  zh: {
    ...
    intro: "AI Labor Calculator 依據每人每月工時、團隊人數與 AI 輔助等級（高人力、標準或全自動），計算整月人力總成本、每人成本與成本密度，協助您判斷預算是否合理、該擴編還是導入 AI 輔助、是否該把重複工作交給自動化流程，讓您在規劃團隊與 AI 投資前就把人力花費算清楚。",
    trustNoteLabel: "注意事項：", trustNote: "本工具以您輸入的 AI 輔助等級時薪估算，未含福利稅負、招募成本與各地薪資差異；實際成本請以您公司薪資與會計明細為準。",
    ...
    trustReferences: "信任聲明 · 相關工具 · 參考資料", trust: "信任聲明", trustText: "本工具只供成本規劃與教育用途，不取代您公司薪資制度、會計明細或合約報價。", relatedTools: "相關工具", relatedToolsText: "Automation Savings · AI ROI · Prompt ROI · Implementation ROI", references: "參考資料", referencesText: "各地薪資調查報告；福利稅負規範；招募培訓成本指南；外包與自動化效益研究。",
    ...
    q6: "這個工具能取代薪資制度嗎？", a6: "不能。它只是快速估算與教育用途；實際成本應以您公司薪資制度與會計明細為準。",
  },
  en: {
