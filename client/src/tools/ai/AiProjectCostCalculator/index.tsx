...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "專案的下一步工具", premiumTitle: "PRO 專案成本分析包", premiumText: "解鎖授權費試算、資料標註成本、多階段里程碑排程與自建對外包的長期成本比較矩陣。", feat1: "授權費用", feat2: "資料標註", feat3: "里程碑規劃", feat4: "自建外購",
