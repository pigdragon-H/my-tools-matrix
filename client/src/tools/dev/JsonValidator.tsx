  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-8">
      <section className="rounded-2xl border bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
        <h1 className="text-3xl font-bold text-slate-950 dark:text-white">JSON Validator</h1>
        <p className="mt-2 text-slate-600 dark:text-slate-300">JSON驗證器：驗證 JSON 語法，顯示錯誤行號並提供格式化預覽。</p>
      </section>
