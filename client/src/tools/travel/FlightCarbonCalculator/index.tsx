...
const ui = {
  zh: {
    ...
    intro: "本工具把您輸入的飛行距離,乘上艙等係數與單程或來回設定,即時估算航班碳排放量（kg CO2）、等同於開車多少公里,以及抵消所需的植樹年棵數,協助您了解旅程的環境影響並規劃碳抵消。所有計算都在瀏覽器本機完成。",
    ...
    examplesCalculator: "範例 → 計算器", enterValues: "輸入飛行距離與艙等", examplesHelper: "先用範例了解航班碳排放的量級,再輸入您自己的飛行距離、艙等與單程或來回設定,即可得到碳排放量、等同開車公里與植樹抵消棵數。",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把碳排放估算整合進旅程規劃", conversionNote: "L9 會連動目前計算結果,顯示碳排放量、等同開車公里與植樹棵數,協助您評估旅程的環境影響並考慮碳抵消。",
    progressInsight: "進度洞察卡", possibleTarget: "目前航班計算", dailyGap: "碳排放", weeklyTrend: "距離", motivation: "動力卡", keepMomentum: "從單趟估算走向年度旅行碳足跡管理",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這次估算帶進您的旅行碳帳", journeyHint: "每次規劃新航班時重新計算,並把碳排放量記錄到年度旅行碳足跡表,做為碳抵消與綠色出行的依據。",
    ...
    q6: "這個工具會上傳我的資料嗎？", a6: "不會。所有距離與碳排放計算都在您的瀏覽器本機完成,輸入的數據不會上傳到任何伺服器。",
  },
  en: {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題補充區" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="flight-carbon-faq" position="inline" /></section>
