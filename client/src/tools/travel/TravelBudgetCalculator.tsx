...
export default function TravelBudgetCalculator() {
  ...
  const copyResult = async () => {
    if (!result) return;
    const text = `Travel Budget Calculator
  ...
  return (
    <main className="container mx-auto max-w-4xl px-4 py-8">
      <section className="rounded-2xl border bg-card p-6 shadow-sm">
        <p className="text-sm font-medium uppercase tracking-wide text-muted-foreground">travel tool</p>
        <h1 className="mt-2 text-3xl font-bold">Travel Budget Calculator</h1>
