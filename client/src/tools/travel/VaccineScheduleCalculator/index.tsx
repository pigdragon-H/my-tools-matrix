...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "疫苗的下一步工具", premiumTitle: "PRO 疫苗排程分析包", premiumText: "解鎖各國疫苗要求串接、個別劑程模板、接種提醒與多人同行排程。", feat1: "國家要求", feat2: "劑次範本", feat3: "疫苗警示", feat4: "團體排程",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for vaccines", premiumTitle: "PRO Vaccine Schedule Analytics Pack", premiumText: "Unlock country vaccine-requirement feeds, individual dose-schedule templates, vaccination reminders, and multi-traveler scheduling.", feat1: "Country Requirements", feat2: "Dose Template", feat3: "Vaccine Alert", feat4: "Group Schedule",
