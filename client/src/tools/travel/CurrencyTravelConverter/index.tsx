...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "換匯的下一步工具", premiumTitle: "PRO 換匯分析包", premiumText: "解鎖即時匯率串接、多通路費率比對、發卡行附加費試算與買賣價差報告。", feat1: "即時匯率", feat2: "渠道比較", feat3: "發卡附加費", feat4: "價差報表",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for conversion", premiumTitle: "PRO Currency Conversion Analytics Pack", premiumText: "Unlock live-rate feeds, multi-channel fee comparison, issuer-surcharge estimation, and buy/sell spread reports.", feat1: "Live Rate Feed", feat2: "Channel Compare", feat3: "Issuer Surcharge", feat4: "Spread Report",
