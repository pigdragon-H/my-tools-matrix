...
const bands = [
  ...
  { key: "elite", range: "> 9 d", label: { zh: "極重", en: "Severe" }, desc: { zh: "跨越時區極多，恢復期很長，務必保留充足適應時間。", en: "Very many zones crossed; a very long recovery—reserve ample adjustment time." } },
] as const;
