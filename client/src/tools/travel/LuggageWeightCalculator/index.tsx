...
const bands = [
  ...
  { key: "healthy", range: "75–90%", label: { zh: "合理", en: "Reasonable" }, desc: { zh: "多數旅客打包常見區間，建議保留回程戰利品空間。", en: "Common packed band; leave space for return-trip purchases." } },
...
const ui = {
  zh: {
    ...
    q2: "使用率多少才安全？", a2: "建議使用率控制在 90% 以下並保留回程採買空間；超過 100% 即超重，需付超重費或重新分配。",
