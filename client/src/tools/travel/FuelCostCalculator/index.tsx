...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "油費的下一步工具", premiumTitle: "PRO 油費分析包", premiumText: "解鎖即時油價串接、車款油耗資料庫、塞車與載重修正及共乘分攤試算。", feat1: "即時油價", feat2: "車型資料庫", feat3: "路況修正", feat4: "共乘分攤",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for fuel", premiumTitle: "PRO Fuel Cost Analytics Pack", premiumText: "Unlock live fuel-price feeds, a vehicle efficiency database, traffic-and-load corrections, and carpool split estimation.", feat1: "Live Fuel Price", feat2: "Vehicle Database", feat3: "Traffic Correction", feat4: "Carpool Split",
