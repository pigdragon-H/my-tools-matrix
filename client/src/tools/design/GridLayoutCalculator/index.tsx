...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "網格的下一步工具", premiumTitle: "PRO 網格版面分析包", premiumText: "解鎖批量網格計算、CSS Grid 匯出、自訂欄數預設與團隊協作。", feat1: "批次網格", feat2: "CSS Grid匯出", feat3: "自訂預設", feat4: "團隊協作",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for grid", premiumTitle: "PRO Grid Layout Analytics Pack", premiumText: "Unlock batch grid calculation, CSS Grid export, custom column presets, and team collaboration.", feat1: "Batch Grid", feat2: "CSS Grid Export", feat3: "Custom Preset", feat4: "Team Collab",
