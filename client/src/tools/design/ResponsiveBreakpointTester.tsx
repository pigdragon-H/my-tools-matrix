...
export default function ResponsiveBreakpointTester() {
  ...
  const copyResult = async () => {
    if (!result) return;
    const text = `Responsive Breakpoint Tester
  ...
  return (
    <main className="container mx-auto max-w-4xl px-4 py-8">
      <section className="rounded-2xl border bg-card p-6 shadow-sm">
        <p className="text-sm font-medium uppercase tracking-wide text-muted-foreground">design tool</p>
        <h1 className="mt-2 text-3xl font-bold">Responsive Breakpoint Tester</h1>
