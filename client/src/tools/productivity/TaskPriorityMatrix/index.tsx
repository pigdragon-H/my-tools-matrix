...
const ui = {
  zh: {
    ...
    intro: "本工具根據重要程度、緊急程度與投入心力，計算任務所屬象限、建議行動與優先指數，幫助你決定先做什麼、排程什麼、委派什麼，以及刪除什麼。",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把任務優先盤點轉成可行計畫", conversionNote: "L9 會連動目前計算結果，顯示優先指數、所屬象限與建議行動，協助你判斷該立即做、排程、委派還是刪除。",
    ...
    q2: "投入心力為什麼會降低分數？", a2: "在重要與緊急相同時，投入心力越高代表越耗費資源，因此略微下調優先分數，提醒你評估投入與回報是否相稱。",
