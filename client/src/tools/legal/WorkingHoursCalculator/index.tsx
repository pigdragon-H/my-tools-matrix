...
const ui = {
  zh: {
    ...
    intro: "本工具依勞基法的正常工時基準（每日 8 小時、每週 40 小時、月加班上限 46 小時），把你輸入的每日時數、每週工作天數與週數換算成總工時與延長工時,協助你快速檢視工時安排是否合規。所有計算都在瀏覽器本機完成。",
    trustNoteLabel: "注意事項：", trustNote: "本工具僅依你輸入的時數做合規檢視,屬一般估算;實際工時認定、加班費率與例假規定請以勞動基準法及主管機關最新公告為準。所有處理皆在本地完成,無資料傳輸。",
    ...
    examplesCalculator: "範例 → 計算器", enterValues: "設定每日時數與工作天數", examplesHelper: "先用範例了解週工時與加班的計算邏輯,再輸入你自己的每日時數、每週工作天數與週數,即可得到總工時、延長工時與合規狀態。",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把工時檢視整合進排班管理", conversionNote: "L9 會連動目前計算結果,顯示總工時、延長工時與合規狀態,協助你判斷是否需調整排班或申報加班。",
    progressInsight: "進度洞察卡", possibleTarget: "目前工時計畫", dailyGap: "延長工時", weeklyTrend: "總工時", motivation: "動力卡", keepMomentum: "從單次檢視走向長期工時追蹤",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這次檢視帶進你的出勤紀錄", journeyHint: "每次更換時數或調整工作天數時重新計算,並把結果記錄到排班表或出勤管理系統。",
    ...
    limitations: "限制", limitationsText: "本工具以你輸入的時數計算,屬一般估算;不同產業、變形工時與責任制另有規定,單次數據僅供參考,實際以法規與勞動契約為準。",
    ...
    q6: "這個工具會上傳我的資料嗎？", a6: "不會。所有工時與加班計算都在你的瀏覽器本機完成,輸入的數據不會上傳到任何伺服器。",
  },
  en: {
