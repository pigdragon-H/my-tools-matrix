...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "契約試算的下一步工具", premiumTitle: "PRO 契約風險包", premiumText: "解鎖違約金條款健診、酌減機率模型、實際損害舉證清單與協商話術範本。",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for contract estimation", premiumTitle: "PRO Contract Risk Pack", premiumText: "Unlock penalty-clause health checks, reduction-likelihood models, damage-evidence checklists, and negotiation script templates.",
