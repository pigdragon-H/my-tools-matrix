...
const ui = {
  zh: {
    ...
    intro: "本工具依印花稅法的比例稅率（銀錢收據千分之四、承攬契據與產權移轉契據千分之一），把您輸入的憑證金額換算成應繳印花稅額,協助您在簽約、開立收據或辦理不動產移轉前快速估算稅負。所有計算都在瀏覽器本機完成。",
    trustNoteLabel: "注意事項：", trustNote: "本工具僅依您輸入的金額與憑證類型做比例稅率估算,屬一般試算;實際應稅憑證範圍、稅率與貼花方式請以印花稅法及稅捐機關最新公告為準。所有處理皆在本地完成,無資料傳輸。",
    ...
    examplesCalculator: "範例 → 計算器", enterValues: "選擇憑證類型與金額", examplesHelper: "先用範例了解不同憑證的比例稅率,再選擇您自己的憑證類型、輸入金額,即可得到應繳印花稅額與適用稅率。",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把印花稅計算整合進憑證管理", conversionNote: "L9 會連動目前計算結果,顯示稅額、稅率與憑證類型,協助您判斷簽約與開立憑證前的稅負成本。",
    progressInsight: "進度洞察卡", possibleTarget: "目前憑證計算", dailyGap: "印花稅額", weeklyTrend: "憑證金額", motivation: "動力卡", keepMomentum: "從單次計算走向長期稅務管理",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這次計算帶進您的稅務紀錄", journeyHint: "每次更換憑證類型或調整金額時重新計算,並把結果記錄到帳務或稅務管理系統。",
    ...
    limitations: "限制", limitationsText: "本工具以您輸入的金額與類型計算比例稅率,屬一般試算;定額憑證、免稅範圍與特殊情形另有規定,實際以印花稅法與稅捐機關認定為準。",
    ...
    q3: "稅額怎麼計算？", a3: "工具以憑證金額乘以適用稅率得到應繳印花稅額,並通常取整數;您只需選擇類型並輸入金額即可即時看到結果。",
    ...
    q6: "這個工具會上傳我的資料嗎？", a6: "不會。所有金額與稅額計算都在您的瀏覽器本機完成,輸入的數據不會上傳到任何伺服器。",
  },
  en: {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題補充區" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="stamp-duty-faq" position="inline" /></section>
