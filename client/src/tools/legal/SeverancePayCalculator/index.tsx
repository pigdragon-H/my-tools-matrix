...
const ui = {
  zh: {
    ...
    title: "非自願離職資遣費計算機 · Involuntary Severance Calculator", subtitle: "非自願離職資遣費、預告工資、特休未休與失業給付資格一次檢查",
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "勞動試算的下一步工具", premiumTitle: "PRO 離職結算包", premiumText: "解鎖新舊制分段試算、平均工資精算、預告工資與特休結算表及調解申請指引。", feat1: "新舊制分段", feat2: "平均工資", feat3: "預告期", feat4: "調解",
    ...
    q1: "非自願離職資遣費怎麼算？", a1: "每滿一年發給0.5個月平均工資，未滿一年按比例，總額以6個月平均工資為上限。",
    q2: "舊制和新制差在哪？", a2: "舊制每年1個月且無6個月上限；新制每年0.5個月並設6個月上限。",
    q3: "平均工資怎麼認定？", a3: "通常以離職前6個月工資總額除以該期間總日數再乘30估算，包含經常性給與。",
    q4: "非自願離職和自願離職有什麼差別？", a4: "非自願離職（雇主終止）有資遣費；自願離職（勞工提出）原則上沒有。簽自願離職前務必確認是否被迫簽署。",
  ...
  en: {
    ...
    title: "Involuntary Severance Calculator", subtitle: "Check severance, notice pay, unused leave, and unemployment benefits eligibility in one place",
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for labor estimation", premiumTitle: "PRO Exit-Settlement Pack", premiumText: "Unlock old/new split estimation, precise average-wage calc, notice-pay and leave-settlement tables, and mediation guidance.", feat1: "Split", feat2: "Avg Wage", feat3: "Notice", feat4: "Mediation",
    ...
    q1: "How is involuntary severance computed?", a1: "0.5 month's average wage per full year, pro-rated for partial years, capped at 6 months' average wage.",
    ...
    q4: "What's the difference between involuntary and voluntary resignation?", a4: "Involuntary (employer-terminated) gets severance; voluntary (worker-initiated) generally doesn't. Verify before signing any resignation.",
      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_#dcfce7,_#f8fafc_45%,_#ccfbf1)]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            <section className="space-y-6"><p className="text-sm font-black uppercase tracking-[0.24em] text-teal-700">{t.badge}</p><h1 className="max-w-3xl font-black tracking-tight text-slate-950 [font-size:clamp(1.75rem,4vw,2.5rem)] [line-height:1.2]">{t.title}</h1><p className="text-xl font-black text-teal-700">{t.subtitle}</p><p className="max-w-2xl text-lg leading-8 text-slate-700">{t.intro}</p><div className="rounded-3xl border border-amber-200 bg-amber-50 p-5 text-sm leading-6 text-amber-950">{/* L2-TrustIntro */}<strong>{t.trustNoteLabel}</strong> {t.trustNote}</div></section>
