...
const ui = {
  zh: {
    ...
    examplesCalculator: "範例 → 計算器", enterValues: "選擇模式並輸入你的薪資", examplesHelper: "先用範例理解合規判定邏輯,再選擇月薪、時薪或差額模式,輸入你的實領薪資,即可看出是否達標與需補足的金額。",
    metric: "月薪/時薪", imperial: "差額換算", exampleCards: "範例卡", baselineExample: "月薪 · 26,000", activeExample: "時薪 · 170", calculator: "計算器",
    modeLabel: "你的薪資", countLabel: "月工時", formatLabel: "模式", regenerate: "重新判定", copyAll: "複製判定結果",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把合規判定整合進勞資溝通", conversionNote: "L9 會連動目前判定結果,顯示基準、實領與差額,協助你判斷是否需要補足或申訴。",
    progressInsight: "進度洞察卡", possibleTarget: "目前薪資定位", dailyGap: "差額", weeklyTrend: "實領", motivation: "動力卡", keepMomentum: "從單次判定走向完整勞動權益確認",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這次判定帶進你的勞資紀錄", journeyHint: "每次更換薪資或切換模式時重新判定,並把結果記錄到薪資單或勞資溝通紀錄。",
    ...
    q6: "這個工具會上傳我的薪資嗎？", a6: "不會。所有合規判定與差額計算都在你的瀏覽器本機完成,輸入的薪資不會上傳到任何伺服器。",
  },
  en: {
