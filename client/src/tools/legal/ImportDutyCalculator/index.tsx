...
const bands = [
  ...
  { key: "review", range: "per HS", label: { zh: "稅則查詢", en: "HS lookup" }, desc: { zh: "實際稅率需依貨物的稅則號別（HS code）查詢,本工具以你輸入的稅率估算。", en: "The actual rate needs an HS-code lookup; this tool estimates with the rate you enter." } },
] as const;
...
const ui = {
  zh: {
    ...
    intro: "本工具依進口稅費結構（關稅 = 完稅價格 × 稅率、營業稅 5%、推廣貿易服務費約萬分之四），把你輸入的貨物價格、運費與關稅稅率換算成應繳關稅、營業稅、貿易費與進口總成本,協助你在報關前快速估算稅負。所有計算都在瀏覽器本機完成。",
    trustNoteLabel: "注意事項：", trustNote: "本工具僅依你輸入的金額與稅率做估算,屬一般試算;實際關稅稅率需依貨物稅則號別查詢,營業稅與規費請以海關及主管機關最新規定為準。所有處理皆在本地完成,無資料傳輸。",
    ...
    examplesCalculator: "範例 → 計算器", enterValues: "輸入完稅價格與關稅稅率", examplesHelper: "先用範例了解進口稅費的計算邏輯,再輸入你自己的貨物價格、運費與關稅稅率,即可得到關稅、營業稅、貿易費與進口總成本。",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把進口稅費整合進成本估算", conversionNote: "L9 會連動目前計算結果,顯示關稅、營業稅與總成本,協助你判斷進口報價與採購決策。",
    progressInsight: "進度洞察卡", possibleTarget: "目前進口計算", dailyGap: "進口總稅費", weeklyTrend: "完稅價格", motivation: "動力卡", keepMomentum: "從單次計算走向長期進口成本管理",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這次計算帶進你的採購紀錄", journeyHint: "每次更換貨物或調整稅率時重新計算,並把結果記錄到採購成本或進口管理系統。",
    ...
    limitations: "限制", limitationsText: "本工具以你輸入的稅率估算,屬一般試算;實際稅率需依貨物稅則號別查詢,反傾銷稅、優惠關稅與規費另有規定,以海關認定為準。",
    ...
    q5: "怎麼查關稅稅率？", a5: "實際稅率需依貨物的稅則號別（HS code）向海關查詢;本工具以你輸入的稅率估算,僅供報關前的初步成本評估。",
    q6: "這個工具會上傳我的資料嗎？", a6: "不會。所有金額與稅費計算都在你的瀏覽器本機完成,輸入的數據不會上傳到任何伺服器。",
  },
  en: {
