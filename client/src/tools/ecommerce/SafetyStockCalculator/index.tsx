...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "庫存營運的下一步工具", premiumTitle: "PRO 庫存分析包", premiumText: "解鎖品項級服務水準、需求波動分析、多倉安全庫存與缺貨成本模擬。", feat1: "服務水準", feat2: "變異分析", feat3: "多倉", feat4: "模擬",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for inventory operations", premiumTitle: "PRO Inventory Analytics Pack", premiumText: "Unlock SKU-level service levels, demand variability analysis, multi-warehouse safety stock, and stockout-cost simulation.", feat1: "Service", feat2: "Variance", feat3: "Multi WH", feat4: "Simulate",
