...
const ui = {
  zh: {
    ...
    trustNoteLabel: "注意事項：", trustNote: "此工具只組裝 UTM 連結與統計長度；不取代你在分析平台中的歸因設定與命名規範。",
    ...
    limitations: "限制", limitationsText: "本工具只組裝連結與統計長度；不檢查你的 GA4 設定、不去重複參數，也不保證各平台對長網址的處理一致。",
