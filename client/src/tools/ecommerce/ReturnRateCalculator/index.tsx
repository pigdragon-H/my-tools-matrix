...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "退貨的下一步工具", premiumTitle: "PRO 退貨率分析包", premiumText: "解鎖品類別退貨基準、退貨原因分群、逆物流成本連動與退款影響毛利報告。", feat1: "基準對標", feat2: "原因分群", feat3: "逆物流成本", feat4: "退款毛利",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for returns", premiumTitle: "PRO Return Rate Analytics Pack", premiumText: "Unlock category-level return benchmarks, return-reason clustering, reverse-logistics cost linkage, and refund-impact-on-margin reports.", feat1: "Benchmark", feat2: "Reason Cluster", feat3: "Reverse Cost", feat4: "Refund Margin",
