...
const ui = {
  zh: {
    ...
    intro: "本工具把您輸入的售價,扣除供應商成本、運費、廣告費與平台費,即時算出單筆毛利、毛利率與依月銷量估算的月收入,協助您在投放廣告前判斷該代發貨品項是否真的賺錢。所有計算都在瀏覽器本機完成。",
    trustNoteLabel: "注意事項：", trustNote: "本工具以您輸入的成本與一般平台費率（約 5%）估算,屬選品參考;實際平台費、金流費與廣告獲客成本因平台與市場而異,正式數字請以各平台後台為準。所有處理皆在本地完成,無資料傳輸。",
    ...
    examplesCalculator: "範例 → 計算器", enterValues: "輸入售價、成本與廣告費", examplesHelper: "先用範例了解代發貨毛利結構,再輸入您自己的售價、供應商成本、運費與廣告費,即可得到單筆毛利、毛利率與月收入預估。",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把獲利計算整合進選品與廣告策略", conversionNote: "L9 會連動目前計算結果,顯示毛利、毛利率與月收入,協助您判斷該品項是否值得投放廣告與如何定價。",
    progressInsight: "進度洞察卡", possibleTarget: "目前選品計算", dailyGap: "毛利", weeklyTrend: "售價", motivation: "動力卡", keepMomentum: "從單筆試算走向長期廣告獲利管理",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這次試算帶進您的選品清單", journeyHint: "每次更換商品、調整售價或廣告預算時重新計算,並把結果記錄到選品表或獲利管理系統。",
    ...
    q6: "這個工具會上傳我的資料嗎？", a6: "不會。所有售價、成本與廣告費計算都在您的瀏覽器本機完成,輸入的數據不會上傳到任何伺服器。",
  },
  en: {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題補充區" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="dropshipping-faq" position="inline" /></section>
