...
const ui = {
  zh: {
    ...
    intro: "本工具把你輸入的商品售價,扣除 Amazon 推薦費（約 15%）、FBA 物流費（依尺寸分級）、商品成本與其他費用,即時算出淨利潤、利潤率與投資報酬率（ROI），協助你在選品與定價前評估每件商品是否真的賺錢。所有計算都在瀏覽器本機完成。",
    ...
    examplesCalculator: "範例 → 計算器", enterValues: "輸入售價、成本與尺寸分級", examplesHelper: "先用範例了解 FBA 費用結構,再輸入你自己的售價、商品成本、尺寸分級與其他費用,即可得到淨利潤、利潤率與 ROI。",
    ...
    emotionConversionLayer: "情緒與轉換層", turnIntoPlan: "把利潤計算整合進選品策略", conversionNote: "L9 會連動目前計算結果,顯示淨利潤、利潤率與 ROI,協助你判斷該商品是否值得上架與如何定價。",
    progressInsight: "進度洞察卡", possibleTarget: "目前選品計算", dailyGap: "淨利潤", weeklyTrend: "售價", motivation: "動力卡", keepMomentum: "從單件試算走向長期選品管理",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把這次試算帶進你的選品清單", journeyHint: "每次更換商品或調整售價時重新計算,並把結果記錄到選品表或利潤管理系統。",
