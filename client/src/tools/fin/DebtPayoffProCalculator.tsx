...
export default function DebtPayoffProCalculator() {
  ...
  const copyResult = async () => {
    if (!result) return;
    const text = `Debt Payoff Pro Calculator
  ...
  return (
    <main className="container mx-auto max-w-4xl px-4 py-8">
      <section className="rounded-2xl border bg-card p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-3xl font-bold">Debt Payoff Pro Calculator</h1>
