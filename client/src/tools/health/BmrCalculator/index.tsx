...
const ui = {
  zh: {
    ...
    subtitle: "了解您的基礎代謝率",
    intro: "BMR 代表身體在靜止狀態下維持呼吸、心跳、體溫與器官運作所需的最低熱量。這個工具使用 Mifflin-St Jeor 公式估算 BMR，並依活動等級推估 TDEE，協助您把代謝數字轉成熱量規劃與體重目標。",
    trustNoteLabel: "注意事項：",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
          {/* L17-TrustRelatedReferences */}<p className="text-xs font-black uppercase tracking-[0.2em] text-emerald-700">{t.trustReferences}</p>
