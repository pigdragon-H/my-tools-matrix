...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "血糖管理的下一步工具", premiumTitle: "PRO 血糖飲食包", premiumText: "解鎖食物 GI 資料庫、混合餐 GL 試算、每日血糖負荷追蹤與個人化飲食報告。", feat1: "資料庫", feat2: "餐後GL", feat3: "追蹤", feat4: "報表",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended tools", affiliateTitle: "Next tools for blood-sugar management", premiumTitle: "PRO Blood-Sugar Pack", premiumText: "Unlock a food GI database, mixed-meal GL calc, daily glycemic-load tracking and a personalized diet report.", feat1: "Database", feat2: "Meal GL", feat3: "Tracking", feat4: "Report",
