...
const ui = {
  zh: {
    ...
    metric: "公制 (g)", imperial: "份量 (serving)", exampleCards: "範例卡", baselineExample: "燕麥 (低GI)", activeExample: "白吐司 (高GI)", flowDemo: "GL 試算", calculator: "計算機",
    weight: "GI 升糖指數 (0–110)", tdee: "每份碳水 (g)", goal: "食物類型", goalCut: "主食/澱粉", goalMaintain: "水果", goalBulk: "點心/飲料",
    resultCard: "升糖負荷計算結果", unit: "GL (升糖負荷)", primaryValue: "GI 值", maintenanceTarget: "GI 等級", actionTarget: "GL 等級", estimatedTdee: "碳水", maintenance: "GI", fatLossTarget: "GL",
  ...
  en: {
    ...
    metric: "Metric (g)", imperial: "Serving", exampleCards: "Example cards", baselineExample: "Oats (Low GI)", activeExample: "White toast (High GI)", flowDemo: "GL Demo", calculator: "Calculator",
    ...
    resultCard: "Glycemic Load Result", unit: "GL (Glycemic Load)", primaryValue: "GI value", maintenanceTarget: "GI band", actionTarget: "GL band", estimatedTdee: "Carbs", maintenance: "GI", fatLossTarget: "GL",
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5"><h3 className="text-lg font-black">{t.exampleCards}</h3><div className="mt-4 space-y-3"><button onClick={fillStandard} className="w-full rounded-2xl border border-emerald-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.baselineExample}</span><span className="rounded-full bg-emerald-100 px-3 py-1 text-xs font-black text-emerald-700">GI 55</span></div><p className="mt-2 text-sm text-slate-600">GI 55 · 27g carbs · GL ≈ 15</p></button><button onClick={fillCut} className="w-full rounded-2xl border border-orange-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.activeExample}</span><span className="rounded-full bg-orange-100 px-3 py-1 text-xs font-black text-orange-700">GI 75</span></div><p className="mt-2 text-sm text-slate-600">GI 75 · 24g carbs · GL ≈ 18</p></button></div></div>
