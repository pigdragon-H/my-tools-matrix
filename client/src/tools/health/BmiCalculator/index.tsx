...
const ui = {
  zh: {
    ...
    conversionLayerNote: "結果後的情緒與轉換層，將數值轉化為您下一步可執行的健康行動。",
    progressInsightCard: "進度洞察卡",
    possibleProgressTarget: "您的可能進度目標",
    timeline: "時間軸",
    ...
    nextActionsNote: "依您的 BMI 分類，挑 3 件當週可執行的小事 — 微小但持續，才是真正改變身體的力量。",
      ...
      */}
      ...
      <div className="bg-slate-50">
        <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
          ...
          <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
            {/* L17-TrustRelatedReferences */}<p className="text-xs font-black uppercase tracking-[0.2em] text-blue-700">{t.trustReferences}</p>
