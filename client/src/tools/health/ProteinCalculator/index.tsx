...
const ui = {
  zh: {
    ...
    examplesCalculator: "範例 → 計算機", enterValues: "輸入體重與目標", examplesHelper: "先用範例理解算法，再換成你自己的體重與訓練目標。",
    metric: "中度活動", imperial: "重量訓練", exampleCards: "範例卡", baselineExample: "70kg · 中度 · 1.6 g/kg", activeExample: "70kg · 重訓 · 2.0 g/kg", flowDemo: "每日餐數", calculator: "計算機",
    weight: "體重（公斤）", tdee: "每日餐數", goal: "活動／目標", goalCut: "中度活動", goalMaintain: "重量訓練", goalBulk: "運動員／減脂保肌",
    resultCard: "你的蛋白質需求結果", unit: "公克/天", primaryValue: "目前設定", maintenanceTarget: "每餐約", actionTarget: "乳清匙數", estimatedTdee: "每日蛋白質", maintenance: "每餐分配", fatLossTarget: "乳清匙",
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "蛋白質規劃的下一步補給", premiumTitle: "PRO 蛋白追蹤包", premiumText: "解鎖分餐排程、食物蛋白質資料庫、每週達標追蹤與個人化餐盤報告。",
    ...
    q1: "一天要吃多少蛋白質？", a1: "依目標而定：久坐約 0.8、規律運動 1.2–1.6、增肌或減脂保肌 1.6–2.2 g/kg 體重。本工具依你的選擇估算。",
  ...
  en: {
    ...
    metric: "Moderate", imperial: "Strength", exampleCards: "Example cards", baselineExample: "70kg · Moderate · 1.6 g/kg", activeExample: "70kg · Strength · 2.0 g/kg", flowDemo: "Meals/day", calculator: "Calculator",
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next supplements for protein planning", premiumTitle: "PRO Protein Tracking Pack", premiumText: "Unlock meal-by-meal scheduling, a food protein database, weekly adherence tracking, and personalized plate reports.",
