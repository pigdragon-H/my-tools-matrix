        ...
        <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
          ...
          <section className="grid gap-5 lg:grid-cols-[1fr_0.8fr]">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
              <p className="text-xs font-black uppercase tracking-[0.16em] text-slate-500">{lang === "zh" ? "能量旅程" : "Energy Journey"}</p>
              <h2 className="mt-2 text-3xl font-black">{lang === "zh" ? "若 TDEE 偏高，繼續熱量路徑" : "If TDEE Is High, Continue Calorie Path"}</h2>
              <div className="mt-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "每日為量需求" : "Daily energy needs"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "熱量赤字" : "Calorie Deficit"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "減重計畫" : "Weight loss plan"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "進度" : "Progress"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "追蹤体重" : "Track weight"}</p>
                  </div>
                </div>
              </div>
            </div>
