...
const ui = {
  zh: {
    ...
    subtitle: "30 秒算出你每天到底該吃幾大卡",
    intro: "TDEE（Total Daily Energy Expenditure）是你身體一整天會消耗的熱量總和，等於 BMR（基礎代謝）乘以活動係數。本工具用 Mifflin-St Jeor 公式估算 BMR，再依 6 段活動量帶推估 TDEE，並給你「維持／減脂／增肌」三檔可執行目標。",
    trustNoteLabel: "信任提醒：",
    ...
    q1: "TDEE 和 BMR 有什麼不同？",
    a1: "BMR 是身體完全休息時的最低熱量需求；TDEE 加上活動消耗，是你「實際每天會燒掉的熱量」。",
    q2: "我該選哪個活動量等級？",
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">{/* L14-Knowledge-FAQ */}
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
            ...
            <div className="mt-5"><AdSlot slot="tdee-knowledge" position="middle" /></div>
          </div>
