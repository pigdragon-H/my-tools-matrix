...
const ui = {
  zh: {
    ...
    metric: "公制", imperial: "分數制", exampleCards: "範例卡", baselineExample: "低風險族群", activeExample: "高風險族群", bodyMassLabel: "體重指數", scoreLabel: "分數", baselineExampleNote: "30 歲 · BMI 22 · 活躍", activeExampleNote: "55 歲 · BMI 31 · 有家族史", flowDemo: "FINDRISC", calculator: "評估器",
    ...
    resultCard: "糖尿病風險評估結果", unit: "分（風險評分）", primaryValue: "年齡", maintenanceTarget: "風險分數", actionTarget: "估計風險", quickRiskLabel: "快速風險", estimatedTdee: "分級", maintenance: "總分", fatLossTarget: "10 年風險",
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "健康規劃的下一步工具", premiumTitle: "PRO 代謝健康追蹤包", premiumText: "解鎖風險趨勢圖、血糖記錄、低 GI 飲食建議與個人化代謝健康報告。", feat1: "趨勢分析", feat2: "血糖", feat3: "飲食", feat4: "報表",
  ...
  en: {
    ...
    metric: "Metric", imperial: "Point scale", exampleCards: "Example cards", baselineExample: "Low-risk profile", activeExample: "High-risk profile", bodyMassLabel: "Body mass", scoreLabel: "Score", baselineExampleNote: "Age 30 · BMI 22 · active", activeExampleNote: "Age 55 · BMI 31 · family hx", flowDemo: "FINDRISC", calculator: "Calculator",
    ...
    resultCard: "Diabetes Risk Result", unit: "points (risk score)", primaryValue: "Age", maintenanceTarget: "Risk score", actionTarget: "Estimated risk", quickRiskLabel: "Quick risk", estimatedTdee: "Band", maintenance: "Total points", fatLossTarget: "10-year risk",
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for health planning", premiumTitle: "PRO Metabolic Health Pack", premiumText: "Unlock risk trend charts, glucose logging, low-GI diet tips, and a personalized metabolic health report.", feat1: "Trends", feat2: "Glucose", feat3: "Diet", feat4: "Report",
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5"><h3 className="text-lg font-black">{t.exampleCards}</h3><div className="mt-4 space-y-3"><button onClick={fillStandard} className="w-full rounded-2xl border border-emerald-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.baselineExample}</span><span className="rounded-full bg-emerald-100 px-3 py-1 text-xs font-black text-emerald-700">~1</span></div><p className="mt-2 text-sm text-slate-600">{t.baselineExampleNote}</p></button><button onClick={fillCut} className="w-full rounded-2xl border border-orange-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.activeExample}</span><span className="rounded-full bg-orange-100 px-3 py-1 text-xs font-black text-orange-700">~16</span></div><p className="mt-2 text-sm text-slate-600">{t.activeExampleNote}</p></button></div></div>
