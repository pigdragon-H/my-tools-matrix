...
const ui = {
  zh: {
    ...
    metric: "公制 (kg/min)", imperial: "英制 (lb/min)", exampleCards: "範例卡", baselineExample: "重訓 45 分鐘", activeExample: "間歇訓練示範", baselineExampleNote: "70 kg · 45 分鐘 · ≈ 331 kcal", activeExampleNote: "70 kg · 30 分鐘 · ≈ 294 kcal", flowDemo: "70 kg", calculator: "計算機",
    ...
    resultCard: "單次運動消耗結果", unit: "kcal/次", primaryValue: "本次運動", maintenanceTarget: "每分鐘消耗", actionTarget: "每週消耗", estimatedTdee: "MET 值", maintenance: "每分鐘", fatLossTarget: "每週 (3 次)", fatLabel: "脂肪",
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "運動規劃的下一步工具", premiumTitle: "PRO 訓練追蹤包", premiumText: "解鎖每週訓練量趨勢、心率區間分析、訓練後營養建議與個人化計畫報告。", feat1: "訓練量", feat2: "心率區間", feat3: "恢復", feat4: "報表",
  ...
  en: {
    ...
    metric: "Metric (kg/min)", imperial: "Imperial (lb/min)", exampleCards: "Example cards", baselineExample: "Strength 45 min", activeExample: "HIIT demo", baselineExampleNote: "70 kg · 45 min · ≈ 331 kcal", activeExampleNote: "70 kg · 30 min · ≈ 294 kcal", flowDemo: "70 kg", calculator: "Calculator",
    ...
    resultCard: "Per-Session Burn Result", unit: "kcal/session", primaryValue: "This session", maintenanceTarget: "Per minute", actionTarget: "Per week", estimatedTdee: "MET value", maintenance: "Per minute", fatLossTarget: "Weekly (3×)", fatLabel: "FAT",
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for exercise planning", premiumTitle: "PRO Training Tracking Pack", premiumText: "Unlock weekly volume trends, heart-rate zone analysis, post-workout nutrition tips, and a personalized plan report.", feat1: "Volume", feat2: "Zones", feat3: "Recovery", feat4: "Report",
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5"><h3 className="text-lg font-black">{t.exampleCards}</h3><div className="mt-4 space-y-3"><button onClick={fillStandard} className="w-full rounded-2xl border border-emerald-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.baselineExample}</span><span className="rounded-full bg-emerald-100 px-3 py-1 text-xs font-black text-emerald-700">MET 6.0</span></div><p className="mt-2 text-sm text-slate-600">{t.baselineExampleNote}</p></button><button onClick={fillHiit} className="w-full rounded-2xl border border-orange-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.activeExample}</span><span className="rounded-full bg-orange-100 px-3 py-1 text-xs font-black text-orange-700">MET 8.0</span></div><p className="mt-2 text-sm text-slate-600">{t.activeExampleNote}</p></button></div></div>
