...
const ui = {
  zh: {
    ...
    metric: "公制 (kg)", imperial: "英制 (lb)", exampleCards: "範例卡", baselineExample: "100 kg × 5 下 · Epley", activeExample: "80 kg × 8 下 · Brzycki", flowDemo: "次數 5", calculator: "計算機",
  ...
  en: {
    ...
    metric: "Metric (kg)", imperial: "Imperial (lb)", exampleCards: "Example cards", baselineExample: "100 kg × 5 · Epley", activeExample: "80 kg × 8 · Brzycki", flowDemo: "Reps 5", calculator: "Calculator",
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5"><h3 className="text-lg font-black">{t.exampleCards}</h3><div className="mt-4 space-y-3"><button onClick={fillStandard} className="w-full rounded-2xl border border-emerald-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.baselineExample}</span><span className="rounded-full bg-emerald-100 px-3 py-1 text-xs font-black text-emerald-700">117 kg</span></div><p className="mt-2 text-sm text-slate-600">100 × (1 + 5/30) = 117 kg</p></button><button onClick={fillBrzycki} className="w-full rounded-2xl border border-orange-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.activeExample}</span><span className="rounded-full bg-orange-100 px-3 py-1 text-xs font-black text-orange-700">99 kg</span></div><p className="mt-2 text-sm text-slate-600">80 × 36/(37−8) = 99 kg</p></button></div></div>
