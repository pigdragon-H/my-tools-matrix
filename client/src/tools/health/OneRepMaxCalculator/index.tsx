...
const ui = {
  zh: {
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "肌力訓練的下一步工具", premiumTitle: "PRO 肌力訓練包", premiumText: "解鎖週期化課表生成、各動作 1RM 趨勢圖、自動配重建議與訓練量負荷追蹤。", feat1: "訓練計畫", feat2: "趨勢分析", feat3: "自動配重", feat4: "訓練量",
  ...
  en: {
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for strength training", premiumTitle: "PRO Strength Training Pack", premiumText: "Unlock periodized program generation, per-lift 1RM trend charts, auto load suggestions, and volume-load tracking.", feat1: "Program", feat2: "Trends", feat3: "Auto Load", feat4: "Volume",
