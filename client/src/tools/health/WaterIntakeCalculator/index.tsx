...
const ui = {
  zh: {
    ...
    metric: "公制 (ml/L)", imperial: "英制 (fl oz)", exampleCards: "範例卡", baselineExample: "70 kg 標準補水", activeExample: "運動 + 炎熱示範", totalLabel: "總計", flowDemo: "運動 45 min", calculator: "計算機", baselineExampleDetail: "70 kg · 0 min · 無氣候加成", activeExampleDetail: "70 kg · 45 min · 炎熱",
    weight: "體重 (kg)", exercise: "運動時間 (分鐘/天)", climate: "氣候調整", climateNone: "無", climateHot: "炎熱/高海拔", climateCold: "寒冷/乾燥",
    resultCard: "飲水量建議結果", unit: "ml/day", primaryValue: "主要數值", waterTargetLabel: "飲水目標", maintenanceTarget: "公升換算", actionTarget: "液體盎司換算", estimatedTdee: "基礎水量", maintenance: "運動加成", fatLossTarget: "氣候加成",
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "水分規劃的下一步工具", premiumTitle: "PRO 飲水追蹤包", premiumText: "解鎖體重連動、每小時提醒、電解質建議與個人化飲水報告。", feat1: "體重", feat2: "攝取量", feat3: "提醒", feat4: "報表",
  ...
  en: {
    ...
    metric: "Metric (ml/L)", imperial: "Imperial (fl oz)", exampleCards: "Example cards", baselineExample: "70 kg standard hydration", activeExample: "Exercise + hot climate demo", totalLabel: "Total", flowDemo: "Exercise 45 min", calculator: "Calculator", baselineExampleDetail: "70 kg · 0 min · No climate", activeExampleDetail: "70 kg · 45 min · Hot",
    ...
    resultCard: "Water Intake Recommendation", unit: "ml/day", primaryValue: "Primary Value", waterTargetLabel: "Water target", maintenanceTarget: "Liter conversion", actionTarget: "Fluid ounce conversion", estimatedTdee: "Base water", maintenance: "Exercise add-on", fatLossTarget: "Climate add-on",
    ...
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for hydration planning", premiumTitle: "PRO Hydration Tracking Pack", premiumText: "Unlock weight-linked hydration, hourly reminders, electrolyte tips, and personalized intake reports.", feat1: "Weight", feat2: "Intake", feat3: "Reminder", feat4: "Report",
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section className="rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-emerald-50 p-6 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_0.9fr]">{/* L9-Emotion-Upper */}
            <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm"><p className="text-xs font-black uppercase tracking-[0.16em] text-blue-700">{t.progressInsight}</p><h3 className="mt-2 text-2xl font-black">{t.possibleTarget}</h3><div className="mt-5 grid gap-3 sm:grid-cols-3"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black uppercase text-slate-500">{t.totalLabel}</div><div className="mt-1 text-3xl font-black">{totalDisplay}</div></div><div className="rounded-2xl bg-blue-50 p-4"><div className="text-xs font-black uppercase text-blue-600">{t.dailyGap}</div><div className="mt-1 text-3xl font-black text-blue-950">{result ? fmt(result.perHour, 0) : "—"}</div></div><div className="rounded-2xl bg-emerald-50 p-4"><div className="text-xs font-black uppercase text-emerald-700">{t.weeklyTrend}</div><div className="mt-1 text-3xl font-black text-emerald-950">{result ? fmt(result.cups, 1) : "—"}</div></div></div></article>
