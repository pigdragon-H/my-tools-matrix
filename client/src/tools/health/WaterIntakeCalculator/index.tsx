...
const ui = {
  zh: {
    ...
    metric: "公制 (ml/L)", imperial: "英制 (fl oz)", exampleCards: "範例卡", baselineExample: "70 kg 標準補水", activeExample: "運動 + 炎熱示範", flowDemo: "運動 45 min", calculator: "計算機",
  ...
  en: {
    ...
    metric: "Metric (ml/L)", imperial: "Imperial (fl oz)", exampleCards: "Example cards", baselineExample: "70 kg standard hydration", activeExample: "Exercise + hot climate demo", flowDemo: "Exercise 45 min", calculator: "Calculator",
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5"><h3 className="text-lg font-black">{t.exampleCards}</h3><div className="mt-4 space-y-3"><button onClick={fillStandard} className="w-full rounded-2xl border border-emerald-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.baselineExample}</span><span className="rounded-full bg-emerald-100 px-3 py-1 text-xs font-black text-emerald-700">2450</span></div><p className="mt-2 text-sm text-slate-600">70 kg · 0 min · 無氣候</p></button><button onClick={fillActive} className="w-full rounded-2xl border border-orange-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.activeExample}</span><span className="rounded-full bg-orange-100 px-3 py-1 text-xs font-black text-orange-700">3560</span></div><p className="mt-2 text-sm text-slate-600">70 kg · 45 min · 炎熱</p></button></div></div>
