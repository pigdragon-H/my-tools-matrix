...
const ui = {
  zh: {
    ...
    q1: "IQ 100 代表什麼？", a1: "IQ 100 是常模的平均值，代表你的分數正好落在同齡常模的中間，約有一半的人分數比你高、一半比你低。",
    q2: "為什麼標準差通常設 15？", a2: "多數現代量表（如 Wechsler）採用平均 100、標準差 15 的設定，這是常模化的慣例；有些量表用 SD 16，換算時需先確認。",
    q3: "百分位和 IQ 有什麼關係？", a3: "百分位表示你勝過多少比例的人。透過 Z 分數對應常態分布，IQ 115 約在第 84 百分位，IQ 130 約在第 98 百分位。",
