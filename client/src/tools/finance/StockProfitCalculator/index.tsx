...
const ui = {
  zh: {
    ...
    intro: "本工具為 股票損益計算機，依公開公式於瀏覽器端試算，輸入買進股價、賣出股價、股數、手續費總額後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    a2: "**不含**。本工具計算的是「純資本利得(capital gain)」,即售價減成本。若您想看含股息的總報酬率(Total Return),可用「複利計算機」搭配把股息再投入算進去,或用 (期末市值 + 累計股息) / 期初市值 - 1。",
    q3: "短線當沖跟長期持有計算上有什麼差?",
    ...
    q5: "股價與報酬輸入會上傳到伺服器嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內以 JavaScript 完成,股價、股數、手續費等敏感交易資料不會傳送到任何伺服器,也不會記錄到日誌或資料庫。",
    q6: "賣出虧損可以抵稅嗎?",
