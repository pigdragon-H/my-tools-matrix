...
const ui = {
  zh: {
    ...
    premiumTitle: "解鎖進階版",
    premiumText: "Premium 解鎖股票損益計算機的批次試算、結果歷史、PDF 匯出、多場景比較與廣告移除。",
  ...
  en: {
    ...
    premiumText: "Premium unlocks batch calculation, history, PDF export, multi-scenario comparison, and ad-free for Stock Profit Calculator.",
    premiumChips_zh: "批次試算 · 歷史紀錄 · PDF 匯出 · 廣告移除",
    premiumChips_en: "Batch · History · PDF Export · Ad-free",
    ...
    q1: "About: 手續費要怎麼算?券商和交易稅誰多?",
    a1: "For \"手續費要怎麼算?券商和交易稅誰多?\": Stock Profit Calculator runs the standard formula client-side; no data leaves the browser. Use the band guidance shown next to the result for your next step.",
    q2: "About: 本工具的「報酬率」是含股息再投入嗎?",
    a2: "For \"本工具的「報酬率」是含股息再投入嗎?\": Stock Profit Calculator runs the standard formula client-side; no data leaves the browser. For unusual scenarios, consult a qualified professional.",
    q3: "About: 短線當沖跟長期持有計算上有什麼差?",
    a3: "For \"短線當沖跟長期持有計算上有什麼差?\": Stock Profit Calculator runs the standard formula client-side; no data leaves the browser. Use the band guidance shown next to the result for your next step.",
    q4: "About: 美股稅後報酬要怎麼估?",
    a4: "For \"美股稅後報酬要怎麼估?\": Stock Profit Calculator runs the standard formula client-side; no data leaves the browser. For unusual scenarios, consult a qualified professional.",
    q5: "About: 股價與報酬輸入會上傳到伺服器嗎?",
    a5: "For \"股價與報酬輸入會上傳到伺服器嗎?\": Stock Profit Calculator runs the standard formula client-side; no data leaves the browser. Use the band guidance shown next to the result for your next step.",
    q6: "About: 賣出虧損可以抵稅嗎?",
    a6: "For \"賣出虧損可以抵稅嗎?\": Stock Profit Calculator runs the standard formula client-side; no data leaves the browser. For unusual scenarios, consult a qualified professional."
  },
} as const;
