...
const ui = {
  zh: {
    ...
    intro: "本工具為 FIRE 目標數字計算機，依公開公式於瀏覽器端試算，輸入預計年支出、安全提領率、目前已存資產、預期年化報酬率後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    premiumText: "進階版加入通膨調整目標、Monte Carlo 存活率、分階段提領與多情境達標路徑,協助你精算真正的財務自由時間表。",
    ...
    q3: "達成進度代表什麼?",
    a3: "達成進度 = 目前已存資產 ÷ FIRE 目標數字,反映你距離財務自由的百分比。",
    q4: "達標年數怎麼推估?",
