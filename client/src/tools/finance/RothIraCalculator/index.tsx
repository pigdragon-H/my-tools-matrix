// @profile B
// Profile B · 計算機-YMYL · RothIraCalculator（GOLD-STANDARD-001 compatible · clone of MeetingCostCalculator）
...
const bands = [
  { key: "tiny", range: "< 20", label: { zh: "極低 (< 20)", en: "Very low (< 20)" }, desc: { zh: "落在「極低」級距< 20。獲利佔比 < 20%,投資年限短或報酬低,複利尚未發揮。", en: "Falls in the \"Very low\" band (< 20). This is the very low range for Roth IRA Calculator." } },
  { key: "normal", range: "20–40", label: { zh: "低 (20–40)", en: "Low (20–40)" }, desc: { zh: "落在「低」級距20–40。20-40%,複利開始累積,常見於 10-15 年期。", en: "Falls in the \"Low\" band (20–40). This is the low range for Roth IRA Calculator." } },
  { key: "notable", range: "40–55", label: { zh: "中等 (40–55)", en: "Moderate (40–55)" }, desc: { zh: "落在「中等」級距40–55。40-55%,過半,長期投資的複利效果顯現。", en: "Falls in the \"Moderate\" band (40–55). This is the moderate range for Roth IRA Calculator." } },
  { key: "high", range: "55–70", label: { zh: "偏高 (55–70)", en: "Elevated (55–70)" }, desc: { zh: "落在「偏高」級距55–70。55-70%,獲利已超過本金,接近 20-25 年期成果。", en: "Falls in the \"Elevated\" band (55–70). This is the elevated range for Roth IRA Calculator." } },
  { key: "major", range: "70–85", label: { zh: "高 (70–85)", en: "High (70–85)" }, desc: { zh: "落在「高」級距70–85。70-85%,複利強勁,多為 30 年以上長期投資。", en: "Falls in the \"High\" band (70–85). This is the high range for Roth IRA Calculator." } },
  { key: "executive", range: "≥ 85", label: { zh: "極高 (≥ 85)", en: "Very high (≥ 85)" }, desc: { zh: "落在「極高」級距≥ 85。> 85%,絕大部分為免稅獲利,展現極長期複利的威力。", en: "Falls in the \"Very high\" band (≥ 85). This is the very high range for Roth IRA Calculator." } },
] as const;

const affiliateItems: AffiliateItem[] = [
  { label: { zh: "複利計算機", en: "Compound Interest Calculator" }, href: "/tools/finance/compound-interest-calculator" },
  { label: { zh: "401k 退休帳戶計算機", en: "401k Retirement Calculator" }, href: "/tools/finance/retirement-401k-calculator" },
...
const ui = {
  zh: {
    badge: "財務 · Roth IRA 計算機 · 黃金工具",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Roth IRA Calculator · Roth IRA 計算機",
    subtitle: "輸入每年提撥、報酬率與年數,立即算出 Roth IRA 終值、總提撥與免稅獲利佔比",
    intro: "本工具為 Roth IRA 計算機，依公開公式於瀏覽器端試算，輸入每年提撥、年化報酬率%、年數、目前餘額後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    trustNote: "本工具僅供一般情境試算，未涵蓋極端條件、稅務優惠、地區差異或特殊規範。涉及重大決策請以合格專業人士為準。",
    quickActionCard: "快速範例卡",
    tryExample: "試算Roth IRA 計算機",
    examplePreview: "免稅獲利佔比",
    examplePerson: "標準範例",
    fillExample: "一鍵填入標準範例",
    previewActivePath: "填入進階範例",
    examplesCalculator: "範例 → 計算機",
    enterValues: "輸入每年提撥、年化報酬率%、年數、目前餘額",
    examplesHelper: "先用範例了解結果輸出，再改成自己的數字。",
    metric: "標準",
    imperial: "進階",
    exampleCards: "範例卡",
    baselineExample: "標準範例",
    baselineExampleValue: "年提 18 萬 · 7% · 30 年",
    baselineExampleNote: "每年提撥 180000 · 年化報酬率% 7",
    activeExample: "進階範例",
    activeExampleValue: "年提 21 萬 · 8% · 25 年 · 起始 30 萬",
    activeExampleNote: "每年提撥 加倍 · 觀察 免稅獲利佔比 變化",
    flowDemo: "數字流向示範",
    calculator: "Roth IRA 計算機",
    annualContribution: "每年提撥",
    ...
    metricCTail: "$",
    headlineCaption: "Roth IRA 計算機 · 即時試算",
    fatLossTarget: "免稅獲利",
    resultIntelligence: "結果解讀",
    tdeeMatrix: "Roth IRA 計算機 · 級距矩陣",
    ...
    nextActionItem1: "把 每年提撥 與 年數 各調 ±10% 觀察主要結果敏感度",
    ...
    decisionPath: "決策路徑",
    decisionTitle: "Roth IRA 計算機 · 決策四步",
    bmrStep: "Step 1 · 蒐集參數",
    bmrNote: "先把 每年提撥、年化報酬率%、年數、目前餘額 四個欄位填齊。",
    deficitStep: "Step 2 · 套公式",
    deficitNote: "依每年提撥、報酬率與年數計算 Roth IRA 終值、總提撥與免稅獲利佔比。",
    trendStep: "Step 3 · 看級距",
    trendNote: "對照六格級距,定位主要結果。",
    mealStep: "Step 4 · 行動",
    mealNote: "依級距提示挑一個下一步,執行 30 天後回來重算。",
    knowledge: "工具知識庫",
    knowledgeTitle: "Roth IRA 計算機 · 觀念整理",
    definition: "定義",
    definitionText: "Roth IRA 計算機以每年提撥金額、年化報酬率、投資年數與目前餘額,計算退休帳戶終值、累計提撥與免稅獲利佔比,展現稅後提撥、免稅成長的長期威力。",
    formula: "公式",
    formulaText: "終值 = 目前餘額 × (1 + r)^年數 + 每年提撥 × ((1 + r)^年數 − 1) ÷ r;免稅獲利 = 終值 − 總提撥",
    limitations: "限制",
    limitationsText: "本工具以名目報酬估算,不含通膨、投資波動、提撥上限與收入資格限制。",
    interpretation: "解讀",
    interpretationText: "免稅獲利佔比越高代表複利成長越顯著;年限越長、佔比越高,凸顯及早投資的重要性。",
    context: "情境",
    ...
    premiumTitle: "專業版 免稅退休規劃",
    premiumText: "解鎖含通膨實質終值、Roth vs Traditional 稅後比較、提撥上限與收入資格檢核、轉換策略與提領排程。",
    premiumChips_zh: "通膨調整|稅後比較|資格檢核|轉換策略",
    premiumChips_en: "Inflation|After-tax|Eligibility|Conversion",
    ...
    q1: "Roth IRA 的最大優勢是什麼?",
    a1: "Roth IRA 用稅後的錢提撥,但帳戶內的成長與未來提領完全免稅。對年輕、目前稅率較低、預期退休時稅率更高的人特別有利,因為今天繳低稅、未來免稅領出,複利成長全歸自己。",
    q2: "Roth 和 Traditional 怎麼選?",
    a2: "若您預期退休時稅率高於現在(年輕、收入成長期),選 Roth(現在繳稅、未來免稅);若預期退休稅率較低,選 Traditional(現在抵稅、未來繳稅)。許多人兩者並用以分散稅務風險。",
    q3: "提撥有上限嗎?",
    a3: "有。美國 2024 年 IRA 年度提撥上限為 $7,000(50 歲以上 $8,000),且高收入者有資格限制(MAGI phase-out)。本工具以您輸入的提撥金額試算,實際以 IRS 規定為準。",
    q4: "可以提前領本金嗎?",
    a4: "Roth IRA 的「本金」(已提撥部分)可隨時免稅免罰提領,但「獲利」在 59½ 歲且帳戶滿 5 年前提領需繳稅加罰款。這項彈性讓 Roth 兼具退休與緊急備援功能。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內以 JavaScript 完成,提撥與報酬等資料不會傳送到任何伺服器。",
    q6: "可以模擬通膨嗎?",
    a6: "含通膨的實質終值、Roth vs Traditional 稅後比較、提撥上限檢核與提領排程屬於專業版功能,免費版以名目報酬估算。"
  },
  en: {
    badge: "Finance · Roth IRA Calculator · Gold Tool",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Roth IRA Calculator",
    subtitle: "Enter annual contribution, return rate, and years to see the Roth IRA future value, total contributed, and tax-free gain share",
    intro: "Roth IRA Calculator runs the standard formula in your browser. Enter annual contribution, annual return pct, years, current balance to see the primary result and three supporting metrics. Nothing is uploaded.",
    ...
    tryExample: "Try Roth IRA Calculator",
    examplePreview: "Tax-Free Gain Share",
    examplePerson: "Standard example",
    fillExample: "Fill standard example",
    previewActivePath: "Fill advanced example",
    examplesCalculator: "Examples → Calculator",
    enterValues: "Enter annual contribution, annual return pct, years, current balance",
    ...
    baselineExampleValue: "180k/yr · 7% · 30y",
    baselineExampleNote: "Annual Contribution 180000 · Annual Return Pct 7",
    activeExample: "Advanced example",
    activeExampleValue: "210k/yr · 8% · 25y · 300k start",
    activeExampleNote: "Annual Contribution doubled · watch Tax-Free Gain Share react",
    ...
    primaryValue: "Tax-Free Gain Share",
    primaryUnitTail: "%",
    secondaryLabel: "Account Future Value",
    secondaryTail: "$",
    metricALabel: "Tax-Free Gain Share",
    metricACaption: "Main figure from the standard formula",
    metricATail: "%",
    metricBLabel: "Account Future Value",
    metricBCaption: "Secondary metric tied to the primary",
    metricBTail: "$",
    metricCLabel: "Total Contributed",
    metricCCaption: "Percentage view",
    metricCTail: "$",
    headlineCaption: "Roth IRA Calculator · live calc",
    fatLossTarget: "Tax-Free Gain",
    resultIntelligence: "Result intelligence",
    tdeeMatrix: "Roth IRA Calculator · band matrix",
    ...
    nextActionItem1: "Move Annual Contribution and Years by ±10% to see sensitivity.",
    ...
    decisionTitle: "Roth IRA Calculator · 4-step decision",
    bmrStep: "Step 1 · Gather inputs",
    bmrNote: "Fill annual contribution, annual return pct, years, current balance.",
    deficitStep: "Step 2 · Apply formula",
    deficitNote: "Roth IRA Calculator standard formula.",
    ...
    knowledgeTitle: "Roth IRA Calculator · concept primer",
    definition: "Definition",
    definitionText: "Roth IRA Calculator converts inputs (annual contribution, annual return pct, years, current balance) into Tax-Free Gain Share. It is widely used in personal finance and investment planning.",
    formula: "Formula",
    formulaText: "result = f(annual contribution, annual return pct, years, current balance)",
    ...
    premiumTitle: "Pro Tax-Free Retirement",
    premiumText: "Unlock inflation-adjusted value, Roth vs Traditional after-tax compare, contribution-limit and income checks, conversion strategy, and withdrawal schedule.",
    premiumChips_zh: "通膨調整|稅後比較|資格檢核|轉換策略",
    premiumChips_en: "Inflation|After-tax|Eligibility|Conversion",
    ...
    q1: "What does Roth IRA Calculator calculate?",
    a1: "Roth IRA Calculator applies the standard formula to your inputs and returns Tax-Free Gain Share plus three supporting metrics, all computed in your browser.",
    q2: "Which inputs do I need for Roth IRA Calculator?",
    a2: "Enter annual contribution, annual return pct, years, current balance. Roth IRA Calculator runs the standard formula client-side and updates instantly as you type.",
    ...
    a6: "Unlock inflation-adjusted value, Roth vs Traditional after-tax compare, contribution-limit and income checks, conversion strategy, and withdrawal schedule."
  },
} as const;
...
export default function RothIraCalculator() {
  ...
  const [annualContribution, setAnnualContribution] = useState("180000");
  ...
  }, [annualContribution, annualReturnPct, years, currentBalance]);

  const primaryDisplay = fmt(result.gainShare, 1);
  const secondaryDisplay = fmt(result.fv, 0);
  const tertiaryDisplay = fmt(result.totalContributed, 0);
  const quaternaryDisplay = fmt(result.taxFreeGain, 0);

  function fillSolid() { setUnit("metric"); setAnnualContribution("180000"); setAnnualReturnPct("7"); setYears("30"); setCurrentBalance("0"); }
  function fillHighSalary() { setUnit("imperial"); setAnnualContribution("210000"); setAnnualReturnPct("8"); setYears("25"); setCurrentBalance("300000"); }
      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_#ffe4e6,_#fff7ed_45%,_#fce7f3)]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            ...
            <aside className="rounded-[2rem] border border-rose-100 bg-white/90 p-6 shadow-2xl shadow-rose-950/10 backdrop-blur"><p className="text-xs font-black uppercase tracking-[0.18em] text-rose-700">{t.quickActionCard}</p><h2 className="mt-2 text-2xl font-black">{t.tryExample}</h2><div className="mt-5 rounded-3xl bg-rose-600 p-5 text-white"><div className="text-xs font-bold uppercase text-rose-100">{t.examplePreview}</div><div className="mt-1 text-5xl font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div><div className="text-sm font-bold text-rose-100">{t.headlineCaption}</div></div><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.examplePerson}</div><div className="font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.flowDemo}</div><div className="font-black">{annualContribution} × {annualReturnPct}</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.fatLossTarget}</div><div className="font-black">{secondaryDisplay}</div></div></div><button onClick={fillSolid} className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-4 text-sm font-black text-white">{t.fillExample}</button><button onClick={fillHighSalary} className="mt-3 w-full rounded-2xl border border-rose-200 bg-rose-50 px-5 py-4 text-sm font-black text-rose-900">{t.previewActivePath}</button></aside>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5"><h3 className="text-lg font-black">{t.calculator}</h3><div className="mt-4 grid gap-4 md:grid-cols-2"><label className="block text-sm font-black text-slate-700">{t.annualContribution}<input type="number" step="10000" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={annualContribution} onChange={(e) => setAnnualContribution(e.target.value)} /></label><label className="block text-sm font-black text-emerald-700">{t.annualReturnPct}<input type="number" step="0.5" className="mt-2 w-full rounded-2xl border border-emerald-200 px-4 py-3 text-lg font-bold" value={annualReturnPct} onChange={(e) => setAnnualReturnPct(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.years}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={years} onChange={(e) => setYears(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.currentBalance}<input type="number" step="10000" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={currentBalance} onChange={(e) => setCurrentBalance(e.target.value)} /></label></div></div>
          </div>
        </section>
        ...
        <AdSenseWrapper showAds={true} adSlot="roth-ira-calculator-result-intelligence" adFormat="horizontal" className="my-2" />
        ...
        <section aria-label="L14 常見問題後廣告位:廣告位" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="roth-ira-calculator-faq" position="inline" /></section>
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7">{/* L17-TrustRelatedReferences */}<p className="text-xs font-black uppercase tracking-[0.2em] text-rose-700">{t.trustReferences}</p><div className="mt-4 grid gap-5 md:grid-cols-3"><div><h2 className="text-xl font-black">{t.trust}</h2><p className="mt-2 text-sm leading-6 text-slate-700">{t.trustText}</p></div><div><h2 className="text-xl font-black">{t.relatedTools}</h2><p className="mt-2 text-sm leading-6 text-slate-700">{t.relatedToolsText}</p></div><div><h2 className="text-xl font-black">{t.references}</h2><p className="mt-2 text-sm leading-6 text-slate-700">{t.referencesText}</p></div></div></section>
      </div>
    </main>
  );
}
