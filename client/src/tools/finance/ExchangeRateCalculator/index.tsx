...
const ui = {
  zh: {
    ...
    intro: "本工具以報價匯率將來源幣金額換算為目標幣,計入比例手續費與固定手續費,呈現實際淨換得金額、換匯總成本與反向匯率,讓您在換匯前看清真正的代價。",
    trustNoteLabel: "注意事項:",
    ...
    q3: "反向匯率有什麼用?",
    a3: "反向匯率是報價匯率的倒數,方便您把目標幣換回來源幣時快速估算,也能交叉檢查報價方向是否正確。",
    q4: "固定手續費怎麼計算?",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題補充區" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="exchange-rate-calculator-faq" position="inline" /></section>
