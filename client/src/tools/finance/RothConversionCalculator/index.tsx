...
const ui = {
  zh: {
    ...
    intro: "本工具為 Roth 轉換稅務試算機，依公開公式於瀏覽器端試算，輸入擬轉換金額、目前邊際稅率、退休時預期稅率、轉換後成長年數後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    premiumText: "進階版加入稅率級距遞進、分年轉換階梯、IRMAA 與州稅估算、繼承免稅規劃,協助您設計最佳轉換策略。",
    ...
    q3: "什麼情況下轉換最划算?",
    a3: "當您預期退休時稅率高於現在、或想留免稅資產給繼承人、或當年所得偏低時,轉換通常最划算。",
    q4: "稅率差代表什麼?",
    a4: "稅率差 = 退休預期稅率 − 目前邊際稅率;為正代表現在轉換較有利,為負則偏不利。",
    q5: "轉換有金額上限嗎?",
    a5: "Roth 轉換本身無年度金額上限,但轉換金額會計入當年應稅所得,可能推升您的稅率級距。",
    q6: "這個試算準確嗎?",
