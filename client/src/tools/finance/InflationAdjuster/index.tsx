...
const ui = {
  zh: {
    ...
    adjustedLabel: "已調整", remainingPowerLabel: "剩餘購買力", nominalLabel: "名目金額",
  ...
  en: {
    ...
    adjustedLabel: "Adjusted", remainingPowerLabel: "Remaining purchasing power", nominalLabel: "Nominal amount",
