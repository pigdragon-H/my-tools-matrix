...
const ui = {
  zh: {
    ...
    trustNoteLabel: "注意事項：", trustNote: "此工具以你輸入的匯率試算；實際匯率隨市場即時波動，銀行與匯款商會加上買賣價差與手續費，實際成交請以交易當下報價為準。",
    ...
    limitations: "限制", limitationsText: "本工具以你輸入的單一匯率試算；不含買賣價差、跨行費、ATM 海外提領費與即時波動，實際到手金額可能因這些成本而降低。",
    ...
    q3: "匯率要去哪裡查？", a3: "可參考銀行牌告、財經網站或匯款商即時報價；中間市場匯率是基準，但實際換匯會加上買賣價差與手續費，填入你查到的實際匯率最準。",
    ...
    q6: "這個工具是即時匯率嗎？", a6: "不是。它以你輸入的匯率計算，方便快速試算；如需即時匯率，請以交易當下的銀行或匯款商報價為準。",
  },
  en: {
