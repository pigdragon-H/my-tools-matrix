        ...
        <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
          ...
          <section className="grid gap-5 lg:grid-cols-[1fr_0.8fr]">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
              <p className="text-xs font-black uppercase tracking-[0.16em] text-slate-500">{lang === "zh" ? "投資回報旅程" : "Investment Return Journey"}</p>
              <h2 className="mt-2 text-3xl font-black">{lang === "zh" ? "投資不同，回報不同" : "Different Investments, Different Returns"}</h2>
              <div className="mt-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "輸入數字" : "Input Amounts"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "初始投資、回報" : "Initial investment, return"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 rounded-full bg-blue-100 px-3 py-1 text-xs font-black text-blue-700">{lang === "zh" ? "步驟 2" : "Step 2"}</div>
                  <div>
                    <h3 className="font-black">ROI</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "計算回報率" : "Calculate return rate"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 rounded-full bg-blue-100 px-3 py-1 text-xs font-black text-blue-700">{lang === "zh" ? "步驟 3" : "Step 3"}</div>
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "比較投資" : "Compare Investments"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "評估不同方案" : "Evaluate options"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "做出決策" : "Make Decision"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "選擇最佳投資" : "Choose best investment"}</p>
                  </div>
                </div>
              </div>
            </div>
