...
const ui = {
  zh: {
    ...
    intro: "本工具為 安全提領率計算機，依公開公式於瀏覽器端試算，輸入退休投資組合、年度提領率(%)、預期年報酬率(%)、退休年數後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    definition: "定義",
    definitionText: "安全提領率計算機以退休投資組合、年度提領率、預期年報酬率與退休年數,計算可持續的年度與每月提領金額、期末餘額與是否耗盡,協助規劃退休現金流並評估 4% 法則在您情境下的可行性。",
    formula: "公式",
    ...
    q2: "4% 法則可靠嗎?",
    a2: "經典「4% 法則」源自 Trinity Study,指以投資組合 4% 為首年提領、其後隨通膨調整,在 30 年期間有很高機率不耗盡。它是實用起點,但受市場開局順序、資產配置與退休年數影響;本工具讓您自訂提領率、報酬率與年數試算,而非套單一數字。",
    q3: "提領率該設多少?",
    ...
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內以 JavaScript 完成,投資組合與提領率等資料不會傳送到任何伺服器。",
    q6: "可以模擬通膨嗎?",
