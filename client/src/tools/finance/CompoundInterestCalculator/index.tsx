        ...
        <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
          ...
          <section className="grid gap-5 lg:grid-cols-[1fr_0.8fr]">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7">
              <p className="text-xs font-black uppercase tracking-[0.16em] text-slate-500">{lang === "zh" ? "複利增長旅程" : "Compound Growth Journey"}</p>
              <h2 className="mt-2 text-3xl font-black">{lang === "zh" ? "時間變鼠，複利變鼠" : "Time Multiplies, Compound Grows"}</h2>
              <div className="mt-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "初始資本" : "Initial Capital"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "設定起始金額" : "Set starting amount"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 rounded-full bg-blue-100 px-3 py-1 text-xs font-black text-blue-700">{lang === "zh" ? "步驟 2" : "Step 2"}</div>
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "利率設定" : "Rate Setup"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "設定年利率" : "Set annual interest rate"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 rounded-full bg-blue-100 px-3 py-1 text-xs font-black text-blue-700">{lang === "zh" ? "步驟 3" : "Step 3"}</div>
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "複利計算" : "Calculate Compound"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "計算未來余额" : "Project future balance"}</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-black">{lang === "zh" ? "長期規劃" : "Long-term Plan"}</h3>
                    <p className="mt-1 text-sm text-slate-600">{lang === "zh" ? "制定存讀計畫" : "Plan savings strategy"}</p>
                  </div>
                </div>
              </div>
            </div>
