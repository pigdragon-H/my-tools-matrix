...
const ui = {
  zh: {
    ...
    intro: "本工具採用銀行公會與 Investopedia 公認的「等額本息」公式（PMT），輸入貸款金額、年利率與年期即可估算每月還款、總還款金額與總利息支出，並以 5 / 10 / 15 / 20 / 25 / 30 年六段對照表協助您比較不同年期的月付負擔與利息燒蝕程度，做出最適決策。",
    trustNoteLabel: "信任提醒：",
    ...
    examplesHelper: "先用範例理解月付、總利息與年期關係，再改成您自己的金額、利率與年期。",
    metric: "新台幣",
    imperial: "美元",
    exampleCards: "範例卡",
    ...
    termMatrixNote: "下列卡片以目前貸款金額與年利率為基礎，乘上不同年期換算月付與總利息，協助您直觀比較「年期越長，月付越輕，但總利息暴增」的取捨。",
