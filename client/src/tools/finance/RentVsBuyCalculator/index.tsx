// @profile B
// Profile B · 計算機-YMYL · RentVsBuyCalculator（GOLD-STANDARD-001 compatible · clone of MeetingCostCalculator）
...
const bands = [
  { key: "tiny", range: "< -50000", label: { zh: "強烈租屋 (< -50000)", en: "Strongly rent (< -50000)" }, desc: { zh: "落在「強烈租屋」級距< -50000。購屋淨成本遠高於租屋,於此期間強烈建議租屋。", en: "Falls in the \"Strongly rent\" band (< -50000). Buying costs far exceed renting; strongly favor renting for this horizon." } },
  { key: "normal", range: "-50000–-15000", label: { zh: "傾向租屋 (-50000–-15000)", en: "Lean rent (-50000–-15000)" }, desc: { zh: "落在「傾向租屋」級距-50000–-15000。購屋成本高於租屋,傾向租屋較划算。", en: "Falls in the \"Lean rent\" band (-50000–-15000). Buying costs more than renting; leaning toward renting." } },
  { key: "notable", range: "-15000–0", label: { zh: "略偏租屋 (-15000–0)", en: "Slightly rent (-15000–0)" }, desc: { zh: "落在「略偏租屋」級距-15000–0。差距不大但略偏租屋,可保留彈性。", en: "Falls in the \"Slightly rent\" band (-15000–0). Small gap, slightly favoring renting; keep flexibility." } },
  { key: "high", range: "0–15000", label: { zh: "略偏購屋 (0–15000)", en: "Slightly buy (0–15000)" }, desc: { zh: "落在「略偏購屋」級距0–15000。差距不大但略偏購屋,若長住可考慮買進。", en: "Falls in the \"Slightly buy\" band (0–15000). Small gap, slightly favoring buying; consider buying if staying long." } },
  { key: "major", range: "15000–50000", label: { zh: "傾向購屋 (15000–50000)", en: "Lean buy (15000–50000)" }, desc: { zh: "落在「傾向購屋」級距15000–50000。購屋淨省較明顯,傾向購屋。", en: "Falls in the \"Lean buy\" band (15000–50000). Buying saves noticeably; leaning toward buying." } },
  { key: "executive", range: "≥ 50000", label: { zh: "強烈購屋 (≥ 50000)", en: "Strongly buy (≥ 50000)" }, desc: { zh: "落在「強烈購屋」級距≥ 50000。購屋淨省極大,於此期間強烈建議購屋。", en: "Falls in the \"Strongly buy\" band (≥ 50000). Buying saves a lot; strongly favor buying for this horizon." } },
] as const;
...
const ui = {
  zh: {
    badge: "財務 · 租屋 vs 購屋計算機 · 黃金工具",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Rent vs Buy Calculator · 租屋 vs 購屋計算機",
    subtitle: "在相同期間內比較租屋與購屋的總成本,找出較划算的選項。",
    intro: "本工具為 租屋 vs 購屋計算機，依公開公式於瀏覽器端試算，輸入房屋購買總價、目前每月租金、計畫持有年數、年持有成本率後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    trustNote: "本工具僅供一般情境試算，未涵蓋極端條件、稅務優惠、地區差異或特殊規範。涉及重大決策請以合格專業人士為準。",
    quickActionCard: "快速範例卡",
    tryExample: "試算租屋 vs 購屋計算機",
    examplePreview: "購屋相對租屋淨省",
    examplePerson: "標準範例",
    fillExample: "一鍵填入標準範例",
    previewActivePath: "填入進階範例",
    examplesCalculator: "範例 → 計算機",
    enterValues: "輸入房屋購買總價、目前每月租金、計畫持有年數、年持有成本率",
    examplesHelper: "先用範例了解結果輸出，再改成自己的數字。",
    metric: "標準",
    imperial: "進階",
    exampleCards: "範例卡",
    baselineExample: "標準範例",
    baselineExampleValue: "7 年標準情境",
    baselineExampleNote: "房屋購買總價 400000 · 目前每月租金 2000",
    activeExample: "進階範例",
    activeExampleValue: "長住高租金情境",
    activeExampleNote: "房屋購買總價 加倍 · 觀察 購屋相對租屋淨省 變化",
    flowDemo: "數字流向示範",
    calculator: "租屋 vs 購屋計算機",
    homePurchasePrice: "房屋購買總價",
    currentMonthlyRent: "目前每月租金",
    yearsYouPlanToStay: "計畫持有年數",
    annualOwnershipCostRate: "年持有成本率",
    resultCard: "結果卡片",
    primaryValue: "購屋相對租屋淨省",
    primaryUnitTail: "$",
    secondaryLabel: "期間總租金支出",
    secondaryTail: "$",
    metricALabel: "購屋相對租屋淨省",
    metricACaption: "依公開公式試算的主要數值",
    metricATail: "$",
    metricBLabel: "期間總租金支出",
    metricBCaption: "與主要結果連動的次要量值",
    metricBTail: "$",
    metricCLabel: "期間購屋淨成本",
    metricCCaption: "百分比形式的觀察點",
    metricCTail: "$",
    headlineCaption: "租屋 vs 購屋計算機 · 即時試算",
    fatLossTarget: "損益平衡等值月租",
    resultIntelligence: "結果解讀",
    tdeeMatrix: "租屋 vs 購屋計算機 · 級距矩陣",
    ...
    nextActionItem1: "把 房屋購買總價 與 計畫持有年數 各調 ±10% 觀察主要結果敏感度",
    ...
    decisionPath: "決策路徑",
    decisionTitle: "租屋 vs 購屋計算機 · 決策四步",
    bmrStep: "Step 1 · 蒐集參數",
    bmrNote: "先把 房屋購買總價、目前每月租金、計畫持有年數、年持有成本率 四個欄位填齊。",
    deficitStep: "Step 2 · 套公式",
    deficitNote: "Rent vs buy total cost comparison。",
    trendStep: "Step 3 · 看級距",
    trendNote: "對照六格級距,定位主要結果。",
    mealStep: "Step 4 · 行動",
    mealNote: "依級距提示挑一個下一步,執行 30 天後回來重算。",
    knowledge: "工具知識庫",
    knowledgeTitle: "租屋 vs 購屋計算機 · 觀念整理",
    definition: "定義",
    definitionText: "租屋 vs 購屋計算機在相同持有期間內,比較總租金支出與購屋淨成本(含持有成本與期末增值權益),協助判斷哪一方較划算。",
    formula: "公式",
    formulaText: "總租金 = Σ 各年月租×12(含租金通膨);購屋淨成本 = 持有成本 + 頭期/手續 − 期末權益增值;淨省 = 總租金 − 購屋淨成本。",
    limitations: "限制",
    limitationsText: "本工具採固定增值率與成本率的簡化模型,未計入完整房貸攤還、稅務優惠、機會成本與市場波動,實際結果會偏離估算。",
    interpretation: "解讀",
    interpretationText: "購屋淨省為正代表此期間購屋較划算,為負則租屋較划算;持有越久通常越偏向購屋有利。",
    context: "情境",
    ...
    premiumTitle: "Rent vs Buy Pro 進階",
    premiumText: "進階版加入完整房貸攤還、稅務優惠、投資機會成本、敏感度分析與多情境損益平衡圖。",
    premiumChips_zh: "完整攤還|稅務優惠|機會成本|敏感度分析",
    premiumChips_en: "Amortization|Tax benefits|Opportunity cost|Sensitivity",
    ...
    q1: "這個比較怎麼算?",
    a1: "工具比較相同期間內「總租金支出」與「購屋淨成本(持有成本 + 頭期/手續 − 增值權益)」,差額即購屋相對租屋的淨省或淨虧。",
    q2: "為什麼持有年數很重要?",
    a2: "持有越久,頭期款與手續費等一次性成本被攤得越薄,且增值累積越多,通常越偏向購屋有利。",
    q3: "年持有成本率包含什麼?",
    a3: "年持有成本率涵蓋房貸利息、房產稅、保險、維修與管理費等,以購價的百分比概估。",
    q4: "有計入房價增值嗎?",
    a4: "有。工具假設房價以約 3% 年增值,並把期末權益增值從購屋成本中扣除。",
    q5: "損益平衡月租代表什麼?",
    a5: "損益平衡等值月租指若租金高於此值則購屋較划算,低於此值則租屋較划算的臨界月租。",
    q6: "結果能當買房決定依據嗎?",
    a6: "本工具為簡化估算,未計入完整房貸攤還、稅務優惠、機會成本與市場波動,僅供初步比較。"
  },
  en: {
    badge: "Finance · Rent vs Buy Calculator · Gold Tool",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Rent vs Buy Calculator",
    subtitle: "Compare total costs of renting versus buying over the same horizon.",
    intro: "Rent vs Buy Calculator runs the standard formula in your browser. Enter home purchase price, current monthly rent, years you plan to stay, annual ownership cost rate to see the primary result and three supporting metrics. Nothing is uploaded.",
    ...
    tryExample: "Try Rent vs Buy Calculator",
    examplePreview: "Buying net savings vs renting",
    examplePerson: "Standard example",
    fillExample: "Fill standard example",
    previewActivePath: "Fill advanced example",
    examplesCalculator: "Examples → Calculator",
    enterValues: "Enter home purchase price, current monthly rent, years you plan to stay, annual ownership cost rate",
    ...
    baselineExampleValue: "Standard 7-year case",
    baselineExampleNote: "Home purchase price 400000 · Current monthly rent 2000",
    activeExample: "Advanced example",
    activeExampleValue: "Long-stay high-rent case",
    activeExampleNote: "Home purchase price doubled · watch Buying net savings vs renting react",
    ...
    yearsYouPlanToStay: "Years you plan to stay",
    annualOwnershipCostRate: "Annual ownership cost rate",
    resultCard: "Result card",
    primaryValue: "Buying net savings vs renting",
    primaryUnitTail: "$",
    secondaryLabel: "Total rent over period",
    secondaryTail: "$",
    metricALabel: "Buying net savings vs renting",
    metricACaption: "Main figure from the standard formula",
    metricATail: "$",
    metricBLabel: "Total rent over period",
    metricBCaption: "Secondary metric tied to the primary",
    metricBTail: "$",
    metricCLabel: "Net cost of buying",
    metricCCaption: "Percentage view",
    metricCTail: "$",
    headlineCaption: "Rent vs Buy Calculator · live calc",
    fatLossTarget: "Break-even equivalent rent",
    resultIntelligence: "Result intelligence",
    tdeeMatrix: "Rent vs Buy Calculator · band matrix",
    ...
    dailyGap: "Daily gap",
    tertiaryTag: "Net cost of buying",
    ...
    nextActionItem1: "Move Home purchase price and Years you plan to stay by ±10% to see sensitivity.",
    ...
    decisionTitle: "Rent vs Buy Calculator · 4-step decision",
    bmrStep: "Step 1 · Gather inputs",
    bmrNote: "Fill home purchase price, current monthly rent, years you plan to stay, annual ownership cost rate.",
    deficitStep: "Step 2 · Apply formula",
    deficitNote: "Rent vs Buy Calculator standard formula.",
    ...
    knowledgeTitle: "Rent vs Buy Calculator · concept primer",
    definition: "Definition",
    definitionText: "Rent vs Buy Calculator converts inputs (home purchase price, current monthly rent, years you plan to stay, annual ownership cost rate) into Buying net savings vs renting. It is widely used in personal finance and investment planning.",
    formula: "Formula",
    formulaText: "result = f(home purchase price, current monthly rent, years you plan to stay, annual ownership cost rate)",
    ...
    premiumTitle: "Rent vs Buy Pro",
    premiumText: "Pro adds full amortization, tax benefits, investment opportunity cost, sensitivity analysis, and multi-scenario break-even charts.",
    premiumChips_zh: "完整攤還|稅務優惠|機會成本|敏感度分析",
    premiumChips_en: "Amortization|Tax benefits|Opportunity cost|Sensitivity",
    ...
    q1: "What does Rent vs Buy Calculator calculate?",
    a1: "Rent vs Buy Calculator applies the standard formula to your inputs and returns Buying net savings vs renting plus three supporting metrics, all computed in your browser.",
    q2: "Which inputs do I need for Rent vs Buy Calculator?",
    a2: "Enter home purchase price, current monthly rent, years you plan to stay, annual ownership cost rate. Rent vs Buy Calculator runs the standard formula client-side and updates instantly as you type.",
    ...
    a6: "Pro adds full amortization, tax benefits, investment opportunity cost, sensitivity analysis, and multi-scenario break-even charts."
  },
} as const;
...
export default function RentVsBuyCalculator() {
  ...
  const [yearsYouPlanToStay, setYearsYouPlanToStay] = useState("7");
  const [annualOwnershipCostRate, setAnnualOwnershipCostRate] = useState("4");
  const t = ui[lang];

  const result = useMemo(() => {
const price = Number(homePurchasePrice) || 0; const rent = Number(currentMonthlyRent) || 0; const years = Number(yearsYouPlanToStay) || 0; const costRate = (Number(annualOwnershipCostRate) || 0) / 100; const apprec = 0.03; const rentInflation = 0.03; let totalRent = 0; let r = rent; for (let y = 0; y < years; y++) { totalRent += r * 12; r *= (1 + rentInflation); } const ownershipCosts = price * costRate * years; const downAndClosing = price * 0.05; const homeValueEnd = price * Math.pow(1 + apprec, years); const equityGain = homeValueEnd - price; const totalBuyCost = ownershipCosts + downAndClosing - equityGain; const savingsBuying = totalRent - totalBuyCost; const breakevenRent = years > 0 ? totalBuyCost / (years * 12) : 0; return { primaryKey: savingsBuying, secondaryKey: totalRent, tertiaryKey: totalBuyCost, quaternaryKey: breakevenRent };
  }, [homePurchasePrice, currentMonthlyRent, yearsYouPlanToStay, annualOwnershipCostRate]);
  ...
  function fillSolid() { setUnit("metric"); setHomePurchasePrice("400000"); setCurrentMonthlyRent("2000"); setYearsYouPlanToStay("7"); setAnnualOwnershipCostRate("4"); }
  function fillHighSalary() { setUnit("imperial"); setHomePurchasePrice("400000"); setCurrentMonthlyRent("2800"); setYearsYouPlanToStay("12"); setAnnualOwnershipCostRate("4"); }

  const activeBand = bands.find(b => {
    const r = result.primaryKey;
    if (r < -50000) return 'tiny';
    if (r < -15000) return 'normal';
    if (r < 0) return 'notable';
    if (r < 15000) return 'high';
    if (r < 50000) return 'major';
    return 'executive';
  });
      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_#e0e7ff,_#f8fafc_45%,_#dbeafe)]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            ...
            <aside className="rounded-[2rem] border border-indigo-100 bg-white/90 p-6 shadow-2xl shadow-indigo-950/10 backdrop-blur"><p className="text-xs font-black uppercase tracking-[0.18em] text-indigo-700">{t.quickActionCard}</p><h2 className="mt-2 text-2xl font-black">{t.tryExample}</h2><div className="mt-5 rounded-3xl bg-indigo-600 p-5 text-white"><div className="text-xs font-bold uppercase text-indigo-100">{t.examplePreview}</div><div className="mt-1 text-5xl font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div><div className="text-sm font-bold text-indigo-100">{t.headlineCaption}</div></div><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.examplePerson}</div><div className="font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.flowDemo}</div><div className="font-black">{homePurchasePrice} × {currentMonthlyRent}</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.fatLossTarget}</div><div className="font-black">{secondaryDisplay}</div></div></div><button onClick={fillSolid} className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-4 text-sm font-black text-white">{t.fillExample}</button><button onClick={fillHighSalary} className="mt-3 w-full rounded-2xl border border-indigo-200 bg-indigo-50 px-5 py-4 text-sm font-black text-indigo-900">{t.previewActivePath}</button></aside>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5"><h3 className="text-lg font-black">{t.calculator}</h3><div className="mt-4 grid gap-4 md:grid-cols-2"><label className="block text-sm font-black text-slate-700">{t.homePurchasePrice}<input type="number" step="10000" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={homePurchasePrice} onChange={(e) => setHomePurchasePrice(e.target.value)} /></label><label className="block text-sm font-black text-emerald-700">{t.currentMonthlyRent}<input type="number" step="100" className="mt-2 w-full rounded-2xl border border-emerald-200 px-4 py-3 text-lg font-bold" value={currentMonthlyRent} onChange={(e) => setCurrentMonthlyRent(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.yearsYouPlanToStay}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={yearsYouPlanToStay} onChange={(e) => setYearsYouPlanToStay(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.annualOwnershipCostRate}<input type="number" step="0.5" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={annualOwnershipCostRate} onChange={(e) => setAnnualOwnershipCostRate(e.target.value)} /></label></div></div>
          </div>
        </section>
        ...
        <AdSenseWrapper showAds={true} adSlot="rent-vs-buy-calculator-result-intelligence" adFormat="horizontal" className="my-2" />
        ...
        <section aria-label="L14 常見問題後廣告位:廣告位" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="rent-vs-buy-calculator-faq" position="inline" /></section>
