...
const ui = {
  zh: {
    ...
    intro: "本工具以標準分期攤還公式,依貸款金額、年利率與貸款年數計算每月應繳的等額分期金額(EMI),並加總總還款額、總利息與其他費用,協助你在簽約前看清長期負擔。",
    trustNoteLabel: "注意事項:",
    ...
    q3: "其他費用率代表什麼?",
    a3: "指開辦費、手續費或保險等一次性或比例性費用,以本金的百分比估算並計入總成本,讓你看清貸款的真實代價。",
    q4: "提前還款真的划算嗎?",
    a4: "通常划算,因為提前還款會減少後續計息的本金;但須確認是否有提前清償違約金,並與其他資金用途比較機會成本。",
    q5: "這個結果含浮動利率調整嗎?",
    a5: "不含。本工具以固定利率假設計算,若你的貸款為浮動利率,月付會隨利率變動,實際金額需依調整後重新試算。",
    q6: "月付佔收入多少比較安全?",
