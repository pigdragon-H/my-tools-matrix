...
const bands = [
  ...
  { key: "normal", range: "3-9", label: { zh: "迷您部位", en: "Mini size" }, desc: { zh: "迷您手交易常見的每點價值區間。", en: "A common pip value range for mini-lot trading." } },
...
const ui = {
  zh: {
    ...
    intro: "輸入交易手數、一點大小、報價匯率與合約單位,本工具計算每一點的貨幣價值、每手每點價值與十點價值,協助您管理外匯部位的風險與停損距離。",
    trustNoteLabel: "注意事項:",
