...
const ui = {
  zh: {
    ...
    intro: "本工具為 小費計算機，依公開公式於瀏覽器端試算，輸入帳單金額、小費比例%、分攤人數、稅率%後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q2: "小費要不要含稅計算?",
    a2: "兩派做法都有:**算稅前**(只對食物服務給小費,較常見且合理)或**算稅後**(對含稅總額給,較大方)。本工具預設對帳單金額計算小費、稅另計,您可調整稅率欄位觀察差異。",
    q3: "外送、外帶也要給小費嗎?",
    a3: "美國外送通常給 10-15% 或至少 3-5 美元,惡劣天氣可加給;外帶傳統上不強制,但若店家有特別包裝服務,給 10% 是禮貌。各地文化不同,本工具讓您自由設定比例。",
    q4: "分帳怎麼算最公平?",
    a4: "最公平是**含小費含稅的總額平分**(本工具預設),適合大家點得差不多時;若有人點很貴,則建議按各自消費比例分攤,專業版支援逐人項目分帳。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內完成,帳單金額不會傳送到任何伺服器。",
    q6: "可以記錄常用比例嗎?",
