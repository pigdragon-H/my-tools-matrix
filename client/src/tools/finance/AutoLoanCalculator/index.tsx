...
const ui = {
  zh: {
    ...
    intro: "本工具為 汽車貸款計算機，依公開公式於瀏覽器端試算，輸入車價、頭期款、年利率%、貸款年限後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q4: "車貸和租賃哪個划算?",
    a4: "若您習慣每 3-4 年換車、在意月付金與保固,租賃可能較適合;若打算長期持有(5 年以上),貸款買斷通常總成本較低。建議搭配租賃 vs 購買計算機比較。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內以 JavaScript 完成,車價與利率等資料不會傳送到任何伺服器。",
    q6: "可以含稅金保險試算嗎?",
