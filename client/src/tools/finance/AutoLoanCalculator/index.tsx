// @profile B
// Profile B · 計算機-YMYL · AutoLoanCalculator（GOLD-STANDARD-001 compatible · clone of MeetingCostCalculator）
...
const bands = [
  { key: "tiny", range: "< 3", label: { zh: "極低 (< 3)", en: "Very low (< 3)" }, desc: { zh: "落在「極低」級距< 3。利息佔貸款 < 3%,屬於超低利車貸或車商促銷 0 利率方案。", en: "Falls in the \"Very low\" band (< 3). This is the very low range for Auto Loan Calculator." } },
  { key: "normal", range: "3–7", label: { zh: "低 (3–7)", en: "Low (3–7)" }, desc: { zh: "落在「低」級距3–7。3-7%,低,常見於銀行優質信用車貸短年限。", en: "Falls in the \"Low\" band (3–7). This is the low range for Auto Loan Calculator." } },
  { key: "notable", range: "7–12", label: { zh: "中等 (7–12)", en: "Moderate (7–12)" }, desc: { zh: "落在「中等」級距7–12。7-12%,中等,屬一般車貸 5 年期主流區間。", en: "Falls in the \"Moderate\" band (7–12). This is the moderate range for Auto Loan Calculator." } },
  { key: "high", range: "12–20", label: { zh: "偏高 (12–20)", en: "Elevated (12–20)" }, desc: { zh: "落在「偏高」級距12–20。12-20%,偏高,長年限或中等信用,建議比較其他銀行。", en: "Falls in the \"Elevated\" band (12–20). This is the elevated range for Auto Loan Calculator." } },
  { key: "major", range: "20–30", label: { zh: "高 (20–30)", en: "High (20–30)" }, desc: { zh: "落在「高」級距20–30。20-30%,高,信用較弱或超長年限,利息負擔沉重。", en: "Falls in the \"High\" band (20–30). This is the high range for Auto Loan Calculator." } },
  { key: "executive", range: "≥ 30", label: { zh: "極高 (≥ 30)", en: "Very high (≥ 30)" }, desc: { zh: "落在「極高」級距≥ 30。> 30%,極高,常見於次級車貸,務必重新議價或增加頭期。", en: "Falls in the \"Very high\" band (≥ 30). This is the very high range for Auto Loan Calculator." } },
] as const;

const affiliateItems: AffiliateItem[] = [
  { label: { zh: "貸款計算機", en: "Loan Calculator" }, href: "/tools/finance/loan-calculator" },
  { label: { zh: "租賃 vs 購買計算機", en: "Lease vs Buy Calculator" }, href: "/tools/finance/lease-vs-buy-calculator" },
...
const ui = {
  zh: {
    badge: "財務 · 汽車貸款計算機 · 黃金工具",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Auto Loan Calculator · 汽車貸款計算機",
    subtitle: "輸入車價、頭期款、利率與年限,立即算出每月還款、總利息與利息佔貸款比",
    intro: "本工具為 汽車貸款計算機，依公開公式於瀏覽器端試算，輸入車價、頭期款、年利率%、貸款年限後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    trustNote: "本工具僅供一般情境試算，未涵蓋極端條件、稅務優惠、地區差異或特殊規範。涉及重大決策請以合格專業人士為準。",
    quickActionCard: "快速範例卡",
    tryExample: "試算汽車貸款計算機",
    examplePreview: "利息佔貸款比",
    examplePerson: "標準範例",
    fillExample: "一鍵填入標準範例",
    previewActivePath: "填入進階範例",
    examplesCalculator: "範例 → 計算機",
    enterValues: "輸入車價、頭期款、年利率%、貸款年限",
    examplesHelper: "先用範例了解結果輸出，再改成自己的數字。",
    metric: "標準",
    imperial: "進階",
    exampleCards: "範例卡",
    baselineExample: "標準範例",
    baselineExampleValue: "車價 80 萬 · 頭期 16 萬 · 5 年",
    baselineExampleNote: "車價 800000 · 頭期款 160000",
    activeExample: "進階範例",
    activeExampleValue: "車價 150 萬 · 頭期 15 萬 · 7 年",
    activeExampleNote: "車價 加倍 · 觀察 利息佔貸款比 變化",
    flowDemo: "數字流向示範",
    calculator: "汽車貸款計算機",
    vehiclePrice: "車價",
    downPayment: "頭期款",
    ...
    metricCTail: "$",
    headlineCaption: "汽車貸款計算機 · 即時試算",
    fatLossTarget: "貸款本金",
    resultIntelligence: "結果解讀",
    tdeeMatrix: "汽車貸款計算機 · 級距矩陣",
    ...
    nextActionItem1: "把 車價 與 年利率% 各調 ±10% 觀察主要結果敏感度",
    ...
    decisionPath: "決策路徑",
    decisionTitle: "汽車貸款計算機 · 決策四步",
    bmrStep: "Step 1 · 蒐集參數",
    bmrNote: "先把 車價、頭期款、年利率%、貸款年限 四個欄位填齊。",
    deficitStep: "Step 2 · 套公式",
    deficitNote: "依車價、頭期款、利率與年限計算每月還款、總利息與利息佔貸款比。",
    trendStep: "Step 3 · 看級距",
    trendNote: "對照六格級距,定位主要結果。",
    mealStep: "Step 4 · 行動",
    mealNote: "依級距提示挑一個下一步,執行 30 天後回來重算。",
    knowledge: "知識庫",
    knowledgeTitle: "汽車貸款計算機 · 觀念整理",
    definition: "定義",
    definitionText: "汽車貸款計算機以車價、頭期款、年利率與貸款年限,計算每月還款額、總利息與利息佔貸款比例,協助買車前評估真實負擔與比較不同方案。",
    formula: "公式",
    formulaText: "貸款本金 = 車價 − 頭期款;每月還款 = 本金 × 月利率 ÷ (1 − (1 + 月利率)^−期數)",
    limitations: "限制",
    limitationsText: "本工具不含牌照稅、保險、領牌費與車商手續費,亦不計入車輛貶值與殘值,僅試算貸款本息。",
    interpretation: "解讀",
    interpretationText: "利息佔貸款比越低代表借貸成本越輕;車貸建議搭配高頭期與短年限,避免負資產與過高總利息。",
    context: "情境",
    ...
    premiumTitle: "專業版 購車全成本分析",
    premiumText: "解鎖含稅金保險的全持有成本(TCO)、車輛貶值曲線、貸款 vs 租賃比較、多方案利率試算與負資產警示。",
    premiumChips_zh: "TCO全成本|貶值曲線|貸租比較|負資產警示",
    premiumChips_en: "TCO|Depreciation|Loan/Lease|Equity Alert",
    ...
    q1: "頭期款放多少最好?",
    a1: "一般建議頭期款至少 20%,可降低貸款本金與每月負擔,也避免車輛貶值速度超過還款速度造成的負資產(欠款大於車值)。頭期越高、總利息越少。",
    q2: "車貸年限越長越好嗎?",
    a2: "不一定。年限越長每月還款越低,但總利息越多,且車輛貶值快,容易出現負資產。建議車貸年限不超過 5 年,且不超過車輛預期使用年限。",
    q3: "0 利率車貸是真的嗎?",
    a3: "車商的 0 利率方案通常以放棄現金折扣為代價,等於把利息藏在車價裡。比較時應同時詢問「現金價」與「貸款價」,用本工具換算實際成本再決定。",
    q4: "車貸和租賃哪個划算?",
    a4: "若你習慣每 3-4 年換車、在意月付金與保固,租賃可能較適合;若打算長期持有(5 年以上),貸款買斷通常總成本較低。建議搭配租賃 vs 購買計算機比較。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在你的瀏覽器內以 JavaScript 完成,車價與利率等資料不會傳送到任何伺服器。",
    q6: "可以含稅金保險試算嗎?",
    a6: "含牌照稅、燃料稅、強制險、車體險與領牌費的全成本試算屬於專業版功能,免費版聚焦貸款本息。"
  },
  en: {
    badge: "Finance · Auto Loan Calculator · Gold Tool",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Auto Loan Calculator",
    subtitle: "Enter vehicle price, down payment, rate, and term to see monthly payment, total interest, and interest-to-loan ratio",
    intro: "Auto Loan Calculator runs the standard formula in your browser. Enter vehicle price, down payment, annual rate pct, loan years to see the primary result and three supporting metrics. Nothing is uploaded.",
    ...
    tryExample: "Try Auto Loan Calculator",
    examplePreview: "Interest-to-Loan",
    examplePerson: "Standard example",
    fillExample: "Fill standard example",
    previewActivePath: "Fill advanced example",
    examplesCalculator: "Examples → Calculator",
    enterValues: "Enter vehicle price, down payment, annual rate pct, loan years",
    ...
    baselineExampleValue: "800k · 160k down · 5y",
    baselineExampleNote: "Vehicle Price 800000 · Down Payment 160000",
    activeExample: "Advanced example",
    activeExampleValue: "1.5M · 150k down · 7y",
    activeExampleNote: "Vehicle Price doubled · watch Interest-to-Loan react",
    ...
    primaryValue: "Interest-to-Loan",
    primaryUnitTail: "%",
    secondaryLabel: "Monthly Payment",
    secondaryTail: "$",
    metricALabel: "Interest-to-Loan",
    ...
    metricCTail: "$",
    headlineCaption: "Auto Loan Calculator · live calc",
    fatLossTarget: "Loan Principal",
    resultIntelligence: "Result intelligence",
    tdeeMatrix: "Auto Loan Calculator · band matrix",
    ...
    nextActionItem1: "Move Vehicle Price and Annual Rate Pct by ±10% to see sensitivity.",
    ...
    decisionTitle: "Auto Loan Calculator · 4-step decision",
    bmrStep: "Step 1 · Gather inputs",
    bmrNote: "Fill vehicle price, down payment, annual rate pct, loan years.",
    deficitStep: "Step 2 · Apply formula",
    deficitNote: "Auto Loan Calculator standard formula.",
    ...
    knowledge: "Knowledge",
    knowledgeTitle: "Auto Loan Calculator · concept primer",
    definition: "Definition",
    definitionText: "Auto Loan Calculator converts inputs (vehicle price, down payment, annual rate pct, loan years) into Interest-to-Loan. It is widely used in personal finance and investment planning.",
    formula: "Formula",
    formulaText: "result = f(vehicle price, down payment, annual rate pct, loan years)",
    ...
    premiumTitle: "Pro Vehicle Cost Analysis",
    premiumText: "Unlock total cost of ownership with tax and insurance, depreciation curve, loan vs lease compare, multi-rate simulation, and negative-equity alerts.",
    premiumChips_zh: "TCO全成本|貶值曲線|貸租比較|負資產警示",
    premiumChips_en: "TCO|Depreciation|Loan/Lease|Equity Alert",
    ...
    q1: "What does Auto Loan Calculator calculate?",
    a1: "Auto Loan Calculator applies the standard formula to your inputs and returns Interest-to-Loan plus three supporting metrics, all computed in your browser.",
    q2: "Which inputs do I need for Auto Loan Calculator?",
    a2: "Enter vehicle price, down payment, annual rate pct, loan years. Auto Loan Calculator runs the standard formula client-side and updates instantly as you type.",
    ...
    a6: "Unlock total cost of ownership with tax and insurance, depreciation curve, loan vs lease compare, multi-rate simulation, and negative-equity alerts."
  },
} as const;
...
export default function AutoLoanCalculator() {
  ...
  }, [vehiclePrice, downPayment, annualRatePct, loanYears]);
  ...
  const quaternaryDisplay = fmt(result.principal, 0);

  function fillSolid() { setUnit("metric"); setVehiclePrice("800000"); setDownPayment("160000"); setAnnualRatePct("3.5"); setLoanYears("5"); }
  function fillHighSalary() { setUnit("imperial"); setVehiclePrice("1500000"); setDownPayment("150000"); setAnnualRatePct("8"); setLoanYears("7"); }
      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_#fef3c7,_#f8fafc_45%,_#e0f2fe)]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            ...
            <aside className="rounded-[2rem] border border-amber-100 bg-white/90 p-6 shadow-2xl shadow-amber-950/10 backdrop-blur"><p className="text-xs font-black uppercase tracking-[0.18em] text-amber-700">{t.quickActionCard}</p><h2 className="mt-2 text-2xl font-black">{t.tryExample}</h2><div className="mt-5 rounded-3xl bg-amber-600 p-5 text-white"><div className="text-xs font-bold uppercase text-amber-100">{t.examplePreview}</div><div className="mt-1 text-5xl font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div><div className="text-sm font-bold text-amber-100">{t.headlineCaption}</div></div><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.examplePerson}</div><div className="font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.flowDemo}</div><div className="font-black">{vehiclePrice} × {downPayment}</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.fatLossTarget}</div><div className="font-black">{secondaryDisplay}</div></div></div><button onClick={fillSolid} className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-4 text-sm font-black text-white">{t.fillExample}</button><button onClick={fillHighSalary} className="mt-3 w-full rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm font-black text-amber-900">{t.previewActivePath}</button></aside>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5"><h3 className="text-lg font-black">{t.calculator}</h3><div className="mt-4 grid gap-4 md:grid-cols-2"><label className="block text-sm font-black text-slate-700">{t.vehiclePrice}<input type="number" step="10000" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={vehiclePrice} onChange={(e) => setVehiclePrice(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.downPayment}<input type="number" step="10000" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={downPayment} onChange={(e) => setDownPayment(e.target.value)} /></label><label className="block text-sm font-black text-emerald-700">{t.annualRatePct}<input type="number" step="0.1" className="mt-2 w-full rounded-2xl border border-emerald-200 px-4 py-3 text-lg font-bold" value={annualRatePct} onChange={(e) => setAnnualRatePct(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.loanYears}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={loanYears} onChange={(e) => setLoanYears(e.target.value)} /></label></div></div>
          </div>
        </section>
        ...
        <AdSenseWrapper showAds={true} adSlot="auto-loan-calculator-result-intelligence" adFormat="horizontal" className="my-2" />
        ...
        <section aria-label="L14 常見問題後廣告位:廣告位" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="auto-loan-calculator-faq" position="inline" /></section>
