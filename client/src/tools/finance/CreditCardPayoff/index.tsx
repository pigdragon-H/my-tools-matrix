...
const ui = {
  zh: {
    ...
    title: "信用卡還款計算機・完整健康評估",
    subtitle: "信用卡還款計算機引導體驗",
  ...
  en: {
    ...
    title: "Credit Card Payoff Calculator · Complete Health Assessment",
    subtitle: "Credit Card Payoff Calculator guided experience",
