...
const ui = {
  zh: {
    ...
    intro: "本工具為 房屋淨值計算機，依公開公式於瀏覽器端試算，輸入房屋目前市值、房貸剩餘餘額、放款機構最高 CLTV、其他抵押餘額後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    limitations: "限制",
    limitationsText: "本工具以您輸入的市值與餘額計算,未計入放款機構鑑價差異、信用與收入核定及費用,實際可借額度以機構評估為準。",
    interpretation: "解讀",
    ...
    q1: "房屋淨值怎麼算?",
    a1: "房屋淨值 = 房屋市值 − 所有抵押債務餘額(含房貸與其他留置權),代表您實際持有的資產價值。",
    q2: "什麼是 CLTV?",
