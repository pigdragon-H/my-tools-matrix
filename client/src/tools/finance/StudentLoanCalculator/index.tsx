...
const ui = {
  zh: {
    ...
    intro: "本工具為 學生貸款計算機，依公開公式於瀏覽器端試算，輸入貸款總額、年利率%、還款年限、寬限期月數後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q1: "寬限期會增加利息嗎?",
    a1: "會。寬限期(在學或畢業緩衝期)雖暫不還本金,但部分方案仍計息並滾入本金,寬限越久、起算本金越高、總利息越多。本工具讓你看到寬限期對利息佔比的影響。",
    q2: "畢業後該先還哪筆?",
    ...
    q4: "就學貸款利率怎麼算?",
    a4: "台灣就學貸款利率多隨郵局一年期定儲機動利率加碼計算,屬機動利率;美國聯邦學貸則為固定利率。本工具以你輸入的年利率試算,實際以借據為準。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在你的瀏覽器內以 JavaScript 完成,貸款金額與利率等資料不會傳送到任何伺服器。",
    q6: "可以模擬多筆貸款嗎?",
