...
const ui = {
  zh: {
    ...
    intro: "本工具為 Coast FIRE 計算機，依公開公式於瀏覽器端試算，輸入目前投資本金、目前年齡、預計退休年齡、預期年化報酬率後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    premiumText: "進階版加入通膨折現、Monte Carlo 報酬模擬、多情境滑行路徑與目標資產回推,協助你精算真正的滑行年齡。",
    ...
    a5: "達到 Coast 後追加投入會讓你提前或更安全地抵達目標,但即使停止,理論上仍能滑行至退休。",
    q6: "這個結果能當退休保證嗎?",
