...
const bands = [
  { key: "minimal", range: "< $500/mo", label: { zh: "輕鬆還款", en: "Minimal debt" }, desc: { zh: "每月還款極低，可加速還清。", en: "Very low monthly payment; consider accelerating payoff." } },
  { key: "manageable", range: "$500–$1,500/mo", label: { zh: "可負擔", en: "Manageable" }, desc: { zh: "還款在合理範圍，持續穩定付款即可。", en: "Within reasonable range; keep steady payments." } },
  { key: "heavy", range: "$1,500–$3,000/mo", label: { zh: "較重負擔", en: "Heavy burden" }, desc: { zh: "佔收入比高，可考慮重組或額外收入。", en: "High share of income; consider restructuring or extra income." } },
  { key: "critical", range: "$3,000–$5,000/mo", label: { zh: "嚴重壓力", en: "Critical pressure" }, desc: { zh: "需立即檢視支出，尋求專業建議。", en: "Review expenses immediately; seek professional advice." } },
  { key: "overwhelmed", range: "$5,000–$10,000/mo", label: { zh: "瀕臨危機", en: "Overwhelmed" }, desc: { zh: "債務危機風險高，需緊急應對方案。", en: "High risk of debt crisis; need emergency response plan." } },
  { key: "emergency", range: "$10,000+/mo", label: { zh: "緊急狀態", en: "Emergency" }, desc: { zh: "必須立即尋求法律與財務顧問協助。", en: "Must seek legal and financial counsel immediately." } },
] as const;
...
const ui = {
  zh: {
    badge: "財務 · 債務管理 · Gold Tool", switchToEnglish: "Switch to English", switchToChinese: "切換到中文", chineseShort: "中", englishShort: "EN",
    title: "債務清償計算機 · Debt Payoff Planner", subtitle: "計算每月還款、總利息與清償日期，制定還債計畫",
    intro: "Debt Payoff Calculator 根據本金、年利率與還款期限，計算每月固定還款額、總利息支出與預計清償日期，協助制定最有效的債務清償策略。",
    ...
    decisionPath: "決策路徑", decisionTitle: "Debt Payoff → Net Worth → DTI → Loan", bmrStep: "債務清償", deficitStep: "淨資產", trendStep: "負債收入比", mealStep: "貸款",
    knowledge: "知識", knowledgeTitle: "Debt Payoff 在財務宇宙中的意義", definition: "定義", definitionText: "債務清償是按固定月付金額分期償還本金與利息的過程。每月還款 = P × r(1+r)^n / ((1+r)^n − 1)。",
    ...
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "推薦工具", affiliateTitle: "債務清償規劃的下一步工具", premiumTitle: "PRO 債務追蹤包", premiumText: "解鎖還款進度甘特圖、利率比較分析、提前還款模擬與個人化財務報告。",
    trustReferences: "信任聲明 · 相關工具 · 參考資料", trust: "信任聲明", trustText: "本工具僅供教育與規劃用途，不取代理財顧問或專業財務規劃。", relatedTools: "相關工具", relatedToolsText: "Loan Calculator · Compound Interest Calculator · Debt-to-Income Calculator · Net Worth Calculator", references: "參考資料", referencesText: "CFPB Paying Off Credit Cards Guide; Federal Reserve G.19 Consumer Credit Report; FTC Consumer Information on Credit; NFCC Financial Counseling Standards。",
  ...
  en: {
    badge: "Finance · Debt Management · Gold Tool", switchToEnglish: "Switch to English", switchToChinese: "切換到中文", chineseShort: "中", englishShort: "EN",
    title: "Debt Payoff Calculator · Debt Payoff Planner", subtitle: "Calculate monthly payment, total interest, and payoff date to build your debt strategy",
    intro: "This calculator uses your principal, annual interest rate, and repayment term to compute the fixed monthly payment, total interest, and estimated payoff date, helping you build the most effective debt payoff strategy.",
    trustNoteLabel: "Note:", trustNote: "Actual payments may differ due to rate changes or additional fees; variable-rate loan results are estimates only.",
    quickActionCard: "Quick Action Card", tryExample: "Create a debt payoff example instantly", examplePreview: "Monthly payment preview", examplePerson: "Standard example", fillExample: "One-click standard example", previewActivePath: "Fill high-rate example",
    examplesCalculator: "Examples → Calculator", enterValues: "Enter debt information", examplesHelper: "Start with an example to understand debt payoff calculation, then replace with your own numbers.",
    metric: "Simple", imperial: "Detailed", exampleCards: "Example cards", baselineExample: "Standard type · $555/mo", activeExample: "High-rate type", flowDemo: "Principal $50k", calculator: "Calculator",
    principal: "Loan principal ($)", annualRate: "Annual interest rate (%)", termMonths: "Repayment term (months)", extraPayment: "Extra monthly payment ($)",
    resultCard: "Debt Payoff Result", unit: "Monthly payment ($)", primaryValue: "Primary Value", maintenanceTarget: "Monthly payment ($)", actionTarget: "Total interest", estimatedTdee: "Total repayment", maintenance: "Monthly", fatLossTarget: "Interest",
    payoffDate: "Payoff date", totalInterest: "Total interest", totalPayment: "Total repayment", interestRatio: "Interest share",
    resultIntelligence: "Result Intelligence", tdeeMatrix: "Six-card debt pressure interpretation matrix", tdeeMatrixNote: "L7 uses six fixed cards to compare the monthly payment with common planning zones. This is planning guidance, not financial advice.",
    emotionConversionLayer: "Emotion + Conversion Layer", turnIntoPlan: "Turn debt payoff plan into an actionable strategy", conversionNote: "L9 values update from the computed result: repayment progress, interest savings, and improvement hints.",
    progressInsight: "Progress Insight Card", possibleTarget: "Current repayment plan", dailyGap: "Interest share", weeklyTrend: "Principal/Interest", motivation: "Motivation Card", keepMomentum: "Move from debt payoff plan to consistent tracking",
    saveShareJourney: "Save / Share", journeyTitle: "Take today's debt payoff plan home", journeyHint: "Re-calculate every quarter to track principal reduction and interest savings progress.",
    nextActionLabel: "Next actions", nextActionTitle: "Connect this result to the next tool", nextActionItem1: "Use Loan Calculator to review mortgage or loan repayment plans", nextActionItem2: "Use Compound Interest to plan investment portfolio growth", nextActionItem3: "Use Debt-to-Income to confirm overall repayment capacity",
    shareLinkBtn: "📋 Copy result link", shareNativeBtn: "📤 Share with friends", shareCopiedToast: "Copied to clipboard ✓",
    decisionPath: "Decision Path", decisionTitle: "Debt Payoff → Net Worth → DTI → Loan", bmrStep: "Debt payoff", deficitStep: "Net worth", trendStep: "DTI", mealStep: "Loan",
    knowledge: "Knowledge", knowledgeTitle: "What debt payoff means in the Finance universe", definition: "Definition", definitionText: "Debt payoff is the process of repaying principal and interest in fixed monthly installments. Monthly payment = P × r(1+r)^n / ((1+r)^n − 1).",
    formula: "Formula", formulaText: "Monthly = Principal × r(1+r)^n / ((1+r)^n − 1), where r = monthly rate, n = months. Total interest = Monthly × n − Principal. Interest share = Total interest ÷ Total repayment × 100%.",
    limitations: "Limitations", limitationsText: "Only applies to fixed-rate loans; variable-rate results are estimates. Does not account for prepayment penalties or fees.",
    interpretation: "Interpretation", interpretationText: "Interest share below 30% is healthy; 30–50% needs attention; above 50% means heavy long-term cost—consider accelerating payoff or restructuring.",
    context: "Context", contextText: "Debt payoff should be paired with debt-to-income ratio, net worth, and loan plans.",
    example: "Example", exampleText: "Principal $50,000, 6% annual, 120 months. Monthly rate = 0.5%, payment = $555.10, total = $66,612, interest = $16,612, share 24.9%.",
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Recommended Tools", affiliateTitle: "Next tools for debt payoff planning", premiumTitle: "PRO Debt Tracking Pack", premiumText: "Unlock repayment progress Gantt chart, rate comparison analysis, prepayment simulation, and personalized financial reports.",
    trustReferences: "Trust · Related Tools · References", trust: "Trust", trustText: "This tool is for education and planning. It does not replace financial advisory or professional financial planning.", relatedTools: "Related Tools", relatedToolsText: "Loan Calculator · Compound Interest Calculator · Debt-to-Income Calculator · Net Worth Calculator", references: "References", referencesText: "CFPB Paying Off Credit Cards Guide; Federal Reserve G.19 Consumer Credit Report; FTC Consumer Information on Credit; NFCC Financial Counseling Standards.",
    q1: "Is prepayment always a good idea?", a1: "Usually yes, but check for prepayment penalties; paying off high-rate debt first gives the most benefit.", q2: "What about variable rates?", a2: "This calculator uses fixed rates; for variable rates, estimate with the current rate and budget for potential increases.", q3: "What if payment exceeds 30% of income?", a3: "Consider extending the term, debt restructuring, or increasing income; seek credit counseling in serious cases.", q4: "What interest share is normal?", a4: "Below 30% is healthy; 30–50% needs attention; above 50% warrants accelerating payoff or restructuring.", q5: "Minimum payment vs fixed monthly payment?", a5: "Minimums cover interest plus small principal, taking much longer; fixed payments give a predictable payoff date.", q6: "Can this tool provide debt restructuring or legal advice?", a6: "No. It is an educational estimate; consult professionals for debt restructuring, bankruptcy, or legal advice.",
  },
} as const;
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5"><h3 className="text-lg font-black">{t.exampleCards}</h3><div className="mt-4 space-y-3"><button onClick={fillStandard} className="w-full rounded-2xl border border-amber-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.baselineExample}</span><span className="rounded-full bg-amber-100 px-3 py-1 text-xs font-black text-amber-700">6%</span></div><p className="mt-2 text-sm text-slate-600">$50k · 120 months</p></button><button onClick={fillHighRate} className="w-full rounded-2xl border border-red-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.activeExample}</span><span className="rounded-full bg-red-100 px-3 py-1 text-xs font-black text-red-700">18%</span></div><p className="mt-2 text-sm text-slate-600">$30k · 60 months</p></button></div></div>
        ...
        <section className="grid gap-7 lg:grid-cols-[0.95fr_1.05fr]">{/* L6-Result */}
          <article className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm"><div className="h-5 bg-gradient-to-r from-amber-400 to-emerald-600" /><div className="p-6 md:p-7"><p className="text-xs font-black uppercase tracking-[0.2em] text-amber-700">{t.resultCard}</p><div className="mt-4 flex items-start justify-between gap-5"><div><div className="text-7xl font-black tracking-tight text-slate-950">${monthlyDisplay}</div><div className="mt-2 rounded-full bg-slate-100 px-4 py-2 text-sm font-black text-slate-700">{t.unit}</div></div><div className="rounded-3xl bg-slate-950 p-4 text-right text-white"><div className="text-xs font-bold uppercase text-slate-300">{t.payoffDate}</div><div className="mt-1 text-xl font-black">{result.payoffDate}</div><div className="mt-1 text-xs text-slate-300">{result.effectiveTerm} mo</div></div></div><div className="mt-6 grid gap-4 md:grid-cols-3"><div className="rounded-2xl bg-emerald-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500">{t.maintenanceTarget}</div><div className="mt-1 text-xs font-black uppercase text-emerald-700">{t.maintenance}</div><p className="mt-2 text-3xl font-black text-emerald-950">${monthlyDisplay}</p><p className="text-sm font-bold text-emerald-700">/mo</p></div><div className="rounded-2xl bg-red-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-red-500">{t.actionTarget}</div><div className="mt-1 text-xs font-black uppercase text-red-700">{t.fatLossTarget}</div><p className="mt-2 text-3xl font-black text-red-950">${interestDisplay}</p><p className="text-sm font-bold text-red-700">total</p></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">{t.estimatedTdee}</div><div className="mt-1 text-xs font-black uppercase text-slate-700">TOTAL</div><p className="mt-2 text-3xl font-black text-slate-950">${fmt(result.totalPayment, 0)}</p><p className="text-sm font-bold text-slate-700">repaid</p></div></div></div></article>
        ...
        <section className="rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-amber-50 p-6 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_0.9fr]">{/* L9-Emotion-Upper */}
            <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm"><p className="text-xs font-black uppercase tracking-[0.16em] text-blue-700">{t.progressInsight}</p><h3 className="mt-2 text-2xl font-black">{t.possibleTarget}</h3><div className="mt-5 grid gap-3 sm:grid-cols-3"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black uppercase text-slate-500">Monthly</div><div className="mt-1 text-3xl font-black">${monthlyDisplay}</div></div><div className="rounded-2xl bg-red-50 p-4"><div className="text-xs font-black uppercase text-red-600">{t.dailyGap}</div><div className="mt-1 text-3xl font-black text-red-950">{fmt(result.interestRatio, 1)}%</div></div><div className="rounded-2xl bg-emerald-50 p-4"><div className="text-xs font-black uppercase text-emerald-700">{t.weeklyTrend}</div><div className="mt-1 text-3xl font-black text-emerald-950">{fmt((Number(principal) / Math.max(result.totalPayment, 1)) * 100, 0)}%</div></div></div></article>
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7"><p className="text-xs font-black uppercase tracking-[0.2em] text-amber-700">{t.decisionPath}</p><h2 className="mt-2 text-3xl font-black">{t.decisionTitle}</h2><div className="mt-6 grid gap-4 md:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] md:items-center">{[{ label: "Debt Payoff", note: t.bmrStep }, { label: "Net Worth", note: t.deficitStep }, { label: "DTI", note: t.trendStep }, { label: "Loan", note: t.mealStep }].map((node, index) => <div key={node.label} className="contents"><div className={`rounded-3xl border p-5 text-center ${index === 0 ? "border-amber-300 bg-amber-50" : "border-blue-200 bg-blue-50"}`}><div className="text-xs font-black uppercase text-slate-500">{index + 1}</div><div className="mt-1 text-xl font-black">{node.label}</div><p className="mt-2 text-sm leading-6 text-slate-600">{node.note}</p></div>{index < 3 && <div className="hidden text-3xl font-black text-slate-300 md:block">→</div>}</div>)}</div></section>
