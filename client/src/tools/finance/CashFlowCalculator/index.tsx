...
const ui = {
  zh: {
    ...
    intro: "本工具為 現金流計算機，依公開公式於瀏覽器端試算，輸入月收入、固定支出、變動支出、儲蓄目標%後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q5: "資料會上傳到伺服器嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內以 JavaScript 完成,收入、支出、儲蓄等資料不會傳送到任何伺服器,也不會記錄到日誌或資料庫。",
    q6: "可以拿這個做家庭預算嗎?",
