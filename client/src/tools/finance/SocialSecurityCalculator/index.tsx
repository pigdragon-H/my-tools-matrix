...
const ui = {
  zh: {
    ...
    intro: "本工具為 社會安全退休金估算機，依公開公式於瀏覽器端試算，輸入FRA 全額月給付、計畫請領年齡、完全退休年齡FRA、預期通膨調整後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    definition: "定義",
    definitionText: "社會安全退休金估算機依你的 FRA 全額給付(PIA)與計畫請領年齡,套用提早減額或延後增額規則,估算每月與年度給付。",
    formula: "公式",
    ...
    premiumText: "進階版加入配偶與遺屬給付、損益平衡分析、稅負估算與多情境請領比較,協助你選出最佳請領時點。",
