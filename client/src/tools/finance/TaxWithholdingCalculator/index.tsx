...
const ui = {
  zh: {
    ...
    intro: "本工具為 薪資預扣稅計算機，依公開公式於瀏覽器端試算，輸入年度總薪資、每期預扣稅額、全年發薪期數、有效稅率後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    definition: "定義",
    definitionText: "薪資預扣稅計算機比較你全年總預扣稅與預估稅負,估算報稅時的退稅或補稅金額及預扣占薪資比例。",
    formula: "公式",
    ...
    q1: "預扣稅是什麼?",
    a1: "預扣稅是雇主每期從你薪資中代扣並繳給稅務機關的金額,年度報稅時與實際稅負結算多退少補。",
    q2: "退稅多就是好嗎?",
    a2: "退稅多代表你全年被多扣,等於無息借錢給政府;理想是預扣與稅負接近持平,讓現金留在自己手上。",
    q3: "為什麼會欠稅?",
    a3: "若預扣不足(W-4 設定、兼職收入、投資所得未扣繳等),報稅時就需補稅,甚至可能有低估罰款。",
    q4: "如何調整預扣?",
    a4: "可透過調整 W-4 的預扣設定(扶養、額外預扣金額等)來提高或降低每期預扣稅。",
    q5: "有效稅率怎麼填?",
    a5: "有效稅率為全年稅負 ÷ 總所得;可參考過往報稅結果或稅率表估算,本工具以你輸入的單一比率計算。",
    q6: "這個結果準確嗎?",
