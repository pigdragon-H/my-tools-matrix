...
export default function ProfitMarginCalculator() {
  ...
  return <main className="min-h-screen bg-slate-50 text-slate-950">
    ...
    <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
      ...
      <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">{/* L17-TrustRelatedReferences */}<p className="text-xs font-black uppercase tracking-[0.2em] text-amber-700">{t.trustRef}</p><div className="mt-4 grid gap-5 md:grid-cols-3"><div><h2 className="text-xl font-black">{t.trust}</h2><p className="mt-2 text-sm leading-6 text-slate-700">{t.trustText}</p></div><div><h2 className="text-xl font-black">{t.related}</h2><p className="mt-2 text-sm leading-6 text-slate-700">{t.relatedText}</p></div><div><h2 className="text-xl font-black">{t.refs}</h2><p className="mt-2 text-sm leading-6 text-slate-700">{t.refsText}</p></div></div></section>
    </div>
  </main>;
}
