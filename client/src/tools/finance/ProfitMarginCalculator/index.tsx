...
const ui = {
  ...
  en: {
    q1: "What is the difference between gross and net margin?", a1: "毛利率 subtracts cost of goods sold only. 淨利率 also subtracts operating expenses, so it is closer to overall profitability.",
    q2: "Are markup and margin the same?", a2: "No. 加價率 is gross profit divided by cost, while margin is profit divided by revenue. For the same sale, markup is usually higher than margin.",
