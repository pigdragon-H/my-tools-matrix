...
const ui = {
  zh: {
    ...
    intro: "本工具為 定存單計算機，依公開公式於瀏覽器端試算，輸入本金、年利率%、存款月數、每年複利次數後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q2: "複利次數有差嗎?",
    a2: "有。複利次數越多,有效年利率(EAR)略高於名目利率。例如名目 2% 月複利的 EAR ≈ 2.018%,年複利則為 2%。差距雖小,長天期或大額本金仍有感。本工具幫你算出真實 EAR。",
    q3: "可以提前解約嗎?",
    a3: "可以,但通常會被打折計息(以較低的活存或解約利率重算),損失原本約定的高利。建議只把確定短期用不到的資金放定存,或採分散到期日的「定存梯」策略保持彈性。",
    q4: "機動利率還是固定利率?",
    a4: "台灣定存可選機動或固定利率:升息預期下選機動、降息預期下選固定較有利。本工具以你輸入的年利率試算到期本利和,實際以銀行牌告為準。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在你的瀏覽器內以 JavaScript 完成,本金與利率等資料不會傳送到任何伺服器。",
    q6: "可以比較多家利率嗎?",
