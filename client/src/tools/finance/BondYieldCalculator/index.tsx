...
const ui = {
  zh: {
    ...
    intro: "本工具為 債券殖利率計算機，依公開公式於瀏覽器端試算，輸入債券面值、現價、票面利率%、剩餘年限後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q5: "債券資料會上傳到伺服器嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內以 JavaScript 完成,債券面值、現價等資料不會傳送到任何伺服器,也不會記錄到日誌或資料庫。",
