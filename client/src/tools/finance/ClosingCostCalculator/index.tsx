...
const ui = {
  zh: {
    ...
    intro: "本工具為 成交費用計算機，依公開公式於瀏覽器端試算，輸入房屋購買價格、頭期款金額、成交費用率、預付項目金額後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    interpretation: "解讀",
    interpretationText: "費用占房價比例越低代表交割成本越省;成交所需現金則是你交割當天必須備妥的總金額。",
    context: "情境",
    ...
    q2: "成交費用通常是多少?",
    a2: "美國成交費用通常落在貸款金額的 2%–5%;本工具以你輸入的費用率估算,實際以結算說明書(CD)為準。",
    q3: "預付項目是什麼?",
    a3: "預付項目指交割時須先繳的費用,如預繳房產稅、保險與利息等,屬一次性現金支出。",
    q4: "成交所需現金怎麼算?",
    a4: "成交所需現金 = 頭期款 + 總成交費用(含貸款費用與預付項目),是你交割當天需準備的總現金。",
    q5: "費用可以協商嗎?",
