...
const ui = {
  zh: {
    ...
    intro: "本工具以中間匯率為基準,計入供應商加價百分比與固定手續費,呈現您真正能換得的目標幣金額、有效匯率與換匯總成本,讓您在執行前看清隱含成本。",
    trustNoteLabel: "注意事項:",
    ...
    q1: "中間匯率和我換到的匯率為什麼不同?",
    a1: "中間匯率是市場公允匯率,供應商會在其上加價或加點差作為利潤,所以您實際換到的有效匯率通常比中間匯率差一些。",
    q2: "加價百分比要填多少?",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題補充區" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="currency-converter-pro-faq" position="inline" /></section>
