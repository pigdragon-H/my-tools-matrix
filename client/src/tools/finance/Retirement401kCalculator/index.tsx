...
const bands = [
  ...
  { key: "high", range: "25–35", label: { zh: "偏高 (25–35)", en: "Elevated (25–35)" }, desc: { zh: "落在「偏高」級距25–35。25-35%,優異,雇主相對提撥慷慨且您已提滿。", en: "Falls in the \"Elevated\" band (25–35). This is the elevated range for 401k Retirement Calculator." } },
  { key: "major", range: "35–50", label: { zh: "高 (35–50)", en: "High (35–50)" }, desc: { zh: "落在「高」級距35–50。35-50%,極佳,雇主貢獻接近您自提的一半。", en: "Falls in the \"High\" band (35–50). This is the high range for 401k Retirement Calculator." } },
...
const ui = {
  zh: {
    ...
    intro: "本工具為 401k 退休帳戶計算機，依公開公式於瀏覽器端試算，輸入年薪、提撥比例%、雇主相對提撥%、年數後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    interpretation: "解讀",
    interpretationText: "雇主貢獻佔比越高代表您越充分利用免費的相對提撥;務必至少提到能拿滿 match 的比例。",
    context: "情境",
    ...
    q1: "雇主相對提撥是免費的錢嗎?",
    a1: "是。雇主相對提撥(employer match)是您提撥後,公司按比例額外存入您帳戶的錢,等於即時 100% 報酬。沒提滿相對提撥的上限,就等於放棄一部分薪水,務必至少提到能拿滿 match 的比例。",
    q2: "該提撥多少比例?",
    ...
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在您的瀏覽器內以 JavaScript 完成,薪資與提撥等資料不會傳送到任何伺服器。",
    q6: "可以模擬不同報酬率嗎?",
