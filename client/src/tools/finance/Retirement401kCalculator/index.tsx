// @profile B
// Profile B · 計算機-YMYL · Retirement401kCalculator（GOLD-STANDARD-001 compatible · clone of MeetingCostCalculator）
...
const bands = [
  { key: "tiny", range: "< 5", label: { zh: "極低 (< 5)", en: "Very low (< 5)" }, desc: { zh: "落在「極低」級距< 5。雇主貢獻 < 5%,相對提撥偏低或自提率遠高於上限,等於少拿免費的錢。", en: "Falls in the \"Very low\" band (< 5). This is the very low range for 401k Retirement Calculator." } },
  { key: "normal", range: "5–15", label: { zh: "低 (5–15)", en: "Low (5–15)" }, desc: { zh: "落在「低」級距5–15。5-15%,一般,接近多數企業 3-6% 的相對提撥水準。", en: "Falls in the \"Low\" band (5–15). This is the low range for 401k Retirement Calculator." } },
  { key: "notable", range: "15–25", label: { zh: "中等 (15–25)", en: "Moderate (15–25)" }, desc: { zh: "落在「中等」級距15–25。15-25%,良好,充分利用雇主相對提撥。", en: "Falls in the \"Moderate\" band (15–25). This is the moderate range for 401k Retirement Calculator." } },
  { key: "high", range: "25–35", label: { zh: "偏高 (25–35)", en: "Elevated (25–35)" }, desc: { zh: "落在「偏高」級距25–35。25-35%,優異,雇主相對提撥慷慨且你已提滿。", en: "Falls in the \"Elevated\" band (25–35). This is the elevated range for 401k Retirement Calculator." } },
  { key: "major", range: "35–50", label: { zh: "高 (35–50)", en: "High (35–50)" }, desc: { zh: "落在「高」級距35–50。35-50%,極佳,雇主貢獻接近你自提的一半。", en: "Falls in the \"High\" band (35–50). This is the high range for 401k Retirement Calculator." } },
  { key: "executive", range: "≥ 50", label: { zh: "極高 (≥ 50)", en: "Very high (≥ 50)" }, desc: { zh: "落在「極高」級距≥ 50。> 50%,罕見,雇主提撥超過自提,務必提滿以拿好拿滿。", en: "Falls in the \"Very high\" band (≥ 50). This is the very high range for 401k Retirement Calculator." } },
] as const;
...
const ui = {
  zh: {
    badge: "財務 · 401k 退休帳戶計算機 · 黃金工具",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "401k Retirement Calculator · 401k 退休帳戶計算機",
    subtitle: "輸入年薪、提撥比例與雇主相對提撥,立即算出退休帳戶終值與雇主貢獻佔比",
    intro: "本工具為 401k 退休帳戶計算機，依公開公式於瀏覽器端試算，輸入年薪、提撥比例%、雇主相對提撥%、年數後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    trustNote: "本工具僅供一般情境試算，未涵蓋極端條件、稅務優惠、地區差異或特殊規範。涉及重大決策請以合格專業人士為準。",
    quickActionCard: "快速範例卡",
    tryExample: "試算401k 退休帳戶計算機",
    examplePreview: "雇主貢獻佔比",
    examplePerson: "標準範例",
    fillExample: "一鍵填入標準範例",
    previewActivePath: "填入進階範例",
    examplesCalculator: "範例 → 計算機",
    enterValues: "輸入年薪、提撥比例%、雇主相對提撥%、年數",
    examplesHelper: "先用範例了解結果輸出，再改成自己的數字。",
    metric: "標準",
    imperial: "進階",
    exampleCards: "範例卡",
    baselineExample: "標準範例",
    baselineExampleValue: "年薪 150 萬 · 自提 10% · match 5%",
    baselineExampleNote: "年薪 1500000 · 提撥比例% 10",
    activeExample: "進階範例",
    activeExampleValue: "年薪 250 萬 · 自提 15% · match 6%",
    activeExampleNote: "年薪 加倍 · 觀察 雇主貢獻佔比 變化",
    flowDemo: "數字流向示範",
    calculator: "401k 退休帳戶計算機",
    annualSalary: "年薪",
    contributionPct: "提撥比例%",
    employerMatchPct: "雇主相對提撥%",
    years: "年數",
    resultCard: "結果卡片",
    primaryValue: "雇主貢獻佔比",
    primaryUnitTail: "%",
    secondaryLabel: "退休帳戶終值",
    secondaryTail: "$",
    metricALabel: "雇主貢獻佔比",
    ...
    metricCTail: "$",
    headlineCaption: "401k 退休帳戶計算機 · 即時試算",
    fatLossTarget: "雇主年提撥",
    resultIntelligence: "結果解讀",
    tdeeMatrix: "401k 退休帳戶計算機 · 級距矩陣",
    ...
    nextActionItem1: "把 年薪 與 雇主相對提撥% 各調 ±10% 觀察主要結果敏感度",
    ...
    decisionPath: "決策路徑",
    decisionTitle: "401k 退休帳戶計算機 · 決策四步",
    bmrStep: "Step 1 · 蒐集參數",
    bmrNote: "先把 年薪、提撥比例%、雇主相對提撥%、年數 四個欄位填齊。",
    deficitStep: "Step 2 · 套公式",
    deficitNote: "依年薪、提撥率、雇主相對提撥與年數計算退休帳戶終值與雇主貢獻佔比。",
    trendStep: "Step 3 · 看級距",
    trendNote: "對照六格級距,定位主要結果。",
    mealStep: "Step 4 · 行動",
    mealNote: "依級距提示挑一個下一步,執行 30 天後回來重算。",
    knowledge: "工具知識庫",
    knowledgeTitle: "401k 退休帳戶計算機 · 觀念整理",
    definition: "定義",
    definitionText: "401k 退休帳戶計算機以年薪、自提比例、雇主相對提撥與年數,估算退休帳戶終值、累計提撥與雇主貢獻佔比,協助上班族評估退休儲蓄成效。",
    formula: "公式",
    formulaText: "年提撥 = 年薪 ×(自提率 + min(雇主match率, 自提率));終值 = 年提撥 × ((1 + r)^年數 − 1) ÷ r,r 預設 7%",
    limitations: "限制",
    limitationsText: "本工具以固定 7% 年化報酬估算,不含通膨、稅務、投資波動與年度提撥上限限制。",
    interpretation: "解讀",
    interpretationText: "雇主貢獻佔比越高代表你越充分利用免費的相對提撥;務必至少提到能拿滿 match 的比例。",
    context: "情境",
    ...
    premiumTitle: "專業版 退休帳戶規劃",
    premiumText: "解鎖自訂報酬率、含通膨實質終值、Roth vs Traditional 稅務比較、年度上限檢核與提領策略模擬。",
    premiumChips_zh: "自訂報酬|通膨調整|稅務比較|提領策略",
    premiumChips_en: "Custom Return|Inflation|Tax Compare|Withdrawal",
    ...
    q1: "雇主相對提撥是免費的錢嗎?",
    a1: "是。雇主相對提撥(employer match)是你提撥後,公司按比例額外存入你帳戶的錢,等於即時 100% 報酬。沒提滿相對提撥的上限,就等於放棄一部分薪水,務必至少提到能拿滿 match 的比例。",
    q2: "該提撥多少比例?",
    a2: "至少提撥到能拿滿雇主相對提撥的比例(常見 5-6%);若行有餘力,建議朝年度上限(美國 2024 年為 $23,000)邁進。本工具預設 7% 年化報酬估算長期終值。",
    q3: "401k 和 IRA 差在哪?",
    a3: "401k 由雇主提供、提撥上限高且常有相對提撥;IRA 為個人開設、上限較低但投資選擇更彈性。常見策略:先提滿 401k 的 match,再補 IRA,有餘力再回頭提滿 401k。",
    q4: "提早領出會怎樣?",
    a4: "59½ 歲前提領 401k 通常需繳所得稅加 10% 罰款(部分例外如首購、醫療)。提早領出會嚴重損害複利效果,應視為最後手段。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在你的瀏覽器內以 JavaScript 完成,薪資與提撥等資料不會傳送到任何伺服器。",
    q6: "可以模擬不同報酬率嗎?",
    a6: "自訂報酬率、含通膨的實質購買力、Roth vs Traditional 稅務比較與提領策略屬於專業版功能,免費版以 7% 報酬估算。"
  },
  en: {
    badge: "Finance · 401k Retirement Calculator · Gold Tool",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "401k Retirement Calculator",
    subtitle: "Enter salary, contribution percent, and employer match to see the account future value and employer share",
    intro: "401k Retirement Calculator runs the standard formula in your browser. Enter annual salary, contribution pct, employer match pct, years to see the primary result and three supporting metrics. Nothing is uploaded.",
    ...
    tryExample: "Try 401k Retirement Calculator",
    examplePreview: "Employer Match Share",
    examplePerson: "Standard example",
    fillExample: "Fill standard example",
    previewActivePath: "Fill advanced example",
    examplesCalculator: "Examples → Calculator",
    enterValues: "Enter annual salary, contribution pct, employer match pct, years",
    ...
    baselineExampleValue: "Salary 1.5M · 10% · match 5%",
    baselineExampleNote: "Annual Salary 1500000 · Contribution Pct 10",
    activeExample: "Advanced example",
    activeExampleValue: "Salary 2.5M · 15% · match 6%",
    activeExampleNote: "Annual Salary doubled · watch Employer Match Share react",
    flowDemo: "Data flow demo",
    calculator: "401k Retirement Calculator",
    annualSalary: "Annual Salary",
    contributionPct: "Contribution Pct",
    employerMatchPct: "Employer Match Pct",
    years: "Years",
    resultCard: "Result card",
    primaryValue: "Employer Match Share",
    primaryUnitTail: "%",
    secondaryLabel: "Account Future Value",
    secondaryTail: "$",
    metricALabel: "Employer Match Share",
    ...
    metricCTail: "$",
    headlineCaption: "401k Retirement Calculator · live calc",
    fatLossTarget: "Annual Match",
    resultIntelligence: "Result intelligence",
    tdeeMatrix: "401k Retirement Calculator · band matrix",
    ...
    nextActionItem1: "Move Annual Salary and Employer Match Pct by ±10% to see sensitivity.",
    ...
    decisionTitle: "401k Retirement Calculator · 4-step decision",
    bmrStep: "Step 1 · Gather inputs",
    bmrNote: "Fill annual salary, contribution pct, employer match pct, years.",
    deficitStep: "Step 2 · Apply formula",
    deficitNote: "401k Retirement Calculator standard formula.",
    ...
    knowledgeTitle: "401k Retirement Calculator · concept primer",
    definition: "Definition",
    definitionText: "401k Retirement Calculator converts inputs (annual salary, contribution pct, employer match pct, years) into Employer Match Share. It is widely used in personal finance and investment planning.",
    formula: "Formula",
    formulaText: "result = f(annual salary, contribution pct, employer match pct, years)",
    ...
    premiumTitle: "Pro Retirement Planner",
    premiumText: "Unlock custom returns, inflation-adjusted value, Roth vs Traditional tax compare, contribution-limit checks, and withdrawal strategy simulation.",
    premiumChips_zh: "自訂報酬|通膨調整|稅務比較|提領策略",
    premiumChips_en: "Custom Return|Inflation|Tax Compare|Withdrawal",
    ...
    q1: "What does 401k Retirement Calculator calculate?",
    a1: "401k Retirement Calculator applies the standard formula to your inputs and returns Employer Match Share plus three supporting metrics, all computed in your browser.",
    q2: "Which inputs do I need for 401k Retirement Calculator?",
    a2: "Enter annual salary, contribution pct, employer match pct, years. 401k Retirement Calculator runs the standard formula client-side and updates instantly as you type.",
    ...
    a6: "Unlock custom returns, inflation-adjusted value, Roth vs Traditional tax compare, contribution-limit checks, and withdrawal strategy simulation."
  },
} as const;
...
export default function Retirement401kCalculator() {
  ...
  }, [annualSalary, contributionPct, employerMatchPct, years]);

  const primaryDisplay = fmt(result.matchShare, 1);
  const secondaryDisplay = fmt(result.fv, 0);
  const tertiaryDisplay = fmt(result.totalContributed, 0);
  const quaternaryDisplay = fmt(result.annualMatch, 0);

  function fillSolid() { setUnit("metric"); setAnnualSalary("1500000"); setContributionPct("10"); setEmployerMatchPct("5"); setYears("30"); }
  function fillHighSalary() { setUnit("imperial"); setAnnualSalary("2500000"); setContributionPct("15"); setEmployerMatchPct("6"); setYears("25"); }

  const activeBand = bands.find(b => {
    const r = result.matchShare;
    if (r < 5) return 'tiny';
    if (r < 15) return 'normal';
    if (r < 25) return 'notable';
    if (r < 35) return 'high';
    if (r < 50) return 'major';
    return 'executive';
  });
      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_#ede9fe,_#f8fafc_45%,_#e0e7ff)]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            ...
            <aside className="rounded-[2rem] border border-violet-100 bg-white/90 p-6 shadow-2xl shadow-violet-950/10 backdrop-blur"><p className="text-xs font-black uppercase tracking-[0.18em] text-violet-700">{t.quickActionCard}</p><h2 className="mt-2 text-2xl font-black">{t.tryExample}</h2><div className="mt-5 rounded-3xl bg-violet-600 p-5 text-white"><div className="text-xs font-bold uppercase text-violet-100">{t.examplePreview}</div><div className="mt-1 text-5xl font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div><div className="text-sm font-bold text-violet-100">{t.headlineCaption}</div></div><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.examplePerson}</div><div className="font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.flowDemo}</div><div className="font-black">{annualSalary} × {contributionPct}</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.fatLossTarget}</div><div className="font-black">{secondaryDisplay}</div></div></div><button onClick={fillSolid} className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-4 text-sm font-black text-white">{t.fillExample}</button><button onClick={fillHighSalary} className="mt-3 w-full rounded-2xl border border-violet-200 bg-violet-50 px-5 py-4 text-sm font-black text-violet-900">{t.previewActivePath}</button></aside>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5"><h3 className="text-lg font-black">{t.calculator}</h3><div className="mt-4 grid gap-4 md:grid-cols-2"><label className="block text-sm font-black text-emerald-700">{t.annualSalary}<input type="number" step="50000" className="mt-2 w-full rounded-2xl border border-emerald-200 px-4 py-3 text-lg font-bold" value={annualSalary} onChange={(e) => setAnnualSalary(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.contributionPct}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={contributionPct} onChange={(e) => setContributionPct(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.employerMatchPct}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={employerMatchPct} onChange={(e) => setEmployerMatchPct(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.years}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={years} onChange={(e) => setYears(e.target.value)} /></label></div></div>
          </div>
        </section>
        ...
        <AdSenseWrapper showAds={true} adSlot="retirement-401k-calculator-result-intelligence" adFormat="horizontal" className="my-2" />
        ...
        <section aria-label="L14 常見問題後廣告位:廣告位" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="retirement-401k-calculator-faq" position="inline" /></section>
