// @profile B
// Profile B · 計算機-YMYL · EpsCalculator（GOLD-STANDARD-001 compatible · clone of MeetingCostCalculator）
...
const bands = [
  { key: "tiny", range: "< 1", label: { zh: "盈餘偏弱 (< 1)", en: "Weak (< 1)" }, desc: { zh: "落在「盈餘偏弱」級距< 1。每股盈餘偏低,獲利能力相對薄弱,須留意營運狀況。", en: "Falls in the \"Weak\" band (< 1). Low EPS; earnings power is relatively weak, watch operations." } },
  { key: "normal", range: "1–3", label: { zh: "盈餘普通 (1–3)", en: "Average (1–3)" }, desc: { zh: "落在「盈餘普通」級距1–3。每股盈餘普通,獲利能力一般,可觀察成長趨勢。", en: "Falls in the \"Average\" band (1–3). Average EPS; ordinary earnings power, observe growth trend." } },
  { key: "notable", range: "3–6", label: { zh: "盈餘穩健 (3–6)", en: "Solid (3–6)" }, desc: { zh: "落在「盈餘穩健」級距3–6。每股盈餘穩健,公司具備一定獲利能力。", en: "Falls in the \"Solid\" band (3–6). Solid EPS; the company has decent earnings power." } },
  { key: "high", range: "6–10", label: { zh: "盈餘良好 (6–10)", en: "Good (6–10)" }, desc: { zh: "落在「盈餘良好」級距6–10。每股盈餘良好,獲利能力佳,基本面相對紮實。", en: "Falls in the \"Good\" band (6–10). Good EPS; strong earnings, fundamentals are relatively solid." } },
  { key: "major", range: "10–15", label: { zh: "盈餘優異 (10–15)", en: "Strong (10–15)" }, desc: { zh: "落在「盈餘優異」級距10–15。每股盈餘優異,獲利能力強勁,具投資吸引力。", en: "Falls in the \"Strong\" band (10–15). Strong EPS; robust earnings power, attractive for investors." } },
  { key: "executive", range: "≥ 15", label: { zh: "盈餘卓越 (≥ 15)", en: "Excellent (≥ 15)" }, desc: { zh: "落在「盈餘卓越」級距≥ 15。每股盈餘卓越,獲利能力極強,屬高獲利企業。", en: "Falls in the \"Excellent\" band (≥ 15). Excellent EPS; very high earnings power, a highly profitable firm." } },
] as const;
...
const ui = {
  zh: {
    badge: "財務 · 每股盈餘計算機 · 黃金工具",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "EPS Calculator · 每股盈餘計算機",
    subtitle: "由淨利與股數計算每股盈餘、本益比與盈餘殖利率。",
    intro: "本工具為 每股盈餘計算機，依公開公式於瀏覽器端試算，輸入稅後淨利、特別股股利、流通在外股數、股價後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在您的裝置完成。",
    trustNoteLabel: "注意事項：",
    trustNote: "本工具僅供一般情境試算，未涵蓋極端條件、稅務優惠、地區差異或特殊規範。涉及重大決策請以合格專業人士為準。",
    quickActionCard: "快速範例卡",
    tryExample: "試算每股盈餘計算機",
    examplePreview: "每股盈餘 (EPS)",
    examplePerson: "標準範例",
    fillExample: "一鍵填入標準範例",
    previewActivePath: "填入進階範例",
    examplesCalculator: "範例 → 計算機",
    enterValues: "輸入稅後淨利、特別股股利、流通在外股數、股價",
    examplesHelper: "先用範例了解結果輸出，再改成自己的數字。",
    metric: "標準",
    imperial: "進階",
    exampleCards: "範例卡",
    baselineExample: "標準範例",
    baselineExampleValue: "穩健獲利情境",
    baselineExampleNote: "稅後淨利 5000000 · 特別股股利 0",
    activeExample: "進階範例",
    activeExampleValue: "高獲利大型股情境",
    activeExampleNote: "稅後淨利 加倍 · 觀察 每股盈餘 (EPS) 變化",
    flowDemo: "數字流向示範",
    calculator: "每股盈餘計算機",
    netIncome: "稅後淨利",
    preferredDividends: "特別股股利",
    sharesOutstanding: "流通在外股數",
    sharePrice: "股價",
    resultCard: "結果卡片",
    primaryValue: "每股盈餘 (EPS)",
    primaryUnitTail: "$",
    secondaryLabel: "本益比 (P/E)",
    secondaryTail: "x",
    metricALabel: "每股盈餘 (EPS)",
    metricACaption: "依公開公式試算的主要數值",
    metricATail: "$",
    metricBLabel: "本益比 (P/E)",
    metricBCaption: "與主要結果連動的次要量值",
    metricBTail: "x",
    metricCLabel: "盈餘殖利率",
    metricCCaption: "百分比形式的觀察點",
    metricCTail: "%",
    headlineCaption: "每股盈餘計算機 · 即時試算",
    fatLossTarget: "歸屬普通股盈餘",
    resultIntelligence: "結果解讀",
    tdeeMatrix: "每股盈餘計算機 · 級距矩陣",
    ...
    nextActionItem1: "把 稅後淨利 與 流通在外股數 各調 ±10% 觀察主要結果敏感度",
    ...
    decisionPath: "決策路徑",
    decisionTitle: "每股盈餘計算機 · 決策四步",
    bmrStep: "Step 1 · 蒐集參數",
    bmrNote: "先把 稅後淨利、特別股股利、流通在外股數、股價 四個欄位填齊。",
    deficitStep: "Step 2 · 套公式",
    deficitNote: "Earnings per share analysis。",
    trendStep: "Step 3 · 看級距",
    trendNote: "對照六格級距,定位主要結果。",
    mealStep: "Step 4 · 行動",
    mealNote: "依級距提示挑一個下一步,執行 30 天後回來重算。",
    knowledge: "工具知識庫",
    knowledgeTitle: "每股盈餘計算機 · 觀念整理",
    definition: "定義",
    definitionText: "每股盈餘計算機以稅後淨利、特別股股利與流通在外股數計算每股盈餘 (EPS),並一併推算本益比、盈餘殖利率與歸屬普通股盈餘。",
    formula: "公式",
    formulaText: "EPS =(稅後淨利 − 特別股股利)÷ 流通在外股數;本益比 = 股價 ÷ EPS;盈餘殖利率 = EPS ÷ 股價。",
    limitations: "限制",
    limitationsText: "本工具採單期淨利與目前股數的簡化模型,未計入稀釋股數、庫藏股、季度波動與一次性損益,僅供概念性估算。",
    interpretation: "解讀",
    interpretationText: "每股盈餘越高代表每股分配到的獲利越多,獲利能力越強;搭配本益比與盈餘殖利率,可進一步判斷估值是否合理。",
    context: "情境",
    ...
    premiumTitle: "EPS Pro 進階",
    premiumText: "進階版加入稀釋每股盈餘、季度 EPS 趨勢、同業比較與盈餘成長率推算。",
    premiumChips_zh: "稀釋EPS|季度趨勢|同業比較|成長率推算",
    premiumChips_en: "Diluted EPS|Quarterly trend|Peer compare|Growth modeling",
    ...
    q1: "每股盈餘是什麼?",
    a1: "每股盈餘是公司歸屬普通股股東的淨利除以流通在外股數,代表每一股股票分配到的獲利,是衡量獲利能力的核心指標。",
    q2: "EPS 怎麼計算?",
    a2: "EPS =(稅後淨利 − 特別股股利)÷ 流通在外股數;先把屬於特別股的股利扣掉,剩下才是普通股股東可享有的盈餘。",
    q3: "為什麼要扣除特別股股利?",
    a3: "特別股股東對盈餘有優先請求權,須先發放特別股股利後,剩餘盈餘才歸屬普通股,因此計算普通股 EPS 時要先扣除。",
    q4: "EPS 越高越好嗎?",
    a4: "一般而言 EPS 越高代表獲利能力越強,但須留意股數變動、一次性損益與盈餘品質,並與同業及歷史趨勢比較。",
    q5: "EPS 和本益比有什麼關係?",
    a5: "本益比 = 股價 ÷ EPS,EPS 是本益比的分母;EPS 提高在股價不變下會使本益比下降,代表估值相對變便宜。",
    q6: "這個結果準確嗎?",
    a6: "本工具以單期淨利與目前股數的簡化模型估算,未計入稀釋股數、季度波動與會計調整,僅供概念性參考。"
  },
  en: {
    badge: "Finance · EPS Calculator · Gold Tool",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "EPS Calculator",
    subtitle: "Calculate EPS, P/E ratio and earnings yield from net income and shares.",
    intro: "EPS Calculator runs the standard formula in your browser. Enter net income, preferred dividends, shares outstanding, share price to see the primary result and three supporting metrics. Nothing is uploaded.",
    ...
    tryExample: "Try EPS Calculator",
    examplePreview: "Earnings per share",
    examplePerson: "Standard example",
    fillExample: "Fill standard example",
    previewActivePath: "Fill advanced example",
    examplesCalculator: "Examples → Calculator",
    enterValues: "Enter net income, preferred dividends, shares outstanding, share price",
    ...
    baselineExampleValue: "Steady earnings case",
    baselineExampleNote: "Net income 5000000 · Preferred dividends 0",
    activeExample: "Advanced example",
    activeExampleValue: "High-earnings large-cap case",
    activeExampleNote: "Net income doubled · watch Earnings per share react",
    flowDemo: "Data flow demo",
    calculator: "EPS Calculator",
    netIncome: "Net income",
    preferredDividends: "Preferred dividends",
    sharesOutstanding: "Shares outstanding",
    sharePrice: "Share price",
    resultCard: "Result card",
    primaryValue: "Earnings per share",
    primaryUnitTail: "$",
    secondaryLabel: "P/E ratio",
    secondaryTail: "x",
    metricALabel: "Earnings per share",
    metricACaption: "Main figure from the standard formula",
    metricATail: "$",
    metricBLabel: "P/E ratio",
    metricBCaption: "Secondary metric tied to the primary",
    metricBTail: "x",
    metricCLabel: "Earnings yield",
    metricCCaption: "Percentage view",
    metricCTail: "%",
    headlineCaption: "EPS Calculator · live calc",
    fatLossTarget: "Earnings to common",
    resultIntelligence: "Result intelligence",
    tdeeMatrix: "EPS Calculator · band matrix",
    ...
    nextActionItem1: "Move Net income and Shares outstanding by ±10% to see sensitivity.",
    ...
    decisionTitle: "EPS Calculator · 4-step decision",
    bmrStep: "Step 1 · Gather inputs",
    bmrNote: "Fill net income, preferred dividends, shares outstanding, share price.",
    deficitStep: "Step 2 · Apply formula",
    deficitNote: "EPS Calculator standard formula.",
    ...
    knowledgeTitle: "EPS Calculator · concept primer",
    definition: "Definition",
    definitionText: "EPS Calculator converts inputs (net income, preferred dividends, shares outstanding, share price) into Earnings per share. It is widely used in personal finance and investment planning.",
    formula: "Formula",
    formulaText: "result = f(net income, preferred dividends, shares outstanding, share price)",
    ...
    premiumTitle: "EPS Pro",
    premiumText: "Pro adds diluted EPS, quarterly EPS trends, peer comparison and earnings-growth modeling.",
    premiumChips_zh: "稀釋EPS|季度趨勢|同業比較|成長率推算",
    premiumChips_en: "Diluted EPS|Quarterly trend|Peer compare|Growth modeling",
    ...
    q1: "What does EPS Calculator calculate?",
    a1: "EPS Calculator applies the standard formula to your inputs and returns Earnings per share plus three supporting metrics, all computed in your browser.",
    q2: "Which inputs do I need for EPS Calculator?",
    a2: "Enter net income, preferred dividends, shares outstanding, share price. EPS Calculator runs the standard formula client-side and updates instantly as you type.",
    ...
    a6: "Pro adds diluted EPS, quarterly EPS trends, peer comparison and earnings-growth modeling."
  },
} as const;
...
const ni = Number(netIncome) || 0; const preferred = Number(preferredDividends) || 0; const shares = Number(sharesOutstanding) || 0; const price = Number(sharePrice) || 0; const eps = shares > 0 ? (ni - preferred) / shares : 0; const peRatio = eps > 0 ? price / eps : 0; const earningsYield = price > 0 ? (eps / price) * 100 : 0; const earningsToCommon = ni - preferred; return { primaryKey: eps, secondaryKey: peRatio, tertiaryKey: earningsYield, quaternaryKey: earningsToCommon };
  }, [netIncome, preferredDividends, sharesOutstanding, sharePrice]);
  ...
  function fillSolid() { setUnit("metric"); setNetIncome("5000000"); setPreferredDividends("0"); setSharesOutstanding("1000000"); setSharePrice("100"); }
  function fillHighSalary() { setUnit("imperial"); setNetIncome("20000000"); setPreferredDividends("500000"); setSharesOutstanding("1000000"); setSharePrice("300"); }

  const activeBand = bands.find(b => {
    const r = result.primaryKey;
    if (r < 1) return 'tiny';
    if (r < 3) return 'normal';
    if (r < 6) return 'notable';
    if (r < 10) return 'high';
      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_#d1fae5,_#f8fafc_45%,_#e0f2fe)]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            ...
            <aside className="rounded-[2rem] border border-emerald-100 bg-white/90 p-6 shadow-2xl shadow-emerald-950/10 backdrop-blur"><p className="text-xs font-black uppercase tracking-[0.18em] text-emerald-700">{t.quickActionCard}</p><h2 className="mt-2 text-2xl font-black">{t.tryExample}</h2><div className="mt-5 rounded-3xl bg-emerald-600 p-5 text-white"><div className="text-xs font-bold uppercase text-emerald-100">{t.examplePreview}</div><div className="mt-1 text-5xl font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div><div className="text-sm font-bold text-emerald-100">{t.headlineCaption}</div></div><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.examplePerson}</div><div className="font-black">{primaryDisplay}<span>{t.primaryUnitTail}</span></div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.flowDemo}</div><div className="font-black">{netIncome} × {preferredDividends}</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.fatLossTarget}</div><div className="font-black">{secondaryDisplay}</div></div></div><button onClick={fillSolid} className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-4 text-sm font-black text-white">{t.fillExample}</button><button onClick={fillHighSalary} className="mt-3 w-full rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm font-black text-emerald-900">{t.previewActivePath}</button></aside>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5"><h3 className="text-lg font-black">{t.calculator}</h3><div className="mt-4 grid gap-4 md:grid-cols-2"><label className="block text-sm font-black text-slate-700">{t.netIncome}<input type="number" step="10000" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={netIncome} onChange={(e) => setNetIncome(e.target.value)} /></label><label className="block text-sm font-black text-emerald-700">{t.preferredDividends}<input type="number" step="1000" className="mt-2 w-full rounded-2xl border border-emerald-200 px-4 py-3 text-lg font-bold" value={preferredDividends} onChange={(e) => setPreferredDividends(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.sharesOutstanding}<input type="number" step="1000" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={sharesOutstanding} onChange={(e) => setSharesOutstanding(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.sharePrice}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={sharePrice} onChange={(e) => setSharePrice(e.target.value)} /></label></div></div>
          </div>
        </section>
        ...
        <AdSenseWrapper showAds={true} adSlot="eps-calculator-result-intelligence" adFormat="horizontal" className="my-2" />
        ...
        <section aria-label="L14 常見問題後廣告位:廣告位" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="eps-calculator-faq" position="inline" /></section>
