...
const ui = {
  zh: {
    ...
    intro: "本工具為 遺產稅計算機，依公開公式於瀏覽器端試算，輸入遺產總值、聯邦免稅額、可扣除負債與捐贈、適用遺產稅率後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q2: "聯邦免稅額是多少?",
    a2: "美國聯邦遺產免稅額逐年調整(2024 年約 1,361 萬美元/人),超過部分才課稅;本工具以你輸入的免稅額計算。",
    q3: "哪些可以扣除?",
