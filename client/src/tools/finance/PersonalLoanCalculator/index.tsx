...
const ui = {
  zh: {
    ...
    intro: "輸入貸款金額、年利率、還款期數與開辦手續費,本工具以本息攤還公式計算每月還款額、總利息與含手續費的總成本,並換算總成本佔本金比例,協助您比較不同信貸方案。",
    trustNoteLabel: "注意事項:",
    trustNote: "此工具僅供教育與規劃用途,結果為估算值,不構成專業財務、稅務或投資建議。",
    quickActionCard: "快速範例",
    tryExample: "一鍵建立個人貸款範例",
    examplePreview: "結果預覽",
    examplePerson: "標準範例",
  ...
  en: {
    ...
    tryExample: "Try a personal-loan example",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 常見問題補充區" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="personal-loan-calculator-faq" position="inline" /></section>
