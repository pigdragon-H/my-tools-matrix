...
const ui = {
  zh: {
    ...
    intro: "本工具以房價、頭期款、年利率與年期推算房貸本金，再採用銀行常用的等額本息公式（PMT）估算每月房貸、本息總額、總利息、貸款成數（LTV）與月收入負擔率（DTI）。六段年期對照表協助你比較 5 / 10 / 15 / 20 / 25 / 30 年的月付壓力與總利息取捨。",
    trustNoteLabel: "信任提醒：",
    ...
    examplesHelper: "先用範例理解房價、頭期款、貸款成數、月付與總利息，再改成你自己的買房條件。",
    metric: "新台幣",
    imperial: "美元",
    exampleCards: "範例卡",
    ...
    relatedTools: "相關工具",
    relatedToolsText: "複利計算 · CAGR · 退休金 · 月薪存款 · 房貸 vs 租屋 · 房租買房比較",
    references: "參考資料",
    referencesText: "Consumer Financial Protection Bureau Explore Interest Rates；Investopedia Mortgage Calculator / Loan Payment Formula；Fannie Mae Mortgage Learning Center；中華民國銀行公會房貸試算範本。",
    q1: "為什麼月付不是「金額 ÷ 年期 ÷ 12」？",
