// @profile B
// Profile B · 計算機-YMYL · CapitalGainsTaxCalculator（GOLD-STANDARD-001 compatible · clone of MeetingCostCalculator）
...
const affiliateItems: AffiliateItem[] = [
  ...
  { label: { zh: "股票獲利計算機", en: "Stock Profit Calculator" }, href: "/tools/finance/stock-profit-calculator" },
...
const ui = {
  zh: {
    badge: "財務 · 資本利得稅計算機 · 黃金工具",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Capital Gains Tax Calculator · 資本利得稅計算機",
    subtitle: "輸入買入價、賣出價、股數與稅率，立即估算資本利得稅與稅後淨利",
    intro: "本工具為 資本利得稅計算機，依公開公式於瀏覽器端試算，輸入買入價、賣出價、持有股數、稅率%後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    trustNote: "本工具僅供一般情境試算，未涵蓋極端條件、稅務優惠、地區差異或特殊規範。涉及重大決策請以合格專業人士為準。",
    quickActionCard: "快速範例卡",
    tryExample: "試算資本利得稅計算機",
    examplePreview: "有效稅率",
    examplePerson: "標準範例",
    fillExample: "一鍵填入標準範例",
    previewActivePath: "填入進階範例",
    examplesCalculator: "範例 → 計算機",
    enterValues: "輸入買入價、賣出價、持有股數、稅率%",
    examplesHelper: "先用範例了解結果輸出，再改成自己的數字。",
    metric: "標準",
    imperial: "進階",
    exampleCards: "範例卡",
    baselineExample: "標準範例",
    baselineExampleValue: "買 100 · 賣 150 · 100 股 · 15%",
    baselineExampleNote: "買入價 100 · 賣出價 150",
    activeExample: "進階範例",
    activeExampleValue: "買 50 · 賣 120 · 200 股 · 32%",
    activeExampleNote: "買入價 加倍 · 觀察 有效稅率 變化",
    flowDemo: "數字流向示範",
    calculator: "資本利得稅計算機",
    buyPrice: "買入價",
    sellPrice: "賣出價",
    ...
    primaryValue: "有效稅率",
    primaryUnitTail: "%",
    secondaryLabel: "應繳資本利得稅",
    secondaryTail: "$",
    metricALabel: "有效稅率",
    metricACaption: "依公開公式試算的主要數值",
    metricATail: "%",
    metricBLabel: "應繳資本利得稅",
    metricBCaption: "與主要結果連動的次要量值",
    metricBTail: "$",
    metricCLabel: "資本利得",
    metricCCaption: "百分比形式的觀察點",
    metricCTail: "$",
    headlineCaption: "資本利得稅計算機 · 即時試算",
    fatLossTarget: "稅後淨利",
    resultIntelligence: "結果解讀",
    tdeeMatrix: "資本利得稅計算機 · 級距矩陣",
    ...
    nextActionItem1: "把 買入價 與 持有股數 各調 ±10% 觀察主要結果敏感度",
    ...
    decisionPath: "決策路徑",
    decisionTitle: "資本利得稅計算機 · 決策四步",
    bmrStep: "Step 1 · 蒐集參數",
    bmrNote: "先把 買入價、賣出價、持有股數、稅率% 四個欄位填齊。",
    deficitStep: "Step 2 · 套公式",
    deficitNote: "依買入、賣出價、股數與稅率計算資本利得、應繳稅額與稅後淨利。",
    trendStep: "Step 3 · 看級距",
    trendNote: "對照六格級距,定位主要結果。",
    mealStep: "Step 4 · 行動",
    mealNote: "依級距提示挑一個下一步,執行 30 天後回來重算。",
    knowledge: "知識庫",
    knowledgeTitle: "資本利得稅計算機 · 觀念整理",
    definition: "定義",
    definitionText: "資本利得稅計算機以買入價、賣出價、股數與稅率,計算資本利得、應繳稅額與稅後淨利,適用股票、ETF、基金等投資出售的稅負估算。",
    formula: "公式",
    formulaText: "資本利得 = (賣出價 − 買入價) × 股數;稅額 = 利得 × 稅率(利得為正才課稅);稅後淨利 = 利得 − 稅額",
    limitations: "限制",
    limitationsText: "本工具採單一稅率模型,不分短期/長期、不計手續費、證交稅、虧損抵減與分級稅率;各國法規差異大,請以當地稅法與會計師意見為準。",
    interpretation: "解讀",
    interpretationText: "有效稅率越高代表稅負越重,可透過長期持有、虧損抵減與免稅帳戶降低;稅後淨利為實際入袋金額。",
    context: "情境",
    contextText: "常見使用情境包括日常財務檢視、年度規劃、重大決策前的快速估算。建議搭配稅率級距計算機 等延伸工具一起使用。",
    example: "範例",
    ...
    premiumTitle: "專業版 資本利得稅務工具組",
    premiumText: "解鎖短期/長期分類、tax-loss harvesting 模擬、多筆交易批次計算、分級稅率與年度稅務彙總報表。",
    premiumChips_zh: "長短期分類|虧損抵稅|批次計算|年度彙總",
    premiumChips_en: "ST/LT|Loss Harvest|Batch|Summary",
    ...
    q1: "短期和長期資本利得稅差多少?",
    a1: "在美國,**短期(持有 ≤ 1 年)**資本利得併入一般所得,稅率最高 37%;**長期(持有 > 1 年)**享優惠稅率 0%/15%/20%。光是多持有幾天跨過一年門檻,稅率可能從 37% 降到 15%,差距巨大。",
    q2: "虧損可以抵稅嗎?",
    a2: "可以。資本損失可先抵銷資本利得,若損失大於利得,美國每年最多可用 3000 美元抵一般所得,剩餘部分結轉至未來年度(tax-loss harvesting)。本工具僅算單筆利得稅,虧損抵稅請用專業版情境模擬。",
    q3: "台灣股票要繳資本利得稅嗎?",
    a3: "台灣現行**證券交易所得停徵**,個人買賣上市櫃股票不課資本利得稅,僅課 0.3% 證交稅(賣出時)。但未上市股票、海外所得、ETF 配息等另有規定,本工具以通用稅率模型計算,請依當地法規調整。",
    q4: "怎麼合法節省資本利得稅?",
    a4: "常見策略:**(1) 長期持有**跨過一年門檻享優惠稅率、**(2) tax-loss harvesting** 用虧損抵利得、**(3) 善用免稅帳戶**(如美國 Roth IRA、401k)、**(4) 分年實現利得**控制級距。建議諮詢稅務專業人士。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在你的瀏覽器內完成,買入價、賣出價等資料不會傳送到任何伺服器。",
    q6: "可以一次算多筆交易嗎?",
    a6: "批次計算多筆交易、自動分類短期/長期、tax-loss harvesting 模擬與年度稅務彙總屬於專業版功能。"
  },
  en: {
    badge: "Finance · Capital Gains Tax Calculator · Gold Tool",
    switchToEnglish: "English mode",
    switchToChinese: "切換到中文",
    chineseShort: "中",
    englishShort: "EN",
    title: "Capital Gains Tax Calculator · 資本利得稅計算機",
    subtitle: "Enter buy price, sell price, shares, and tax rate to estimate capital gains tax and net profit",
    intro: "Capital Gains Tax Calculator runs the standard formula in your browser. Enter buy price, sell price, shares held, tax rate pct to see the primary result and three supporting metrics. Nothing is uploaded.",
    ...
    tryExample: "Try Capital Gains Tax Calculator",
    examplePreview: "Effective Rate",
    examplePerson: "Standard example",
    fillExample: "Fill standard example",
    previewActivePath: "Fill advanced example",
    examplesCalculator: "Examples → Calculator",
    enterValues: "Enter buy price, sell price, shares held, tax rate pct",
    ...
    baselineExampleValue: "Buy 100 · Sell 150 · 100sh · 15%",
    baselineExampleNote: "Buy Price 100 · Sell Price 150",
    activeExample: "Advanced example",
    activeExampleValue: "Buy 50 · Sell 120 · 200sh · 32%",
    activeExampleNote: "Buy Price doubled · watch Effective Rate react",
    ...
    primaryValue: "Effective Rate",
    primaryUnitTail: "%",
    secondaryLabel: "Capital Gains Tax",
    secondaryTail: "$",
    metricALabel: "Effective Rate",
    metricACaption: "Main figure from the standard formula",
    metricATail: "%",
    metricBLabel: "Capital Gains Tax",
    metricBCaption: "Secondary metric tied to the primary",
    metricBTail: "$",
    metricCLabel: "Capital Gain",
    metricCCaption: "Percentage view",
    metricCTail: "$",
    headlineCaption: "Capital Gains Tax Calculator · live calc",
    fatLossTarget: "Net Profit",
    resultIntelligence: "Result intelligence",
    tdeeMatrix: "Capital Gains Tax Calculator · band matrix",
    ...
    nextActionItem1: "Move Buy Price and Shares Held by ±10% to see sensitivity.",
    ...
    decisionTitle: "Capital Gains Tax Calculator · 4-step decision",
    bmrStep: "Step 1 · Gather inputs",
    bmrNote: "Fill buy price, sell price, shares held, tax rate pct.",
    ...
    knowledge: "Knowledge",
    knowledgeTitle: "Capital Gains Tax Calculator · concept primer",
    definition: "Definition",
    definitionText: "Capital Gains Tax Calculator converts inputs (buy price, sell price, shares held, tax rate pct) into Effective Rate. It is widely used in personal finance and investment planning.",
    formula: "Formula",
    formulaText: "資本利得 = (賣出價 − 買入價) × 股數;稅額 = 利得 × 稅率(利得為正才課稅);稅後淨利 = 利得 − 稅額",
    ...
    context: "Context",
    contextText: "Common contexts include daily finance review, annual planning, and pre-decision quick estimates. Pair with Tax Bracket Calculator for a fuller picture.",
    example: "Example",
    ...
    premiumTitle: "Pro Capital Gains Suite",
    premiumText: "Unlock short/long-term classification, tax-loss harvesting, batch trades, tiered rates, and annual tax summary.",
    premiumChips_zh: "長短期分類|虧損抵稅|批次計算|年度彙總",
    premiumChips_en: "ST/LT|Loss Harvest|Batch|Summary",
    ...
    q1: "About: 短期和長期資本利得稅差多少?",
    a1: "For \"短期和長期資本利得稅差多少?\": Capital Gains Tax Calculator runs the standard formula client-side; no data leaves the browser. Use the band guidance shown next to the result for your next step.",
    q2: "About: 虧損可以抵稅嗎?",
    a2: "For \"虧損可以抵稅嗎?\": Capital Gains Tax Calculator runs the standard formula client-side; no data leaves the browser. For unusual scenarios, consult a qualified professional.",
    q3: "About: 台灣股票要繳資本利得稅嗎?",
    a3: "For \"台灣股票要繳資本利得稅嗎?\": Capital Gains Tax Calculator runs the standard formula client-side; no data leaves the browser. Use the band guidance shown next to the result for your next step.",
    q4: "About: 怎麼合法節省資本利得稅?",
    a4: "For \"怎麼合法節省資本利得稅?\": Capital Gains Tax Calculator runs the standard formula client-side; no data leaves the browser. For unusual scenarios, consult a qualified professional.",
    q5: "About: 資料會上傳嗎?",
    a5: "For \"資料會上傳嗎?\": Capital Gains Tax Calculator runs the standard formula client-side; no data leaves the browser. Use the band guidance shown next to the result for your next step.",
    q6: "About: 可以一次算多筆交易嗎?",
    a6: "For \"可以一次算多筆交易嗎?\": Capital Gains Tax Calculator runs the standard formula client-side; no data leaves the browser. For unusual scenarios, consult a qualified professional."
  },
} as const;
...
export default function CapitalGainsTaxCalculator() {
  ...
  }, [buyPrice, sellPrice, sharesHeld, taxRatePct]);

  const primaryDisplay = fmt(result.effRate, 2);
  const secondaryDisplay = fmt(result.tax, 2);
  const tertiaryDisplay = fmt(result.gain, 2);
  const quaternaryDisplay = fmt(result.netProfit, 2);

  function fillSolid() { setUnit("metric"); setBuyPrice("100"); setSellPrice("150"); setSharesHeld("100"); setTaxRatePct("15"); }
  function fillHighSalary() { setUnit("imperial"); setBuyPrice("50"); setSellPrice("120"); setSharesHeld("200"); setTaxRatePct("32"); }
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5"><h3 className="text-lg font-black">{t.calculator}</h3><div className="mt-4 grid gap-4 md:grid-cols-2"><label className="block text-sm font-black text-slate-700">{t.buyPrice}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={buyPrice} onChange={(e) => setBuyPrice(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.sellPrice}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={sellPrice} onChange={(e) => setSellPrice(e.target.value)} /></label><label className="block text-sm font-black text-slate-700">{t.sharesHeld}<input type="number" step="10" className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 text-lg font-bold" value={sharesHeld} onChange={(e) => setSharesHeld(e.target.value)} /></label><label className="block text-sm font-black text-emerald-700">{t.taxRatePct}<input type="number" step="1" className="mt-2 w-full rounded-2xl border border-emerald-200 px-4 py-3 text-lg font-bold" value={taxRatePct} onChange={(e) => setTaxRatePct(e.target.value)} /></label></div></div>
          </div>
        </section>
        ...
        <AdSenseWrapper showAds={true} adSlot="capital-gains-tax-calculator-result-intelligence" adFormat="horizontal" className="my-2" />
        ...
        <section aria-label="L14 常見問題後廣告位:廣告位" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="capital-gains-tax-calculator-faq" position="inline" /></section>
