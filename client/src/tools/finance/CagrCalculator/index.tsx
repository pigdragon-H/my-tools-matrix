...
const ui = {
  zh: {
    ...
    intro: "本工具採用國際公認的「複合年化成長率」（CAGR）標準公式，輸入起始投資金額、目前金額與投資年期，即可換算真實的年化報酬率、總報酬率與總獲利。並提供 5 / 10 / 15 / 20 / 25 / 30 年六段對照，幫您判斷投資績效在不同時間尺度下的表現。",
    trustNoteLabel: "信任提醒：",
    ...
    examplesHelper: "先用範例感受「翻倍≠很厲害」這件事，再改成您自己的投資績效。",
    metric: "新台幣",
    imperial: "美元",
    exampleCards: "範例卡",
    ...
    periodMatrixNote: "下列卡片以您的起始與終值為基礎，假設不同年期回望，看出 CAGR 對「年期」的敏感度——同樣翻倍，5 年和 30 年的年化天差地遠。",
    ...
    q1: "CAGR 跟「總報酬率」差在哪？",
    a1: "總報酬率 (FV-PV)/PV 看您「總共賺多少％」；CAGR 把這個總報酬攤平到每年，告訴您「平均每年複利賺多少％」。10 年翻倍，總報酬 100%，CAGR 只有 7.18%。",
