      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_#fef3c7,_#f8fafc_45%,_#e0f2fe)]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            ...
            <aside className="rounded-[2rem] border border-amber-100 bg-white/90 p-6 shadow-2xl shadow-amber-950/10 backdrop-blur"><p className="text-xs font-black uppercase tracking-[0.18em] text-amber-700">{t.quickActionCard}</p><h2 className="mt-2 text-2xl font-black">{t.tryExample}</h2><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-3xl bg-emerald-600 p-4 text-white"><div className="text-xs font-bold uppercase text-emerald-100">{lang === "zh" ? "需要" : "Needs"}</div><div className="mt-1 text-4xl font-black">{needsDisplay}%</div></div><div className="rounded-3xl bg-amber-500 p-4 text-white"><div className="text-xs font-bold uppercase text-amber-100">{lang === "zh" ? "想要" : "Wants"}</div><div className="mt-1 text-4xl font-black">{fmt(result.wantsPct, 1)}%</div></div><div className="rounded-3xl bg-blue-600 p-4 text-white"><div className="text-xs font-bold uppercase text-blue-100">{lang === "zh" ? "儲蓄" : "Savings"}</div><div className="mt-1 text-4xl font-black">{savingsDisplay}%</div></div></div><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.examplePerson}</div><div className="font-black">{needsDisplay}%</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.flowDemo}</div><div className="font-black">${fmt(Number(monthlyIncome), 0)}</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{lang === "zh" ? "儲蓄" : "Savings"}</div><div className="font-black">{savingsDisplay}%</div></div></div><button onClick={fillBalanced} className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-4 text-sm font-black text-white">{t.fillExample}</button><button onClick={fillHighExpense} className="mt-3 w-full rounded-2xl border border-red-200 bg-red-50 px-5 py-4 text-sm font-black text-red-900">{t.previewActivePath}</button></aside>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">{/* L5-Calc */}
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5"><h3 className="text-lg font-black">{t.exampleCards}</h3><div className="mt-4 space-y-3"><button onClick={fillBalanced} className="w-full rounded-2xl border border-amber-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.baselineExample}</span><span className="rounded-full bg-amber-100 px-3 py-1 text-xs font-black text-amber-700">50/30/20</span></div><p className="mt-2 text-sm text-slate-600">{lang === "zh" ? "月收入 $5,000" : "$5,000/mo income"}</p></button><button onClick={fillHighExpense} className="w-full rounded-2xl border border-red-200 bg-white p-4 text-left"><div className="flex items-center justify-between gap-3"><span className="font-black">{t.activeExample}</span><span className="rounded-full bg-red-100 px-3 py-1 text-xs font-black text-red-700">75%</span></div><p className="mt-2 text-sm text-slate-600">{lang === "zh" ? "每月 $4,000 · 必要支出 $3,000" : "$4,000/mo · Needs $3,000"}</p></button></div></div>
        ...
        <section className="grid gap-7 lg:grid-cols-[0.95fr_1.05fr]">{/* L6-Result */}
          <article className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm"><div className="h-5 bg-gradient-to-r from-emerald-400 via-amber-400 to-blue-500" /><div className="p-6 md:p-7"><p className="text-xs font-black uppercase tracking-[0.2em] text-amber-700">{t.resultCard}</p><div className="mt-4 grid gap-4 md:grid-cols-3"><div className="rounded-2xl bg-emerald-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500">{t.needsPct}</div><div className="mt-1 text-xs font-black uppercase text-emerald-700">{lang === "zh" ? "需要" : "Needs"}</div><p className="mt-2 text-4xl font-black text-emerald-950">{needsDisplay}%</p><p className="text-sm font-bold text-emerald-700">{lang === "zh" ? "理想：50%" : "Ideal: 50%"}</p></div><div className="rounded-2xl bg-amber-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-500">{t.wantsPct}</div><div className="mt-1 text-xs font-black uppercase text-amber-700">{lang === "zh" ? "想要" : "Wants"}</div><p className="mt-2 text-4xl font-black text-amber-950">{fmt(result.wantsPct, 1)}%</p><p className="text-sm font-bold text-amber-700">{lang === "zh" ? "理想：30%" : "Ideal: 30%"}</p></div><div className="rounded-2xl bg-blue-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-500">{t.savingsPct}</div><div className="mt-1 text-xs font-black uppercase text-blue-700">{lang === "zh" ? "儲蓄" : "Savings"}</div><p className="mt-2 text-4xl font-black text-blue-950">{savingsDisplay}%</p><p className="text-sm font-bold text-blue-700">{lang === "zh" ? "理想：20%" : "Ideal: 20%"}</p></div></div><div className="mt-6 grid gap-4 md:grid-cols-3"><div className="rounded-2xl bg-emerald-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500">{t.maintenanceTarget}</div><div className="mt-1 text-xs font-black uppercase text-emerald-700">{t.maintenance}</div><p className="mt-2 text-3xl font-black text-emerald-950">${fmt(Number(savings), 0)}</p><p className="text-sm font-bold text-emerald-700">{lang === "zh" ? "/月" : "/mo"}</p></div><div className="rounded-2xl bg-red-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-red-500">{t.actionTarget}</div><div className="mt-1 text-xs font-black uppercase text-red-700">{t.fatLossTarget}</div><p className="mt-2 text-3xl font-black text-red-950">{needsDisplay}%</p><p className="text-sm font-bold text-red-700">{lang === "zh" ? "占收入" : "of income"}</p></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">{t.estimatedTdee}</div><div className="mt-1 text-xs font-black uppercase text-slate-700">{lang === "zh" ? "收入" : "Income"}</div><p className="mt-2 text-3xl font-black text-slate-950">${fmt(Number(monthlyIncome), 0)}</p><p className="text-sm font-bold text-slate-700">{lang === "zh" ? "/月" : "/mo"}</p></div></div></div></article>
        ...
        <AdSenseWrapper showAds={true} adSlot="budget-ratio-result-intelligence" adFormat="horizontal" className="my-2" />
        <section className="rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-amber-50 p-6 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_0.9fr]">{/* L9-Emotion-Upper */}
            <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm"><p className="text-xs font-black uppercase tracking-[0.16em] text-blue-700">{t.progressInsight}</p><h3 className="mt-2 text-2xl font-black">{t.possibleTarget}</h3><div className="mt-5 grid gap-3 sm:grid-cols-3"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black uppercase text-slate-500">{lang === "zh" ? "需要" : "Needs"}</div><div className="mt-1 text-3xl font-black">{needsDisplay}%</div></div><div className="rounded-2xl bg-red-50 p-4"><div className="text-xs font-black uppercase text-red-600">{t.dailyGap}</div><div className="mt-1 text-3xl font-black text-red-950">{needsDisplay}%</div></div><div className="rounded-2xl bg-emerald-50 p-4"><div className="text-xs font-black uppercase text-emerald-700">{t.weeklyTrend}</div><div className="mt-1 text-3xl font-black text-emerald-950">{savingsDisplay}%</div></div></div></article>
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-7"><p className="text-xs font-black uppercase tracking-[0.2em] text-amber-700">{t.decisionPath}</p><h2 className="mt-2 text-3xl font-black">{t.decisionTitle}</h2><div className="mt-6 grid gap-4 md:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] md:items-center">{[{ label: lang === "zh" ? "預算" : "Budget", note: t.bmrStep }, { label: lang === "zh" ? "淨資產" : "Net Worth", note: t.deficitStep }, { label: lang === "zh" ? "儲蓄" : "Savings", note: t.trendStep }, { label: lang === "zh" ? "負債比" : "DTI", note: t.mealStep }].map((node, index) => <div key={node.label} className="contents"><div className={`rounded-3xl border p-5 text-center ${index === 0 ? "border-amber-300 bg-amber-50" : "border-blue-200 bg-blue-50"}`}><div className="text-xs font-black uppercase text-slate-500">{index + 1}</div><div className="mt-1 text-xl font-black">{node.label}</div><p className="mt-2 text-sm leading-6 text-slate-600">{node.note}</p></div>{index < 3 && <div className="hidden text-3xl font-black text-slate-300 md:block">→</div>}</div>)}</div></section>
