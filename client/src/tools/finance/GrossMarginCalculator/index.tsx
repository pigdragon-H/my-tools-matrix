...
const ui = {
  zh: {
    ...
    intro: "本工具為 毛利計算機，依公開公式於瀏覽器端試算，輸入營收、銷貨成本、退貨折讓、單位數量後立即得出主要結果與三個輔助指標。所有計算均不上傳，僅在你的裝置完成。",
    trustNoteLabel: "注意事項：",
    ...
    q3: "退貨折讓要扣嗎?",
    a3: "建議扣除。退貨折讓會減少實際收到的營收,以「淨營收」計算毛利率更貼近真實獲利能力。本工具讓你輸入退貨折讓,自動算出淨營收與真實毛利率。",
    q4: "怎麼提升毛利率?",
    a4: "兩條路:提高售價(品牌、差異化、組合銷售)或降低銷貨成本(規模採購、製程優化、供應鏈議價)。也可調整產品組合,主推高毛利品項。本工具的單位毛利可協助定價決策。",
    q5: "資料會上傳嗎?",
    a5: "完全不會。所有計算都在你的瀏覽器內以 JavaScript 完成,營收與成本等資料不會傳送到任何伺服器。",
    q6: "可以多產品比較嗎?",
