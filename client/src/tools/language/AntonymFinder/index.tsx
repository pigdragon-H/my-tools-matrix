...
const ui = {
  zh: {
    ...
    intro: "Antonym Finder 串接 Datamuse 開放語料 API（rel_ant），並內建 CEFR-J 權威分級與編輯團隊人工撰寫的繁體中文釋義詞庫。輸入任何英文單字即可取得真實反義詞清單，每個結果都標註 CEFR 難度等級、IPA 音標、詞性與繁體中文釋義，並可展開查看英文定義與例句，幫你在口說、寫作、考試中精準掌握語義的對立面。",
    trustNoteLabel: "資料來源：", trustNote: "反義詞來自 Datamuse（彙整 WordNet）；CEFR 等級以 CEFR-J 與 Octanove 權威詞表對照；繁體中文釋義由編輯團隊人工撰寫，尚未收錄者展開即顯示英文定義；IPA 音標取自 ECDICT 開源詞典與 ARPABET 轉換；例句來自 Free Dictionary API。僅供學習參考。",
    ...
    resultCard: "反義詞結果", unit: "個反義詞", primaryValue: "查詢字", ipaLabel: "音標", meaningLabel: "釋義", enGlossHint: "（此字繁體釋義整理中，展開看英文定義與例句）", expandHint: "展開看例句", collapseHint: "收合", exampleLabel: "例句", enLoading: "載入例句中…", noExample: "查無例句，建議造句練習。",
    resultIntelligence: "結果解讀", levelMatrix: "六級 CEFR 反義詞解讀矩陣", levelMatrixNote: "L7 將反義詞依 CEFR 等級分層，以 CEFR-J 權威詞表對照，A1 最常用、C2 最罕見；挑對立詞時對照你的目標讀者程度。",
    ...
    saveShareJourney: "儲存 / 分享", journeyTitle: "把今天學到的反義詞帶回家", journeyHint: "挑 2–3 組你會真正用到的反義詞造對比句，比死背 20 個更有效。",
    nextActionLabel: "下一步行動", nextActionTitle: "把反義詞接到下一個工具", nextActionItem1: "用同義詞查找器補齊近義詞，把語義光譜兩端都掌握", nextActionItem2: "用 CEFR 等級估算確認難度是否符合你的程度", nextActionItem3: "用字根分析器理解詞義從何而來，記得更牢",
  ...
  en: {
    ...
    resultCard: "Antonym Results", unit: "antonyms", primaryValue: "Query word", ipaLabel: "IPA", meaningLabel: "Gloss", enGlossHint: "(Traditional Chinese gloss coming soon — expand for the English definition & example.)", expandHint: "Show example", collapseHint: "Collapse", exampleLabel: "Example", enLoading: "Loading example…", noExample: "No example found; try writing your own.",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section aria-label="L14 FAQ after ad slot: AD 廣告位 · Advertisement" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="antonym-faq" position="inline" /></section>
