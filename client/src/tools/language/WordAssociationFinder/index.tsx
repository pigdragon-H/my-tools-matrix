// @profile B
// Profile B · Language-Hub A-class (Datamuse rel_trg) · WordAssociationFinder（GOLD-STANDARD MacroCalculator compatible）
// 詞語聯想查找器：1) 聯想基於「語意主題」相關性(rel_trg)  2) 三層中文釋義(繁體優先→ECDICT簡體標「簡」→英文定義標EN)  3) CEFR 分層改用權威詞表
...
const HOT_WORDS = ["ocean", "music", "winter", "coffee", "travel", "science"] as const;

const cefrBands = [
  { key: "A1", label: { zh: "A1 入門", en: "A1 Beginner" }, desc: { zh: "最常用的基礎聯想詞，寫作與口語首選。", en: "Most frequent basics; best for writing and speech." } },
  { key: "A2", label: { zh: "A2 基礎", en: "A2 Elementary" }, desc: { zh: "常見的主題相關詞，足以應付日常表達。", en: "Common topical words for everyday expression." } },
  { key: "B1", label: { zh: "B1 中級", en: "B1 Intermediate" }, desc: { zh: "讓段落與作文更有層次的中階聯想詞。", en: "Mid-level associations that add range to writing." } },
  { key: "B2", label: { zh: "B2 中高", en: "B2 Upper-Inter" }, desc: { zh: "正式寫作與報告常見的進階聯想詞。", en: "Advanced associations common in formal writing." } },
  { key: "C1", label: { zh: "C1 高級", en: "C1 Advanced" }, desc: { zh: "精準、學術感強的高階聯想詞。", en: "Precise, academic high-level associations." } },
...
const ui = {
  zh: {
    badge: "語言 · 詞語聯想 · Language Hub", switchToEnglish: "Switch to English", switchToChinese: "切換到中文", chineseShort: "中", englishShort: "EN",
    title: "詞語聯想查找器 · Word Association Finder", subtitle: "輸入一個英文字，立刻找出語意相關、帶 CEFR 等級、IPA 音標與中文釋義的聯想詞",
    intro: "Word Association Finder 串接 Datamuse 開放語料 API（rel_trg），以「語意主題」為核心找出與您輸入單字常一起出現、語意相關的聯想詞。聯想看的是「語意關聯」而非拼字或發音，所以每個結果都標註 CEFR 難度等級、詞性與中文釋義，並附 IPA 音標，可展開查看英文定義與例句，幫您在腦力激盪、寫作擴詞、主題詞彙建構與聯想記憶中快速擴充相關詞。",
    trustNoteLabel: "資料來源：", trustNote: "聯想詞來自 Datamuse（以語料庫統計找出語意主題相關詞 rel_trg）；CEFR 等級以 CEFR-J 與 Octanove 權威詞表對照；中文釋義以編輯團隊人工撰寫的繁體中文為優先，尚無繁體者改顯示 ECDICT 開源詞典的簡體釋義（標註「簡」），繁簡皆無者展開即顯示英文定義；IPA 音標取自 ECDICT 與 ARPABET 轉換；例句來自 Free Dictionary API。僅供學習參考。",
    quickActionCard: "快速查詢卡", tryExample: "一鍵查 ocean 的聯想詞", examplePreview: "找到的聯想詞數", examplePerson: "查詢字", fillExample: "查 ocean 的聯想詞", previewActivePath: "查 music 的聯想詞",
    examplesCalculator: "範例 → 查詢", enterValues: "輸入英文單字", examplesHelper: "先用熱門範例了解 CEFR 等級、IPA 音標與中文釋義如何呈現，再換成您自己想聯想的單字。",
    queryBtn: "查詢聯想詞", clearBtn: "清除", hotWords: "熱門查詢", inputPlaceholder: "輸入英文單字，例如 ocean",
    loading: "查詢中…", emptyHint: "輸入上方單字並按「查詢聯想詞」，結果會列在這裡。", noResult: "查無聯想詞，換個更常見的單字試試。",
    fallbackTitle: "查詢暫時無法使用", fallbackBody: "網路連線問題，請稍後再試。常用結果已儲存在本機快取中。",
    resultCard: "聯想詞結果", unit: "個聯想詞", primaryValue: "查詢字", ipaLabel: "音標", meaningLabel: "釋義", glossTagCn: "簡", glossTagEn: "EN", enGlossHint: "展開看英文定義與例句", expandHint: "展開看例句", collapseHint: "收合", exampleLabel: "例句", enLoading: "載入例句中…", noExample: "查無例句，建議造句練習。",
    resultIntelligence: "結果解讀", levelMatrix: "六級 CEFR 聯想詞解讀矩陣", levelMatrixNote: "L7 將聯想詞依 CEFR 等級分層，以 CEFR-J 權威詞表對照，A1 最常用、C2 最罕見；擴詞時對照您的目標讀者程度。",
    scenarioLayer: "使用場景", scenarioTitle: "什麼時候用詞語聯想", scenarioNote: "L8 列出四個典型場景，把聯想詞用在對的地方，而不是隨意堆詞。",
    scenarioExam: "腦力激盪", scenarioExamNote: "為主題或文章發想方向時，用聯想詞快速展開相關概念與切入點。", scenarioWriting: "寫作擴詞", scenarioWritingNote: "依語意與 CEFR 適中挑聯想詞，讓段落用詞更豐富不重複。", scenarioDaily: "主題詞彙", scenarioDailyNote: "建構某個主題的字彙網，選 A1/A2 聯想詞先打底，自然好記。", scenarioBusiness: "命名發想", scenarioBusinessNote: "幫品牌、活動、角色取名，用聯想詞找出語意相關又有記憶點的詞。",
    progressInsight: "學習洞察卡", possibleTarget: "本次查詢", dailyGap: "最常用等級", weeklyTrend: "已分級比例", motivation: "動力卡", keepMomentum: "從查聯想詞走向主動擴充主題字彙",
    saveShareJourney: "儲存 / 分享", journeyTitle: "把今天找到的聯想詞帶回家", journeyHint: "挑 2–3 個您真正會用到的聯想詞查釋義並造句，比死背 20 個更有效。",
    nextActionLabel: "下一步行動", nextActionTitle: "把聯想詞接到下一個工具", nextActionItem1: "用同義詞查找器替換聯想出的字，理解語意光譜", nextActionItem2: "用 CEFR 等級估算確認聯想詞難度是否符合您的程度", nextActionItem3: "用字根分析器理解聯想詞的語義從何而來，記得更牢",
    shareLinkBtn: "📋 複製結果連結", shareNativeBtn: "📤 分享給朋友", shareCopiedToast: "已複製到剪貼簿 ✓",
    decisionPath: "聯想路徑", decisionTitle: "輸入 → 查詢 → 擴詞 → 應用", step1: "輸入單字", step2: "查聯想詞", step3: "看 CEFR", step4: "用在寫作",
    knowledge: "知識", knowledgeTitle: "詞語聯想在英語學習中的意義", definition: "定義", definitionText: "詞語聯想（word association）是與某個字在語意主題上常一起出現、相關的字；聯想看的是「語意關聯」而非拼字或發音，因此判斷是否相關要看主題語境，而非同義或押韻。", usage: "用法", usageText: "輸入一個單字後，演算法會以語料庫統計找出常與它一起出現的主題相關詞（例如 ocean 會聯想到 wave、tide、marine），再依 CEFR 等級與詞性整理，幫您擴充某主題的字彙網。", limitations: "限制", limitationsText: "Datamuse 的聯想依語料統計，可能含罕見或專業詞；語意關聯偶有鬆散；CEFR 等級以 CEFR-J/Octanove 詞表為主，未收錄者改用詞頻啟發式推估。", interpretation: "解讀", interpretationText: "A1/A2 聯想詞適合基礎主題與口語；B1/B2 適合一般寫作與報告；C1/C2 雖然精準，用錯場合反而生硬難懂。", context: "脈絡", contextText: "聯想查詢應與同義詞、字根、CEFR 估算一起用：先用聯想擴出主題相關詞，再用同義詞挑最貼意的字，兼顧廣度與精準。", example: "範例", exampleText: "查 music → 得到 melody(B1)、rhythm(B2)、orchestra(B2)、jazz(B1)；寫作時 music 聯想出 rhythm 與 melody，能讓主題段落用詞更立體。",
    faq: "FAQ", commonQuestions: "常見問題", affiliate: "相關工具", affiliateTitle: "詞語聯想的下一步工具", premiumTitle: "PRO 詞彙擴充包", premiumText: "解鎖無限查詢、依 CEFR 等級篩選聯想詞、依詞性過濾、自動記錄查詢歷史，並把聯想字表匯出複習。",
    feat1: "無限查詢次數", feat2: "難度等級篩選", feat3: "查詢歷史記錄", feat4: "聯想字表匯出",
    trustReferences: "信任聲明 · 相關工具 · 參考資料", trust: "信任聲明", trustText: "本工具僅供英語學習與詞彙擴充用途；CEFR 等級以 CEFR-J/Octanove 權威詞表對照，詞表未收錄者為啟發式推估，不等同官方語言檢定結果。", relatedTools: "相關工具", relatedToolsText: "Synonym Finder · Antonym Finder · Word Root Analyzer · CEFR Level Estimator", references: "參考資料", referencesText: "Datamuse API（rel_trg，語料庫統計語意主題相關詞）；CEFR-J Wordlist v1.5（Tono Lab, TUFS）；Octanove C1/C2 Vocabulary Profile（CC BY-SA 4.0）；ECDICT 開源英漢詞典（IPA 音標與簡體釋義）；繁體中文釋義由編輯團隊人工撰寫；Free Dictionary API（例句）。",
    q1: "詞語聯想和同義詞有什麼不同？", a1: "同義詞是意思相近、可互換的字；聯想詞是語意主題相關、常一起出現的字（例如 doctor 的聯想詞有 hospital、nurse、patient，但它們不是同義詞）。聯想擴的是主題廣度，同義換的是精準度。",
    q2: "CEFR 等級是怎麼判斷的？", a2: "優先以 CEFR-J 與 Octanove 權威詞表對照；詞表未收錄的罕見字才改用 Datamuse 詞頻啟發式推估。這是學習參考，非官方檢定。",
    q3: "為什麼有些字查不到聯想詞？", a3: "罕見字、專有名詞或拼錯的字可能沒有聯想資料；某些字語料中關聯太鬆散也可能列不出來。換成更常見的字通常就有結果。",
    ...
    q6: "適合腦力激盪和主題寫作嗎？", a6: "適合。先用聯想詞展開主題相關概念，再依 CEFR 等級與詞性挑選；主題寫作前先聯想擴詞，能讓段落用詞更豐富不單調。",
  },
  en: {
    badge: "Language · Association · Language Hub", switchToEnglish: "Switch to English", switchToChinese: "切換到中文", chineseShort: "中", englishShort: "EN",
    title: "Word Association Finder", subtitle: "Type one English word and get topically related associations with CEFR level, IPA, and Chinese gloss",
    intro: "Word Association Finder calls the open Datamuse corpus API (rel_trg) and finds words that are topically related to your input based on meaning. Association is about semantic relatedness, not spelling or sound, so each result is tagged with a CEFR difficulty level, part of speech, and Chinese gloss, with an IPA transcription, expandable to show an English definition and example sentence, helping you quickly expand related words for brainstorming, vocabulary building, topical word webs, and associative memory.",
    trustNoteLabel: "Data source:", trustNote: "Associations come from Datamuse (topically related words found via corpus statistics, rel_trg); CEFR levels are matched against the CEFR-J and Octanove authoritative wordlists; Chinese glosses prioritize the editorial team's hand-written Traditional Chinese, falling back to ECDICT's Simplified gloss (tagged Simp) when no Traditional one exists, and to an English definition when neither is available; IPA comes from ECDICT and ARPABET conversion; examples come from the Free Dictionary API. For study reference only.",
    quickActionCard: "Quick Query Card", tryExample: "Find associations for ocean", examplePreview: "Associations found", examplePerson: "Query word", fillExample: "Find associations for ocean", previewActivePath: "Find associations for music",
    examplesCalculator: "Examples → Query", enterValues: "Enter an English word", examplesHelper: "Start with a popular example to see how CEFR level, IPA, and Chinese gloss appear, then swap in the word you want to associate.",
    queryBtn: "Find associations", clearBtn: "Clear", hotWords: "Popular queries", inputPlaceholder: "Type an English word, e.g. ocean",
    loading: "Searching…", emptyHint: "Enter a word above and press Find associations; results will appear here.", noResult: "No associations found, try a more common word.",
    ...
    resultCard: "Association Results", unit: "associations", primaryValue: "Query word", ipaLabel: "IPA", meaningLabel: "Gloss", glossTagCn: "Simp", glossTagEn: "EN", enGlossHint: "See English definition & example on expand", expandHint: "Show example", collapseHint: "Collapse", exampleLabel: "Example", enLoading: "Loading example…", noExample: "No example found; try writing your own.",
    resultIntelligence: "Result Intelligence", levelMatrix: "Six-level CEFR association matrix", levelMatrixNote: "L7 groups associations by CEFR level using the authoritative CEFR-J wordlist, with A1 most common and C2 rarest; match the level to your target reader when expanding vocabulary.",
    scenarioLayer: "Use scenarios", scenarioTitle: "When to use word association", scenarioNote: "L8 lists four typical scenarios so you use associations in the right place, not just piling up words.",
    scenarioExam: "Brainstorming", scenarioExamNote: "When developing a topic or article, use associations to quickly open up related concepts and angles.", scenarioWriting: "Vocabulary expansion", scenarioWritingNote: "Pick associations that fit the meaning at a moderate CEFR level so paragraphs use richer, less repetitive words.", scenarioDaily: "Topical vocabulary", scenarioDailyNote: "Build a word web for a topic, starting with A1/A2 associations as a natural, memorable base.", scenarioBusiness: "Naming ideas", scenarioBusinessNote: "Name brands, events, or characters by finding related, memorable words via association.",
    progressInsight: "Learning Insight Card", possibleTarget: "This query", dailyGap: "Most common level", weeklyTrend: "Graded ratio", motivation: "Motivation Card", keepMomentum: "Move from looking up associations to actively building topical vocabulary",
    saveShareJourney: "Save / Share", journeyTitle: "Take today's associations home", journeyHint: "Look up and use 2–3 associations you will actually use in sentences; it beats memorizing 20 at once.",
    nextActionLabel: "Next actions", nextActionTitle: "Connect associations to the next tool", nextActionItem1: "Use Synonym Finder to swap an associated word and understand the meaning spectrum", nextActionItem2: "Use CEFR Level Estimator to confirm the association difficulty fits your level", nextActionItem3: "Use Word Root Analyzer to see where the associated word's meaning comes from and remember it better",
    shareLinkBtn: "📋 Copy result link", shareNativeBtn: "📤 Share with friends", shareCopiedToast: "Copied to clipboard ✓",
    decisionPath: "Association Path", decisionTitle: "Input → Query → Expand → Apply", step1: "Type a word", step2: "Find associations", step3: "Check CEFR", step4: "Use in writing",
    knowledge: "Knowledge", knowledgeTitle: "What word association means in English learning", definition: "Definition", definitionText: "A word association is a word that is topically related to and often co-occurs with another; association is about semantic relatedness, not spelling or sound, so relatedness depends on topical context rather than synonymy or rhyme.", usage: "Usage", usageText: "After entering a word, the algorithm uses corpus statistics to find topically related words that co-occur with it (e.g. ocean associates with wave, tide, marine), then organizes them by CEFR level and part of speech to expand a topic's word web.", limitations: "Limitations", limitationsText: "Datamuse associations are based on corpus statistics and may include rare or technical words; semantic relatedness is occasionally loose; CEFR levels primarily use the CEFR-J/Octanove wordlists, falling back to a frequency heuristic for unlisted words.", interpretation: "Interpretation", interpretationText: "A1/A2 associations suit basic topics and speech; B1/B2 suit general writing and reports; C1/C2 look precise but feel stiff if used in the wrong place.", context: "Context", contextText: "Association lookup should be used with synonyms, word roots, and CEFR estimation: expand topical words with associations first, then pick the most fitting word with synonyms, balancing breadth and precision.", example: "Example", exampleText: "Search music → get melody(B1), rhythm(B2), orchestra(B2), jazz(B1); in writing, associating music with rhythm and melody makes the topic paragraph more three-dimensional.",
    faq: "FAQ", commonQuestions: "Common questions", affiliate: "Related Tools", affiliateTitle: "Next tools for word association", premiumTitle: "PRO Vocabulary Pack", premiumText: "Unlock unlimited queries, filter associations by CEFR level, filter by part of speech, auto-log query history, and export association lists for review.",
    feat1: "Unlimited queries", feat2: "Level filter", feat3: "Query history", feat4: "Export list",
    trustReferences: "Trust · Related Tools · References", trust: "Trust", trustText: "This tool is for English learning and vocabulary expansion only; CEFR levels are matched against the CEFR-J/Octanove wordlists, with a heuristic estimate for unlisted words, and do not equal an official language assessment.", relatedTools: "Related Tools", relatedToolsText: "Synonym Finder · Antonym Finder · Word Root Analyzer · CEFR Level Estimator", references: "References", referencesText: "Datamuse API (rel_trg, topically related words via corpus statistics); CEFR-J Wordlist v1.5 (Tono Lab, TUFS); Octanove C1/C2 Vocabulary Profile (CC BY-SA 4.0); ECDICT open EN-ZH dictionary (IPA and Simplified glosses); Traditional Chinese glosses hand-written by the editorial team; Free Dictionary API (examples).",
    q1: "How is word association different from a synonym?", a1: "Synonyms are interchangeable words with similar meaning; associations are topically related words that co-occur (e.g. doctor associates with hospital, nurse, patient, but they are not synonyms). Association expands topical breadth; synonyms swap for precision.",
    ...
    q3: "Why do some words return no associations?", a3: "Rare words, proper nouns, or misspellings may have no association data; some words have associations too loose in the corpus to list. Switching to a more common word usually returns results.",
    ...
    q6: "Is it good for brainstorming and topical writing?", a6: "Yes. Open up related concepts with associations first, then pick by CEFR level and part of speech; associating to expand vocabulary before topical writing makes paragraphs richer and less monotonous.",
  },
} as const;
...
export default function WordAssociationFinder() {
  const { lang, setLang } = useLanguage();
  const t = ui[lang];
  const [input, setInput] = useState("ocean");
  ...
  const runQuery = useCallback(async (rawWord: string) => {
    ...
    setExpanded(null);
    await loadDict();
    const data = await queryDatamuse(`rel_trg=${encodeURIComponent(word)}`, 24);
  ...
  function fillStandard() { setInput("ocean"); runQuery("ocean"); }
  function fillCut() { setInput("music"); runQuery("music"); }
      ...
      */}
      ...
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section className="grid gap-7 lg:grid-cols-[0.95fr_1.05fr]">{/* L6-Result */}
          <article className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm"><div className="h-5 bg-gradient-to-r from-emerald-400 to-blue-600" /><div className="p-6 md:p-7"><p className="text-xs font-black uppercase tracking-[0.2em] text-emerald-700">{t.resultCard}</p><div className="mt-4 flex items-start justify-between gap-5"><div><div className="text-7xl font-black tracking-tight text-slate-950">{countDisplay}</div><div className="mt-2 rounded-full bg-slate-100 px-4 py-2 text-sm font-black text-slate-700">{t.unit}</div></div><div className="rounded-3xl bg-slate-950 p-4 text-right text-white"><div className="text-xs font-bold uppercase text-slate-300">{t.primaryValue}</div><div className="mt-1 text-xl font-black">{queryWord || "—"}</div><div className="mt-1 text-xs text-slate-300">rel_trg</div></div></div>
        ...
        <AdSenseWrapper showAds={true} adSlot="word-association-result-intelligence" adFormat="horizontal" className="my-2" />
        ...
        <section aria-label="L14 FAQ after ad slot: AD 廣告位 · Advertisement" className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm md:p-5"><AdSlot slot="word-association-faq" position="inline" /></section>
