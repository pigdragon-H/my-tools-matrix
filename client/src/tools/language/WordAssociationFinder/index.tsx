...
const ui = {
  zh: {
    ...
    intro: "Word Association Finder 串接 Datamuse 開放語料 API（rel_trg），以「語意主題」為核心找出與你輸入單字常一起出現、語意相關的聯想詞。聯想看的是「語意關聯」而非拼字或發音，所以每個結果都標註 CEFR 難度等級、詞性與中文釋義，並附 IPA 音標，可展開查看英文定義與例句，幫你在腦力激盪、寫作擴詞、主題詞彙建構與聯想記憶中快速擴充相關詞。",
    ...
    examplesCalculator: "範例 → 查詢", enterValues: "輸入英文單字", examplesHelper: "先用熱門範例了解 CEFR 等級、IPA 音標與中文釋義如何呈現，再換成你自己想聯想的單字。",
    ...
    resultIntelligence: "結果解讀", levelMatrix: "六級 CEFR 聯想詞解讀矩陣", levelMatrixNote: "L7 將聯想詞依 CEFR 等級分層，以 CEFR-J 權威詞表對照，A1 最常用、C2 最罕見；擴詞時對照你的目標讀者程度。",
