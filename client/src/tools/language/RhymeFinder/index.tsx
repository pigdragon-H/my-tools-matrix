...
const ui = {
  zh: {
    ...
    intro: "Rhyme Finder 串接 Datamuse 開放語料 API（rel_rhy），以發音為核心找出與你輸入單字押韻的字。押韻看的是「韻腳的聲音」而非語意，所以每個結果都以 IPA 音標凸顯韻腳，並標註 CEFR 難度等級、詞性與中文釋義，可展開查看英文定義與例句，幫你在寫詩、寫歌詞、押韻創作與口語節奏練習中快速挑出順耳又貼切的韻腳。",
    ...
    examplesCalculator: "範例 → 查詢", enterValues: "輸入英文單字", examplesHelper: "先用熱門範例了解 CEFR 等級、IPA 音標與中文釋義如何呈現，再換成你自己想押韻的單字。",
    ...
    resultIntelligence: "結果解讀", levelMatrix: "六級 CEFR 押韻詞解讀矩陣", levelMatrixNote: "L7 將押韻詞依 CEFR 等級分層，以 CEFR-J 權威詞表對照，A1 最常用、C2 最罕見；挑韻腳時對照你的目標讀者程度。",
    ...
    saveShareJourney: "儲存 / 分享", journeyTitle: "把今天找到的韻腳帶回家", journeyHint: "挑 2–3 個你真正會用到的押韻字寫成兩句押韻句，比死背 20 個更有效。",
    nextActionLabel: "下一步行動", nextActionTitle: "把押韻詞接到下一個工具", nextActionItem1: "用同義詞查找器替換同韻但更貼意的字，兼顧聲音與語意", nextActionItem2: "用 CEFR 等級估算確認韻腳難度是否符合你的程度", nextActionItem3: "用字根分析器理解韻腳字的語義從何而來，記得更牢",
