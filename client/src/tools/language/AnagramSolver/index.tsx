...
const ui = {
  zh: {
    ...
    intro: "Anagram Solver 採用自建的「字母指紋」演算法，把您輸入的字母排序成一組指紋，再比對內建 22,499 字的詞庫，瞬間找出所有同字母異序的英文單字。每個結果都標註 CEFR 難度等級、IPA 音標、詞性與中文釋義，並可展開查看英文定義與例句，幫您在玩拼字遊戲、解字謎、Scrabble 與創意命名時快速找出所有重組答案。本工具為純前端演算法，不依賴外部 API 取結果，速度快、離線可用。",
