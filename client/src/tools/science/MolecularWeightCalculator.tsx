...
export default function MolecularWeightCalculator() {
  ...
  const copyResult = async () => {
    if (!result) return;
    const text = `Molecular Weight Calculator
  ...
  return (
    <main className="container mx-auto max-w-4xl px-4 py-8">
      <section className="rounded-2xl border bg-card p-6 shadow-sm">
        <p className="text-sm font-medium uppercase tracking-wide text-muted-foreground">science tool</p>
        <h1 className="mt-2 text-3xl font-bold">Molecular Weight Calculator</h1>
