...
const toolComponentMap: Record<string, React.LazyExoticComponent<() => React.ReactElement>> = {
  ...
  "fin/cagr-calculator": lazy(() => import("@/tools/fin/CagrCalculator")),
  "fin/compound-interest-calculator": lazy(() => import("@/tools/fin/CompoundInterestCalculator")),
  "fin/dividend-yield-calculator": lazy(() => import("@/tools/fin/DividendYieldCalculator")),
  "fin/stock-return-calculator": lazy(() => import("@/tools/fin/StockReturnCalculator")),
  "fin/dollar-cost-averaging-calculator": lazy(() => import("@/tools/fin/DollarCostAveragingCalculator")),
  "fin/fire-calculator": lazy(() => import("@/tools/fin/FireCalculator")),
  "fin/retirement-savings-calculator": lazy(() => import("@/tools/fin/RetirementSavingsCalculator")),
  "fin/withdrawal-rate-calculator": lazy(() => import("@/tools/fin/WithdrawalRateCalculator")),
  "fin/coast-fire-calculator": lazy(() => import("@/tools/fin/CoastFireCalculator")),
  "fin/pension-calculator": lazy(() => import("@/tools/fin/PensionCalculator")),
  "fin/loan-calculator": lazy(() => import("@/tools/fin/LoanCalculator")),
  "fin/personal-loan-calculator": lazy(() => import("@/tools/fin/PersonalLoanCalculator")),
  "fin/emi-calculator": lazy(() => import("@/tools/fin/EmiCalculator")),
  "fin/debt-payoff-calculator": lazy(() => import("@/tools/fin/DebtPayoffCalculator")),
  "fin/interest-rate-calculator": lazy(() => import("@/tools/fin/InterestRateCalculator")),
  "fin/mortgage-calculator": lazy(() => import("@/tools/fin/MortgageCalculator")),
  "fin/mortgage-amortization-calculator": lazy(() => import("@/tools/fin/MortgageAmortizationCalculator")),
  "fin/refinance-calculator": lazy(() => import("@/tools/fin/RefinanceCalculator")),
  "fin/down-payment-calculator": lazy(() => import("@/tools/fin/DownPaymentCalculator")),
  "fin/affordability-calculator": lazy(() => import("@/tools/fin/AffordabilityCalculator")),
  "fin/pip-value-calculator": lazy(() => import("@/tools/fin/PipValueCalculator")),
  "fin/forex-profit-calculator": lazy(() => import("@/tools/fin/ForexProfitCalculator")),
  "fin/currency-converter-pro": lazy(() => import("@/tools/fin/CurrencyConverterPro")),
  "fin/exchange-rate-calculator": lazy(() => import("@/tools/fin/ExchangeRateCalculator")),
  "fin/cross-rate-calculator": lazy(() => import("@/tools/fin/CrossRateCalculator")),
