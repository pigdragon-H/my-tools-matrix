...
const toolComponentMap: Record<string, React.LazyExoticComponent<() => React.ReactElement>> = {
  ...
  "finance/break-even-calculator": lazy(() => import("@/tools/fin/BreakEvenCalculator")),
  "finance/budget-planner": lazy(() => import("@/tools/fin/BudgetPlanner")),
  "finance/capital-gains-tax-calculator": lazy(() => import("@/tools/fin/CapitalGainsTaxCalculator")),
  "finance/compound-interest-advanced": lazy(() => import("@/tools/fin/CompoundInterestAdvanced")),
  "finance/compound-interest-pro-calculator": lazy(() => import("@/tools/fin/CompoundInterestProCalculator")),
  "finance/corporate-tax-calculator": lazy(() => import("@/tools/fin/CorporateTaxCalculator")),
  "finance/credit-score-calculator": lazy(() => import("@/tools/fin/CreditScoreCalculator")),
  "finance/debt-payoff-pro-calculator": lazy(() => import("@/tools/fin/DebtPayoffProCalculator")),
  "finance/dividend-yield-pro-calculator": lazy(() => import("@/tools/fin/DividendYieldProCalculator")),
  "finance/emergency-fund-calculator": lazy(() => import("@/tools/fin/EmergencyFundCalculator")),
  "finance/estate-tax-calculator": lazy(() => import("@/tools/fin/EstateTaxCalculator")),
  "finance/gift-tax-calculator": lazy(() => import("@/tools/fin/GiftTaxCalculator")),
  "finance/gold-price-calculator": lazy(() => import("@/tools/fin/GoldPriceCalculator")),
  "finance/home-affordability-calculator": lazy(() => import("@/tools/fin/HomeAffordabilityCalculator")),
  "finance/home-equity-calculator": lazy(() => import("@/tools/fin/HomeEquityCalculator")),
  "finance/land-value-calculator": lazy(() => import("@/tools/fin/LandValueCalculator")),
  "finance/loan-pro-calculator": lazy(() => import("@/tools/fin/LoanProCalculator")),
  "finance/moving-cost-calculator": lazy(() => import("@/tools/fin/MovingCostCalculator")),
  "finance/net-worth-calculator": lazy(() => import("@/tools/fin/NetWorthCalculator")),
  "finance/pe-ratio-calculator": lazy(() => import("@/tools/fin/PeRatioCalculator")),
  "finance/profit-margin-calculator": lazy(() => import("@/tools/fin/ProfitMarginCalculator")),
  "finance/property-roi-calculator": lazy(() => import("@/tools/fin/PropertyRoiCalculator")),
  "finance/property-tax-calculator": lazy(() => import("@/tools/fin/PropertyTaxCalculator")),
  "finance/rental-yield-calculator": lazy(() => import("@/tools/fin/RentalYieldCalculator")),
  "finance/salary-after-tax-calculator": lazy(() => import("@/tools/fin/SalaryAfterTaxCalculator")),
  "finance/savings-goal-calculator": lazy(() => import("@/tools/fin/SavingsGoalCalculator")),
  "finance/stamp-duty-calculator": lazy(() => import("@/tools/fin/StampDutyCalculator")),
  "finance/stock-profit-loss-calculator": lazy(() => import("@/tools/fin/StockProfitLossCalculator")),
  "finance/tax-refund-calculator": lazy(() => import("@/tools/fin/TaxRefundCalculator")),
  "finance/tip-calculator": lazy(() => import("@/tools/fin/TipCalculator")),
  "finance/vat-calculator": lazy(() => import("@/tools/fin/VatCalculator")),
  "finance/withholding-tax-calculator": lazy(() => import("@/tools/fin/WithholdingTaxCalculator")),
  "health/age-calculator": lazy(() => import("@/tools/hlt/AgeCalculator")),
  "health/alcohol-calculator": lazy(() => import("@/tools/hlt/AlcoholCalculator")),
  "health/blood-pressure-calculator": lazy(() => import("@/tools/hlt/BloodPressureCalculator")),
  "health/body-fat-calculator": lazy(() => import("@/tools/hlt/BodyFatCalculator")),
  "health/due-date-calculator": lazy(() => import("@/tools/hlt/DueDateCalculator")),
  "health/heart-rate-calculator": lazy(() => import("@/tools/hlt/HeartRateCalculator")),
  "health/ideal-weight-calculator": lazy(() => import("@/tools/hlt/IdealWeightCalculator")),
  "health/pregnancy-calculator": lazy(() => import("@/tools/hlt/PregnancyCalculator")),
  "health/vitamin-calculator": lazy(() => import("@/tools/hlt/VitaminCalculator")),
