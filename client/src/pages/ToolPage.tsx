...
// 工具組件映射（懶加載）
const toolCategoryLoaderMap: Record<string, React.LazyExoticComponent<({ toolKey }: { toolKey: string }) => React.ReactElement | null>> = {
  "ai": lazy(() => import("@/pages/toolLoaders/AiToolLoader")),
  "design": lazy(() => import("@/pages/toolLoaders/DesignToolLoader")),
  "developer": lazy(() => import("@/pages/toolLoaders/DeveloperToolLoader")),
  "ecommerce": lazy(() => import("@/pages/toolLoaders/EcommerceToolLoader")),
  "education": lazy(() => import("@/pages/toolLoaders/EducationToolLoader")),
  "finance": lazy(() => import("@/pages/toolLoaders/FinanceToolLoader")),
  "health": lazy(() => import("@/pages/toolLoaders/HealthToolLoader")),
  "language": lazy(() => import("@/pages/toolLoaders/LanguageToolLoader")),
  "legal": lazy(() => import("@/pages/toolLoaders/LegalToolLoader")),
  "productivity": lazy(() => import("@/pages/toolLoaders/ProductivityToolLoader")),
  "science": lazy(() => import("@/pages/toolLoaders/ScienceToolLoader")),
  "travel": lazy(() => import("@/pages/toolLoaders/TravelToolLoader")),
};

/**
 * Registry-only route markers for Gate 1 / trunk QC.
 * These lines intentionally remain in ToolPage.tsx so existing registry
 * regex audits can verify every public tool route without forcing this
 * page to execute a 341-entry runtime import map. Do not remove unless
 * the registry gates are updated in the same change.
 *
...
export default function ToolPage() {
  ...
  const ToolCategoryLoader = toolCategoryLoaderMap[category ?? ""];
  ...
  if (!ToolCategoryLoader || !toolConfig) {
    return (
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <Suspense fallback={<ToolSkeleton />}>
        <ToolCategoryLoader toolKey={toolKey} />
      </Suspense>
    </div>
  );
}
