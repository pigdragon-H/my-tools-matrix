...
const toolComponentMap: Record<string, React.LazyExoticComponent<() => React.ReactElement>> = {
  ...
  "dev/aspect-ratio-calculator": lazy(() => import("@/tools/dev/AspectRatioCalculator")),
  "dev/http-status-checker": lazy(() => import("@/tools/dev/HttpStatusChecker")),
  "dev/color-palette-generator": lazy(() => import("@/tools/dev/ColorPaletteGenerator")),
  "dev/meta-tags-generator": lazy(() => import("@/tools/dev/MetaTagsGenerator")),
  "dev/font-size-converter": lazy(() => import("@/tools/dev/FontSizeConverter")),
  "dev/json-schema-validator": lazy(() => import("@/tools/dev/JsonSchemaValidator")),
  "dev/cron-explainer": lazy(() => import("@/tools/dev/CronExplainer")),
  "dev/color-contrast-checker": lazy(() => import("@/tools/dev/ColorContrastChecker")),
  "dev/escape-unescape": lazy(() => import("@/tools/dev/EscapeUnescape")),
  "dev/markdown-table-generator": lazy(() => import("@/tools/dev/MarkdownTableGenerator")),
