...
def build_layers(profile: str) -> list[tuple[str, str, list[str]]]:
    ...
    return [
        ...
        ("L10", "Emotion+Conversion 下排 · Journey + Next Actions",
            ["nextActionLabel", "nextActionTitle", "nextActionsTitle", "nextActionsLabel",
             "shareLinkBtn", "shareResultBtn", "shareNativeBtn", "shareResultNative",
             "journeyTitle", "下一步行動", "Next actions"]),
