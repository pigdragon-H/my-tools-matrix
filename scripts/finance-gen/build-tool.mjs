      ...
      <section className="bg-[radial-gradient(circle_at_top_left,_${C.hueA},_${C.hueB}_45%,_${C.hueC})]">
        <div className="mx-auto max-w-7xl px-4 py-10 md:px-8 md:py-14">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">{/* L1-Hero */}
            ...
            <aside className="rounded-[2rem] border border-${C.primary}-100 bg-white/90 p-6 shadow-2xl shadow-${C.primary}-950/10 backdrop-blur"><p className="text-xs font-black uppercase tracking-[0.18em] text-${C.primary}-700">{t.quickActionCard}</p><h2 className="mt-2 text-2xl font-black">{t.tryExample}</h2><div className="mt-5 rounded-3xl bg-${C.primary}-600 p-5 text-white"><div className="text-xs font-bold uppercase text-${C.primary}-100">{t.examplePreview}</div><div className="mt-1 text-5xl font-black">${PKPrefix}{primaryDisplay}${PKSuffix}<span>{t.primaryUnitTail}</span></div><div className="text-sm font-bold text-${C.primary}-100">{t.headlineCaption}</div></div><div className="mt-5 grid grid-cols-3 gap-3 text-center"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.examplePerson}</div><div className="font-black">${PKPrefix}{primaryDisplay}${PKSuffix}<span>{t.primaryUnitTail}</span></div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.flowDemo}</div><div className="font-black">{${inp[0].name}} × {${inp[1].name}}</div></div><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.fatLossTarget}</div><div className="font-black">{secondaryDisplay}</div></div></div><button onClick={fillSolid} className="mt-5 w-full rounded-2xl bg-slate-950 px-5 py-4 text-sm font-black text-white">{t.fillExample}</button><button onClick={fillHighSalary} className="mt-3 w-full rounded-2xl border border-${C.primary}-200 bg-${C.primary}-50 px-5 py-4 text-sm font-black text-${C.primary}-900">{t.previewActivePath}</button></aside>
          </div>
        </div>
      </section>
      <div className="mx-auto max-w-7xl space-y-7 px-4 py-8 md:px-8">
        ...
        <section className="rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-${C.primary}-50 p-6 shadow-sm md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_0.9fr]">{/* L9 */}
            <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm"><p className="text-xs font-black uppercase tracking-[0.16em] text-blue-700">{t.progressInsight}</p><h3 className="mt-2 text-2xl font-black">{t.possibleTarget}</h3><div className="mt-5 grid gap-3 sm:grid-cols-3"><div className="rounded-2xl bg-slate-50 p-4"><div className="text-xs font-black text-slate-500">{t.weeklyTrend}</div><div className="mt-1 text-3xl font-black">${PKPrefix}{primaryDisplay}${PKSuffix}<span>{t.primaryUnitTail}</span></div></div><div className="rounded-2xl bg-${C.primary}-50 p-4"><div className="text-xs font-black uppercase text-${C.primary}-700">{t.dailyGap}</div><div className="mt-1 text-3xl font-black text-${C.primary}-950">{secondaryDisplay}</div></div><div className="rounded-2xl bg-emerald-50 p-4"><div className="text-xs font-black uppercase text-emerald-700">{t.tertiaryTag}</div><div className="mt-1 text-3xl font-black text-emerald-950">{tertiaryDisplay}</div></div></div></article>
